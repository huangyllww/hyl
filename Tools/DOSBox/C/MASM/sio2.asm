...
data segment use16
	temp_device0    db	'device0 offset 30,60,61,70,f0:',2 dup (0)
	temp_device1  	db	'device1 offset 30,60,61,70,f0:',2 dup (0)
	temp_device2  	db	'device2 offset 30,60,61,70,f0:',2 dup (0)
	temp_device3 	db	'device3 offset 30,60,61,70,f0:',2 dup (0)
	temp_device4  	db	'device4 offset 30,60,61,70,f0:',2 dup (0)
	temp_device5  	db	'device5 offset 30,60,61,70,f0:',2 dup (0)
	temp_device6	db	'device6 offset 30,60,61,70,f0:',2 dup (0)
	temp_device7	db	'device7 offset 30,60,61,70,f0:',2 dup (0)
	temp_device8	db	'device8 offset 30,60,61,70,f0:',2 dup (0)
	temp_device9	db	'device9 offset 30,60,61,70,f0:',2 dup (0)
	temp_device10	db	'device10 offset 30,60,61,70,f0:',2 dup (0)
	temp_device11	db	'device11 offset 30,60,61,70,f0:',2 dup (0)
	temp_device12	db	'device12 offset 30,60,61,70,f0:',2 dup (0)
	temp_device13	db	'device13 offset 30,60,61,70,f0:',2 dup (0)
	temp_device14	db	'device14 offset 30,60,61,70,f0:',2 dup (0)
	temp_device15	db	'device15 offset 30,60,61,70,f0:',2 dup (0)
...
MOV DX, 02EH  ;exit the Extended function mode  退出扩展模式 
MOV AL, 0AAH
OUT DX, AL
