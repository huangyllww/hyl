...
;;---------------------------------------------------	
    ...
    pcie_string1        db  'Please enter the bus(0x000-0x0ff,eg:001):',0
    pcie_string2        db  'Please enter the device(00x--0x1f,eg:01) :',0
    pcie_string3        db  'press Enter to continue    press ESC to exit',0
	pcie_string4        db  'Please enter the function(0-8,eg:5) :',0
