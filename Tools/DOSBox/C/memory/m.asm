...
data segment use16
    ...
    temp_string1        db  'Please enter the start address(Hex,eg:1300) :',0
    temp_string2        db  'Please enter the length(Hex,max 0x00ff) :',0
...
;;---------------------------------------------------		
	...
	print_data:
				...
				mov cl,4                ;eg: startAddress(0x134) = es(0x0123) << 4 + di(0x0004)
				shr ax,cl				;startAddress右移4位
				mov es,ax
