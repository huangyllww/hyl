...
===================================================================================================================== 
  ...
  /MSR:   MSR Access;                                  || /NBIO: NBIOSmn Access;
...
MSR Access:
=====================================================================================================================
  Utility /MSR /WD [MsrAddr] [EDX] [EAX]:            || Write MSR EDX:EAX(64 Bit) to MsrAddr.
  Utility /MSR /RD 0xC0010058:                       || Read MSR from 0xC0010058.
  Utility /MSR /WD 0xC0010058 0 0x22222222:          || Write MSR 0x00000000_22222222 to 0xC0010058.
=====================================================================================================================
 RTC:
=====================================================================================================================
...
NBIO:
=====================================================================================================================
  Utility /NBIO /RD [DieNum] [RegesterIndex]:        || Read SMN address data on witch DieNum.
  Utility /NBIO /WD [DieNum] [RegesterIndex] [Data]: || Write SMN data to address on witch DieNum.
=====================================================================================================================
FLASH:
=====================================================================================================================
