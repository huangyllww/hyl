...
//
// GPIO Init Table for Hygon35N16
//
AMD_CPM_GPIO_INIT_TABLE             gCpmGpioInitTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
...
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_INIT, sizeof (gCpmGpioInitTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {//        (socket,die,gpio,function,         output,           pullup)
          
          GPIO_DEF_V2 (0, 0, 3  , GPIO_FUNCTION_0, GPIO_INPUT      , GPIO_PU_EN    ),  // BIOS_RECOVERY#
          GPIO_DEF_V2 (0, 0, 4  , GPIO_FUNCTION_0, GPIO_INPUT      , GPIO_PU_EN    ),  // BMC_SCI#
          GPIO_DEF_V2 (0, 0, 5  , GPIO_FUNCTION_0, GPIO_INPUT      , GPIO_PU_EN    ),  // BMC_PRESENT#
          GPIO_DEF_V2 (0, 0, 6  , GPIO_FUNCTION_0, GPIO_INPUT      , GPIO_PU_EN    ),  // MEZZ1_PRSNT#  
          GPIO_DEF_V2 (0, 0, 42 , GPIO_FUNCTION_1, GPIO_INPUT      , GPIO_PU_EN    ),  // BMC_+3V_READY#
          GPIO_DEF_V2 (0, 0, 70 , GPIO_FUNCTION_0, GPIO_INPUT      , GPIO_PD_EN    ),  // CLEAR_PASSWORD#         
          GPIO_DEF_V2 (0, 0, 108, GPIO_FUNCTION_2, GPIO_OUTPUT_LOW , GPIO_PU_EN    ),  // FM_VIDEO_DISABLE_+3V_N
          GPIO_DEF_V2 (0, 0, 135, GPIO_FUNCTION_2, GPIO_INPUT      , GPIO_PU_EN    ),  // BMC_INIT#
          GPIO_DEF_V2 (0, 0, 140, GPIO_FUNCTION_2, GPIO_INPUT      , GPIO_PU_PD_DIS),  // BLADE_TYPE_0
          GPIO_DEF_V2 (0, 0, 141, GPIO_FUNCTION_1, GPIO_INPUT      , GPIO_PU_PD_DIS),  // BLADE_TYPE_1
          GPIO_DEF_V2 (0, 0, 143, GPIO_FUNCTION_1, GPIO_INPUT      , GPIO_PU_PD_DIS),  // BLADE_TYPE_2
          GPIO_DEF_V2 (0, 0, 144, GPIO_FUNCTION_1, GPIO_INPUT      , GPIO_PU_PD_DIS),  // BLADE_TYPE_3
          GPIO_DEF_V2 (0, 0, 9,   GPIO_FUNCTION_1, GPIO_NA         , GPIO_PD_EN    ),  // CPU1_SGPIO_SDATAOUT0
          GPIO_DEF_V2 (0, 0, 10,  GPIO_FUNCTION_2, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_CLK0
          GPIO_DEF_V2 (0, 0, 23,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_EN    ),  // CPU1_SGPIO_LOAD0
          GPIO_DEF_V2 (0, 0, 40,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_SDATAIN0
          GPIO_DEF_V2 (0, 1, 9,   GPIO_FUNCTION_1, GPIO_NA         , GPIO_PD_EN    ),  // CPU1_SGPIO_SDATAOUT1
          GPIO_DEF_V2 (0, 1, 10,  GPIO_FUNCTION_2, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_CLK01
          ...
          GPIO_DEF_V2 (0, 2, 9,   GPIO_FUNCTION_1, GPIO_NA         , GPIO_PD_EN    ),  // CPU1_SGPIO_SDATAOUT2
          GPIO_DEF_V2 (0, 2, 10,  GPIO_FUNCTION_2, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_CLK02
          GPIO_DEF_V2 (0, 2, 23,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_EN    ),  // CPU1_SGPIO_LOAD2
          GPIO_DEF_V2 (0, 3, 40,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_SDATAIN2
          GPIO_DEF_V2 (0, 3, 9,   GPIO_FUNCTION_1, GPIO_NA         , GPIO_PD_EN    ),  // CPU1_SGPIO_SDATAOUT2
          GPIO_DEF_V2 (0, 3, 10,  GPIO_FUNCTION_2, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_CLK02
          GPIO_DEF_V2 (0, 3, 23,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_EN    ),  // CPU1_SGPIO_LOAD2
          GPIO_DEF_V2 (0, 3, 40,  GPIO_FUNCTION_1, GPIO_NA         , GPIO_PU_PD_DIS),  // CPU1_SGPIO_SDATAIN3
          0xFF,
  }
};
...
// GEVENT Init Table
//
AMD_CPM_GEVENT_INIT_TABLE           gCpmGeventInitTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GEVENT_INIT, sizeof (gCpmGeventInitTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x00000001},
...
AMD_CPM_GPIO_DEVICE_CONFIG_TABLE    gCpmGpioDeviceConfigTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_CONFIG, sizeof (gCpmGpioDeviceConfigTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
...
//
// CPM Device Detection Table for Hygon35N16
//
AMD_CPM_GPIO_DEVICE_DETECTION_TABLE gCpmGpioDeviceDetectionTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_DETECTION, sizeof (gCpmGpioDeviceDetectionTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
...
//
AMD_CPM_GPIO_DEVICE_RESET_TABLE gCpmGpioDeviceResetTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_RESET, sizeof (gCpmGpioDeviceResetTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
//
AMD_CPM_GPIO_DEVICE_POWER_TABLE gCpmGpioDevicePowerTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_POWER, sizeof (gCpmGpioDevicePowerTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
// PCIE Clock Table
//
AMD_CPM_PCIE_CLOCK_TABLE    gCpmPcieClockTableHygon35N16 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table content
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_PCIE_CLOCK, sizeof (gCpmPcieClockTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0F},
  {
...
//
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHygon35N16S0 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHygon35N16S0) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  0,  // SocketId
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
    { // P0 [0:3]- SATA port port0:NGFF1, port1:ODD, port2: J21 7p slot, port3: J22 7p slot
          0,
    ...
    { //G0[0:15] - PCIE J28 Slot select 0: X16
      0,
    ...
    { // P1 [0:3]- MiniSAS HD0 J18
     ...
     { //P1[7:15] - MEZZ Slot J30_1 select 0: x8
       0,
     ...
     { //G1[0:15] - PCIE J24 Slot select 0: X16
        0,
     ...
     { // G2 [0:3] - MiniSAS HD2 J16
             0,
             DXIO_ENGINE_DATA_INITIALIZER (DxioSATAEngine, 64, 67, DxioHotplugDisabled, 1),
             DXIO_PORT_DATA_INITIALIZER_SATA (
                DxioPortEnabled                       // Port Present
              )
     },

      { // G2 [4:7] - MiniSAS HD3 J17
              0,
              DXIO_ENGINE_DATA_INITIALIZER (DxioSATAEngine, 68, 71, DxioHotplugDisabled, 1),
              DXIO_PORT_DATA_INITIALIZER_SATA (
                 DxioPortEnabled                       // Port Present
               )
      },
      ...
      { // G2 [8:11]- MiniSAS HD4 J14
                   0,
                   DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 72, 75, DxioHotplugDisabled, 1),
                   DXIO_PORT_DATA_INITIALIZER_PCIE (
                        DxioPortEnabled,                      // Port Present
                        0,                                    // Requested Device
                        0,                                    // Requested Function
      ...
      { // G2 [12:15]
               0,
               DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 76, 79, DxioHotplugDisabled, 1),
               DXIO_PORT_DATA_INITIALIZER_PCIE (
                              DxioPortEnabled,                      // Port Present
                              0,                                    // Requested Device
                              0,                                    // Requested Function
       ...
       { //P2[0:15]
        ...
        { // G3[0:3]
             0,
             DXIO_ENGINE_DATA_INITIALIZER (DxioSATAEngine, 96, 99, DxioHotplugDisabled, 1),
             DXIO_PORT_DATA_INITIALIZER_SATA (
                   DxioPortEnabled                       // Port Present
           )
        },
         ...
         { // G3[4:7]
              0,
              DXIO_ENGINE_DATA_INITIALIZER (DxioSATAEngine, 100, 103, DxioHotplugDisabled, 1),
              DXIO_PORT_DATA_INITIALIZER_SATA (
                    DxioPortEnabled                       // Port Present
               )
        },            
       ...
       { //G3[8:15]
         0,
         DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 104, 111, DxioHotplugDisabled, 1),
         DXIO_PORT_DATA_INITIALIZER_PCIE (
           DxioPortEnabled,                      // Port Present
           0,                                    // Requested Device
           0,                                    // Requested Function
...
HYGON_CPM_EQ_CONFIG_TABLE  gHygonEqConfigurationTableHygon35N16 = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof (gHygonEqConfigurationTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    //{FLAG_SPECIFIED, pcie_gen3_ttx_force_otherside_preset, Cpu_Gen_DhyanaPlus, 1, 0xa824144d, 0xFFFFFFFF, 16,  23, TRUE, {1}},
    //{FLAG_FORCE,     pcie_gen3_ttx_force_otherside_preset, Cpu_Gen_DhyanaPlus, 1, 0xFFFFFFFF, 0xFFFFFFFF, 24,  31, TRUE, {3}},
