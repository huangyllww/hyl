 ...
 *----------------------------------------------------------------------------------------
 */
UINT16 PhyParameterTable_H3[3][9] = {
...
UINT16 PhyParameterTable_H4[3][9] = {
    //VERG_CTRL2,AFE_CTLE,AFE_OVER_RTRIM,AFE_OVER_ICTRL,CAL_MUXB,CAL_MUXA,CDR_CTL_3_3_5,CTL_4_0_2
    {0,0,0,0,0,0,0,0x1,0x1},//DM1
    {0xac,0x3c,0xa6,0x7d,0x07,0x48,0x0d,0x1,0x1},//SL1
    {0xac,0x3c,0xa2,0xff,0x07,0x48,0x1d,0x1,0x1},//SL1R2
};
...
)
{
    ...
    BaseGetLogicalIdOnExecutingCore (&LogicalId);
    CpuPkg = GetPkgType();
    //check if CPU not Cx or Dx?
    if(!(LogicalId.Revision & (HYGON_REV_F18_DN_Cx | HYGON_REV_F18_DN_Dx))) {
      IDS_HDT_CONSOLE (PCIE_MISC, "CPU don't match F18 and Cx or Dx\n");
      goto EXIT;
    }
    if(CpuPkg == PKG_DM1) {
    ...
    if(LogicalId.Revision & (HYGON_REV_F18_DN_Dx)){
        for(Lane=StartLane;Lane<=EndLane;Lane++){
            ...
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_ANA_RX_AFE_CTLE to %x\n",PhyParameterTable_H4[PkgIndex][LANE_DIG_ANA_RX_AFE_CTLE_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_ANA_RX_AFE_CTLE,PhyParameterTable_H4[PkgIndex][LANE_DIG_ANA_RX_AFE_CTLE_INDEX]);      
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_RX_CDR_CTL_3_3_5 to %x\n",PhyParameterTable_H4[PkgIndex][LANE_DIG_RX_CDR_CTL_3_INDEX]);
            PhyRegRead(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_3,&Data16);
            Data16 &= 0xffc7;
            Data16 |= (PhyParameterTable_H4[PkgIndex][LANE_DIG_RX_CDR_CTL_3_INDEX]<<3);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_3,Data16);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_RX_CDR_CTL_4_0_2 to %x\n",PhyParameterTable_H4[PkgIndex][LANE_DIG_RX_CDR_CTL_4_INDEX]);
            PhyRegRead(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_4,&Data16);
            Data16 &= 0xfff8;
            Data16 |= PhyParameterTable_H4[PkgIndex][LANE_DIG_RX_CDR_CTL_4_INDEX];
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_4,Data16);
        }
    }else{
        for(Lane=StartLane;Lane<=EndLane;Lane++){    
            IDS_HDT_CONSOLE (PCIE_MISC, "Cfg Lane%x ...\n",Lane);    
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_VERG_CTRL2 to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_VERG_CTRL2_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_VERG_CTRL2,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_VERG_CTRL2_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_ANA_RX_AFE_CTLE to %x\n",PhyParameterTable_H3[PkgIndex][LANE_DIG_ANA_RX_AFE_CTLE_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_ANA_RX_AFE_CTLE,PhyParameterTable_H3[PkgIndex][LANE_DIG_ANA_RX_AFE_CTLE_INDEX]);               
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_AFE_OVER to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_AFE_OVER,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_AFE_OVER_RTRIM to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_RTRIM_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_AFE_OVER_RTRIM,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_RTRIM_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_AFE_OVER_ICTRL to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_ICTRL_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_AFE_OVER_ICTRL,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_AFE_OVER_ICTRL_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_CAL_MUXB to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_CAL_MUXB_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_CAL_MUXB,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_CAL_MUXB_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_ANA_RX_CAL_MUXA to %x\n",PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_CAL_MUXA_INDEX]);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_ANA_RX_CAL_MUXA,PhyParameterTable_H3[PkgIndex][LANE_ANA_RX_CAL_MUXA_INDEX]);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_RX_CDR_CTL_3_3_5 to %x\n",PhyParameterTable_H3[PkgIndex][LANE_DIG_RX_CDR_CTL_3_INDEX]);
            PhyRegRead(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_3,&Data16);
            Data16 &= 0xffc7;
            Data16 |= (PhyParameterTable_H3[PkgIndex][LANE_DIG_RX_CDR_CTL_3_INDEX]<<3);
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_3,Data16);
            IDS_HDT_CONSOLE (PCIE_MISC, "LANE_DIG_RX_CDR_CTL_4_0_2 to %x\n",PhyParameterTable_H3[PkgIndex][LANE_DIG_RX_CDR_CTL_4_INDEX]);
            PhyRegRead(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_4,&Data16);
            Data16 &= 0xfff8;
            Data16 |= PhyParameterTable_H3[PkgIndex][LANE_DIG_RX_CDR_CTL_4_INDEX];
            PhyRegWrite(GnbHandle,DxioType,Lane,LANE_DIG_RX_CDR_CTL_4,Data16);
        }
    }
    //redo EQ
    ...
    do {
      if (PcieEngine->Type.Port.PortId > 7) {
          NbioRegisterRead (GnbHandle, TYPE_SMN, PCIE1_LC_STATE0_ADDRESS+((PcieEngine->Type.Port.PortId - 8) << 12), &LcState0.Value, 0);
      } else {
          NbioRegisterRead (GnbHandle, TYPE_SMN, PCIE0_LC_STATE0_ADDRESS + ((PcieEngine->Type.Port.PortId) << 12), &LcState0.Value, 0);
      }
      if ((UINT8)LcState0.Value != 0x10) {
        NbioRegisterRead (GnbHandle, TYPE_SMN, PcieRcCfgSmnBase + (PortOffset << 12) + RC_PCIE_LINK_CNTL_OFFSET, &LinkCtl.Value, 0);
        LinkCtl.Field.RETRAIN_LINK =1;
        NbioRegisterWrite (GnbHandle, TYPE_SMN, PcieRcCfgSmnBase + (PortOffset << 12) + RC_PCIE_LINK_CNTL_OFFSET, &LinkCtl.Value, 0);
        TryCount++;
      ...
      MicroSecondDelay(50*1000);
    } while((UINT8)LcState0.Value != 0x10);
    //NbioRegisterRead (GnbHandle, TYPE_SMN, PcieRcCfgSmnBase + (PortOffset << 12) + RC_PCIE_LINK_CNTL3_OFFSET, &LinkCtl3.Value, 0);
