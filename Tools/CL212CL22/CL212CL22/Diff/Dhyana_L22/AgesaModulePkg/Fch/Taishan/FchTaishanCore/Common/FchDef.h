...
VOID          FchSmnRead16 (IN UINT32 IohcBus, IN UINT32 SmnAddress, IN UINT16 *Value16, IN AMD_CONFIG_PARAMS *StdHeader);
VOID          FchSmnWrite16 (IN UINT32 IohcBus, IN UINT32 SmnAddress, IN UINT16 *Value16, IN AMD_CONFIG_PARAMS *StdHeader);
VOID          FchSmnRW16 (IN UINT32 IohcBus, IN UINT32 SmnAddress, IN UINT16 AndMask, IN UINT16 OrMask, IN AMD_CONFIG_PARAMS *StdHeader);
///
/// Fch Ab Routines
///
///  Pei Phase
...
VOID TurnOffUsbPme (IN UINT32 DieBusNum, IN VOID *FchDataPtr);
#endif
