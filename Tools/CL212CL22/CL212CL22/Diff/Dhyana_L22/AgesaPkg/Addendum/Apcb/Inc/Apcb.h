 ...
 *----------------------------------------------------------------------------
 */
#define APCB_HEADER_VERSION     0x0000002A  // APCB Version

#define APCB_MAX_SOCKETS_SUPPORTED   2 /// Max Sockets supproted by APCB
#define APCB_MAX_CHANNEL_PER_SOCKET  8
...
#define APCB_TOKEN_CBS_CMN_AVS_DISABLE 0x005D
...
#define APCB_TOKEN_CBS_DBG_MEM_LRDIMM_RESERVED76 0x00B0
#define APCB_TOKEN_CBS_DBG_MEM_LRDIMM_RESERVED77 0x00B1
#define APCB_TOKEN_CBS_DBG_MEM_LRDIMM_F5_B_C5X 0x00B2
#define APCB_TOKEN_CBS_DBG_MEM_LRDIMM_F5_B_C6X 0x00B3
#define APCB_TOKEN_CBS_DBG_END 0x00B4
...
typedef struct _PSP_PSO_STRUCT {
  ...
  //PSO_ENTRY NumberDimmSupported1[NUMBER_OF_DIMMS_SUPPORTED_SIZE];
...
#define SL1_MAKE_TX_EQ_FREQ_TABLE_COMPACT(SpeedMask, SocGeneration, SocPackage, SD0, SD1, SD2, SD3, SD4, SD5, SD6, SD7) \
    MAKE_TX_EQ_FREQ_TBL(SpeedMask), SocGeneration, SocPackage, SD0, SD1, SD2, SD3, SD4, SD5, SD6, SD7, MAKE_TX_EQ_FREQ_END()
...
//#define AMD_FAMILY_AM     (AMD_FAMILY_16_AM)
// Family 15h AM steppings
//#define AMD_F17_ZP_A0    0x0000000002000000ull
//#define AMD_F17_ZP_Ax    (AMD_F17_ZP_A0)
//#define AMD_F17_ZP_ALL   0x0000000000010000ull
//#define AMD_FAMILY_17_ZP  0x0000000000010000ull
//#define AMD_F17_ALL  AMD_FAMILY_17_ZP
//#define AMD_F17_ALL_APCB AMD_F17_ZP_ALL
