...
SATA_WA_PLATFORM SataWaPlatformList[] = {
    {{D2SL1      , 0, REVISION_A, 0}, 0x0F00},
    {{D2SL1      , 0, REVISION_B, 0}, 0x0F00},
    {{D2SL1_DEBUG, 0, REVISION_A, 0}, 0x0F00},
    {{D2SL1_SLT  , 0, REVISION_A, 0}, 0x0F00},
    {{D2SL1_SLT  , 0, REVISION_B, 0}, 0x0F00},
    {{D2SL1_DAP  , 0, REVISION_A, 0}, 0x0F00},
    {{D2SL1_DAP  , 0, REVISION_B, 0}, 0x0F00},
  ...
  )
{
  ...
  DEBUG((EFI_D_ERROR, "PS-64: AmdPlatformId = 0x%08x\n", AmdPlatformId));
...
//  ControlByte = 0x01; //enable channel 1 
 ...
 // MicroSecondDelay(5000000); //Delay 5s
  ...
  DEBUG((EFI_D_ERROR, "PS-69:Get outof Setting FieldCard!!!\n"));
