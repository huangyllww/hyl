...
#define MSR_MCODE_CTL               0xC0011000ul    // Microcode Control
#define MSR_CPUID_7_FEATS           0xC0011002ul    // CPUID Features for Fn00000007_E[A,B]X
...
#define MSR_FP_CFG                  0xC0011028ul    // DNPS-86
