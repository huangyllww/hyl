...
#include    <Library/MemoryAllocationLib.h> //PS-282
...
//PS-282- UINT8                              CommBuffer[sizeof(EFI_GUID) + sizeof(UINTN) + sizeof(MmioBaseAddress)];
    UINT8                              *CommBuffer; //PS-282
    UINTN                              CommSize;
    ...
    CommBuffer = AllocateRuntimePool (sizeof(EFI_GUID) + sizeof(UINTN) + sizeof(MmioBaseAddress)); //PS-282
