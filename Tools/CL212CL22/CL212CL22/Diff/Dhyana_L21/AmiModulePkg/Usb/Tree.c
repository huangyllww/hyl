...
/**
    ...
    @param 
        Node - pointer to TREENODE_T structure
        Data - pointer to data structure specific to
...
/**
    ...
    @param 
        Parent - pointer to parent TREENODE_T structure
        Child  - pointer to child TREENODE_T structure
...
/**
    ...
    @param 
        Node   - pointer to TREENODE_T structure
        Predicate  - predicate function that is called for each node
...
/**
    ...
    @param 
        Node - pointer to TREENODE_T structure
        CallBack  - call-back function that is called for each node
        Data - pointer that is passed to call-back to maintain
        the context of the enumeration
**/

VOID TreeForEachSibling( TREENODE_T* Node, TREE_CALLBACK_T CallBack, VOID* Data )
{
...
/**
    ...
    @param 
        Queue - pointer to QUEUE_T structure
**/
...
/**
    ...
    @param 
        ...
        Size  - number of dwords to add to the queue
**/
...
/**
    ...
    @param 
        Queue - pointer to QUEUE_T structure
        Size - number of dwords to remove from the queue
**/
