...
)
{
    ...
    if (HcInitializedNumber != 0) {
    	RuntimeDriverCalculateCrc32((UINT8*)HcStrucData, 
    ...
    if (Usb3HcInitializedNumber != 0) {
    	RuntimeDriverCalculateCrc32((UINT8*)Usb3HcStrucData, 
    ...
    RuntimeDriverCalculateCrc32((UINT8*)&UsbConStantData, sizeof(UsbConStantData), &Crc32Value[2]);
...
/**
    This function initial crc32 table and register callback function with 
    AmiUsbSmmProtocol
