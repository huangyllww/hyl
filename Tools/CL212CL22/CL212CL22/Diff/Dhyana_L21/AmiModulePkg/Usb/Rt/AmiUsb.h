...
VOID UsbApiLockUsbSwSmi(URP_STRUC *Urp);		// API 37h
...
VOID USBMassAPIGetIdentifyData(URP_STRUC*);         // USB Mass API Sub-Func 0Fh
...
UINT8        UsbHcdStartDummy(HC_STRUC*);
UINT8        UsbHcdStopDummy(HC_STRUC*);
UINT8        UsbHcdEnumeratePortsDummy(HC_STRUC*);
UINT8        UsbHcdDisableInterruptsDummy(HC_STRUC*);
UINT8        UsbHcdEnableInterruptsDummy(HC_STRUC*);
UINT8        UsbHcdProcessInterruptDummy(HC_STRUC*);
UINT32       UsbHcdGetRootHubStatusDummy(HC_STRUC*, UINT8, BOOLEAN);
UINT8        UsbHcdDisableRootHubDummy(HC_STRUC*, UINT8);
UINT8        UsbHcdEnableRootHubDummy(HC_STRUC*, UINT8);
UINT16       UsbHcdControlTransferDummy(HC_STRUC*, DEV_INFO*, UINT16, UINT16, UINT16, UINT8*, UINT16);
UINT32       UsbHcdBulkTransferDummy(HC_STRUC*, DEV_INFO*, UINT8, UINT8*, UINT32);
UINT32       UsbHcdIsocTransferDummy(HC_STRUC*, DEV_INFO*, UINT8, UINT8*, UINT32, UINT8*);
UINT16       UsbHcdInterruptTransferDummy(HC_STRUC*, DEV_INFO*, UINT8, UINT16, UINT8*, UINT16);
UINT8        UsbHcdDeactivatePollingDummy(HC_STRUC*, DEV_INFO*);
UINT8        UsbHcdActivatePollingDummy(HC_STRUC*, DEV_INFO*);
UINT8        UsbHcdDisableKeyRepeatDummy(HC_STRUC*);
UINT8        UsbHcdEnableKeyRepeatDummy(HC_STRUC*);
UINT8        UsbHcdEnableEndpointsDummy(HC_STRUC*, DEV_INFO*, UINT8*);
UINT8        UsbHcdInitDeviceDataDummy(HC_STRUC*, DEV_INFO*, UINT32, UINT8**);
UINT8        UsbHcdDeinitDeviceDataDummy(HC_STRUC*, DEV_INFO*);
UINT8        UsbHcdResetRootHubDummy(HC_STRUC*, UINT8);
UINT8        UsbHcdClearEndpointStateDummy(HC_STRUC*, DEV_INFO*, UINT8);
UINT8        UsbHcdGlobalSuspendDummy(HC_STRUC*);
UINT8        UsbHcdSmiControlDummy(HC_STRUC*, BOOLEAN);     
