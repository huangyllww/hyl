...
HYGON_CPM_EQ_CONFIG_TABLE  gCpmEqConfigurationTableHygon62DB32SL1r2 = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof (gCpmEqConfigurationTableHygon62DB32SL1r2) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
  	...
  	{FLAG_SPECIFIED, pcie_gen3_ttx_force_otherside_preset, CPU_HYGON_CX, 2, 0x100000E6, 0xFFFFFFFF, 8, 15, TRUE, {3,3,3,3,3,3,3,3}},
    {FLAG_SPECIFIED, pcie_gen3_ttx_force_otherside_preset, CPU_HYGON_CX, 2, 0x100010E2, 0xFFFFFFFF, 8, 15, TRUE, {3,3,3,3,3,3,3,3}},
