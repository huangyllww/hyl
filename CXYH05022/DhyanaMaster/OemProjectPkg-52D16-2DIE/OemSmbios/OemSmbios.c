...
#include <OemProjectPkg-52D16-2DIE\OemSmbios\OemSmbios.h>
...
#define NVME_CARD_DET_N_4DIE(ValidSeeting) 23,DIE3,SOCKET0,ValidSeeting,"NVME_CARD_DET_N_4DIE" 
#define NVME_CARD_DET_N_2DIE(ValidSeeting) 3,DIE1,SOCKET0,ValidSeeting,"NVME_CARD_DET_N_2DIE" 
#define SATA_CPU0_DET_N(ValidSeeting) 136,DIE0,SOCKET0,ValidSeeting,"SATA_CPU0_DET_N" 
...
SMBIOS_TYPE_8 PortConnectorInfo[] = {     
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J37 USB0&1","CPU0 USB0"},
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J37 USB0&1","CPU0 USB1"},
        {{{8, 0x09, 0}, 1, 0x12, 0, 0x12, 0x10}, "J104 FP_USB0&1"},
        {{{8, 0x09, 0}, 1, 0x12, 0, 0x12, 0x10}, "J115 FP_USB2&3"},
        {{{8, 0x09, 0}, 1, 0x12, 0, 0x12, 0x10}, "J53 FP_USB4&5"},
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10},    "J56 Type_A_USB ", "M.2_SSD_Act "},
        
        
        {{{8, 0x09, 0}, 1, 0xFF, 0, 0, 0xFF}, "J51 COM"},
        {{{8, 0x09, 0}, 1, 0xFF, 2, 0, 0xFF}, "J25 Mmgt","Mmgt LAN"},
        {{{8, 0x09, 0}, 1, 0x0B, 2, 0x0B, 0x1F}, "J33 LAN1&2","LAN1"},
        {{{8, 0x09, 0}, 1, 0x0B, 2, 0x0B, 0x1F}, "J33 LAN1&2","LAN2"},
        {{{8, 0x09, 0}, 1, 0x09, 2, 0x12, 0x10}, "J109 CPU UART","DEBUG UART"},
        {{{8, 0x09, 0}, 1, 0x09, 0, 0x12, 0x10}, "J107 BMC UART"},
...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo_4Die[] = {
        {    SYS_SLOT_PCIE_3,    DBW_1X, SHORT_LENGTH, 0xFF, 0xFF,  "BM_Slot",    L"PciRoot(0x0)/Pci(0x1,0x1)",         FALSE,    RESERVED_TYPE, INVALID_SETTING_ARRARY },//J27
          {    SYS_SLOT_PCIE_3,    DBW_4X, LONG_LENGTH, 0x2, 0x2,   "U.2",    L"PciRoot(0x0)/Pci(0x1,0x6)",               FALSE, SETUP_TYPE, INVALID_SETTING_ARRARY},
          {    SYS_SLOT_PCIE_3,    DBW_4X, LONG_LENGTH, 0x2, 0x2,   "Slot2",    L"PciRoot(0x0)/Pci(0x1,0x5)",             FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY},
          
          {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0xFF, 0xFF,   "OCP_2.0",    L"PciRoot(0x2)/Pci(0x3,0x1)",         FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x7, 0x7,  "Storage_Slot",    L"PciRoot(0x2)/Pci(0x3,0x2)",       FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x4, 0x4,  "Slot4",    L"PciRoot(0x4)/Pci(0x1,0x1)",              FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x3, 0x3,  "Slot3",    L"PciRoot(0x4)/Pci(0x1,0x2)",              FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,   "Slot1",    L"PciRoot(0x6)/Pci(0x3,0x1)",           FALSE,     GPIO_TYPE, NVME_CARD_DET_N_4DIE(InputHigh), INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x1)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_4DIE(InputLow), INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x2)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_4DIE(InputLow), INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x3)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_4DIE(InputLow), INVALID_SETTING_ARRARY },
          {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x4)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_4DIE(InputLow), INVALID_SETTING_ARRARY },
    {    0xFF, 0xFF,0xFF, 0xFF,0xFF, NULL, NULL, FALSE, FALSE, INVALID_SETTING_ARRARY },
};


//riser type 0x11
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo_2Die[] = {
    {    SYS_SLOT_PCIE_3,    DBW_1X, SHORT_LENGTH, 0xFF, 0xFF,  "BM_Slot",    L"PciRoot(0x0)/Pci(0x1,0x1)",         FALSE,    RESERVED_TYPE, INVALID_SETTING_ARRARY },//J27
    {    SYS_SLOT_PCIE_3,    DBW_4X, LONG_LENGTH, 0x2, 0x2,   "U.2",    L"PciRoot(0x0)/Pci(0x1,0x6)",               FALSE, SETUP_TYPE, INVALID_SETTING_ARRARY},
    {    SYS_SLOT_PCIE_3,    DBW_4X, LONG_LENGTH, 0x2, 0x2,   "Slot2",    L"PciRoot(0x0)/Pci(0x1,0x5)",             FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY},
    
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0xFF, 0xFF,   "OCP_2.0",    L"PciRoot(0x1)/Pci(0x3,0x1)",         FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x7, 0x7,  "Storage_Slot",    L"PciRoot(0x1)/Pci(0x3,0x2)",       FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x4, 0x4,  "Slot4",    L"PciRoot(0x2)/Pci(0x1,0x1)",              FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x3, 0x3,  "Slot3",    L"PciRoot(0x2)/Pci(0x1,0x2)",              FALSE, RESERVED_TYPE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,   "Slot1",    L"PciRoot(0x3)/Pci(0x3,0x1)",           FALSE,     GPIO_TYPE, NVME_CARD_DET_N_2DIE(InputHigh), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x1)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_2DIE(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x2)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_2DIE(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x3)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_2DIE(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x4)",            FALSE,     GPIO_TYPE, NVME_CARD_DET_N_2DIE(InputLow), INVALID_SETTING_ARRARY },
    {    0xFF, 0xFF,0xFF, 0xFF,0xFF, NULL, NULL, FALSE, FALSE, INVALID_SETTING_ARRARY },
...
)
{
    ...
    //SlotsInfo->ConfigFlag = PcdGet8(PcdJ27Nvme);
    if(SlotsInfo->ConfigFlag == SETUP_TYPE)
    {
        //Setup porting
        if (PcdGet8(PcdJ27Nvme) == 1)
            return EFI_SUCCESS;
    }else{
...
UpdateSmbiosType9Table (VOID)
{
    ...
    if(Is2diecpu())
      SystemSlotsInfo = SystemSlotsInfo_2Die;
    else
      SystemSlotsInfo = SystemSlotsInfo_4Die;
