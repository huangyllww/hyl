...
#define IDE_ENUMER_ALL              FALSE
#define CONTROLLER_SIGNATURE        EFI_SIGNATURE_32('P','A','T','A')
#endif

#define HYGONSB_CLASS_CODE_AHCI       0x6
#define HYGONSB_CLASS_CODE_RAID       0x4
...
#define SBIDE_CONTROLLER_PRIVATE_DATA_FROM_THIS(a) MY_CR(a, EFI_SBIDE_CONTROLLER_PRIVATE_DATA, IdeInit, CONTROLLER_SIGNATURE)
