...
IFDEF MKF_HYGONCRBEC_SUPPORT
IF MKF_HYGONCRBEC_SUPPORT
SECSB_SIO_LPC_2E2F      = 1
SECSB_DECODE_6064       = 1
ENDIF
ENDIF
...
SECSB_PCI_PORT80 = 1;MKF_SB_PCI_PORT80_SUPPORT
...
IF MKF_CMOS_MANAGER_SUPPORT                 ; (EIP46657.1)>
    ...
    mov al, 10h                             ; 10h is the recommended value by HYGON
    WRITE_IO_PMU
ENDIF                                       ; <(EIP46657.1)
ENDIF                                       ; (EIP46657.2+)
