...
APCB_TYPE_HEADER       ApcbTypeHeader = { APCB_GROUP_MEMORY, APCB_MEM_TYPE_CONSOLE_OUT_CONTROL, (sizeof(APCB_TYPE_HEADER) + sizeof (APCB_MEM_TYPE_CONSOLE_OUT_CONTROL)), 0, 0, 0 };  // SizeOfType will be fixed up by tool
