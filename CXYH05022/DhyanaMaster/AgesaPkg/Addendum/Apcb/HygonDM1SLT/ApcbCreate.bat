...
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsOdtPatSODIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsCadBusSODIMMDdr4 
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsDataBusSODIMMDdr4 
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsMaxFreqSODIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsStretchFreqSODIMMDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsOdtPatUDIMMDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsCadBusUDIMMDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsDataBusUDIMMDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsMaxFreqUDIMMDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsStretchFreqUDIMMDdr4
...
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_SpdInfo_udimm
