...
APCB_PARAM_ATTRIBUTE  ParameterListAttribute[] = {
  ...
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CONFIG_SOLDERDOWNDRAM, sizeof (BOOLEAN) -1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CONFIG_MEM_1SPC_2SPC_MIXED_MODE_EN, sizeof (UINT8) - 1, 0},
...
_1BYTE_ALIGN UINT8  ParameterListValue[] = {
  ...
  BSBLN (BLDCFG_MEM_INTERNAL_SPD_CNTL),              //< Use internal fixed spd information
  BSBLN (BLDCFG_MEM_SUPPORT_1SPC_AND_2SPC_MIXED_MODE_CNTL),     //< Support 1SPC and 2SPC design scheme or not
  BSU08 (0xFF)
};
