...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo[] = {
    ...
    //SGMTB#164779:Improve PCIe Information Shown At BMC Web+>
    {    SYS_SLOT_PCIE_4,   DBW_16X, 0xC,  0xff,                    "OCP_Slot",    L"PciRoot(0x1)/Pci(0x1,0x4)",    FALSE, OCP_PCIEX16_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_4,    DBW_8X, 0xB,  0xff,                    "OCP_Slot",    L"PciRoot(0x1)/Pci(0x1,0x3)",    FALSE, OCP_PCIEX16_DET_N(InputHigh), INVALID_SETTING_ARRARY },
    //SGMTB#164779:Improve PCIe Information Shown At BMC Web->
