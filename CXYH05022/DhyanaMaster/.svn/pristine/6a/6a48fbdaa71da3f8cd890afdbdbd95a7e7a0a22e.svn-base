...
//<Lvshh001-20190411 Hide BIOS Vendor Name,Core Version,platform for H620 +>
#if 0
...
//<hety-20220617 follow Tencent spec v1.5 +>
#if defined(TENCENT_ERRATA_VERSION_SUPPORT) && (TENCENT_ERRATA_VERSION_SUPPORT == 1)
        L"%01d.%02d.%02d", PROJECT_MAJOR_VERSION, PROJECT_MINOR_VERSION, TENCENT_ERRATA
#else //#if defined(TENCENT_ERRATA_VERSION_SUPPORT) && (TENCENT_ERRATA_VERSION_SUPPORT == 1)
//<hety-20220617 follow Tencent spec v1.5 ->
#if PROJECT_BUILD_NUMBER_IN_TITLE_SUPPORTED && defined(PROJECT_BUILD)
#ifdef EFIx64
//<LiuYB006-20170105 Change project version format>        L"%s %d.%02d.%03d x64",
        L"%s%d%02d.%03d x64",  //<LiuYB006-20170105 Change project version format>
#else
        L"%s %d.%02d.%03d",
#endif
...
#ifdef EFIx64
//<LiuYB006-20170105 Change project version format>        L"%s %d.%02d x64",
//<Yanshp-20220801 Change project version format to show OEM_BOOTLEG_VERSION +>
        L"%s x64",  //<LiuYB006-20170105 Change project version format>
#else
        L"%s",
#endif
        STR(BIOS_TAG)
//<Yanshp-20220801 Change project version format to show OEM_BOOTLEG_VERSION ->
...
#endif //#if defined(TENCENT_ERRATA_VERSION_SUPPORT) && (TENCENT_ERRATA_VERSION_SUPPORT == 1) //<hety-20220617 follow Tencent spec v1.5 >
    );
    ...
    InitString(HiiHandle, STRING_TOKEN(STR_MIN2_PASSWORD_LENGTH__VALUE), L"%d", PASSWORD_MIN2_SIZE);  //<zhouyj1-20220128 Password mini Length is 3 with simple password,and 8 with complex password. +>            
