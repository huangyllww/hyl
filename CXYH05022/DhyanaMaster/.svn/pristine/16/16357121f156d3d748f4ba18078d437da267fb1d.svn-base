  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "BootScriptExecuteMemPoll - 0x%08x, 0x%016lx, 0x%016lx, Data=0x%lx\n", (UINTN)MemPoll.Address, AndMask, OrMask, Data));
  ...
  )
{
  ...
  while ((UINTN) Script < (UINTN) (StartAddress + TableLength)) {
    DEBUG ((EFI_D_INFO, "ExecuteBootScript - 0x%08x\n", (UINTN)Script));
