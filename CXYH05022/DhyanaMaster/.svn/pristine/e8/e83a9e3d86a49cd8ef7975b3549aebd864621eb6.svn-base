...
)
{
    ...
    // Raise TPL so that no other callbacks can happen while executing this code
...
)
{
    ...
    {
		// Clear the current screen before changing the resolution.  Just in case graphics resolution doesn't change
		//	but the text screen changes.
        This->ClearScreen(This);
