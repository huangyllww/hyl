...
//###             DEBUG((DEBUG_INFO, "PciRB: #%X BUS _MIN=0x%lX; _MAX=0x%lX; _LEN=0x%lX\n",
...
//###
//###             DEBUG((DEBUG_INFO, "PciRB: #%X IO ",RootBrgIndex));
...
//###             if(EFI_ERROR(Status)) {
//###                 DEBUG((DEBUG_INFO,"PciRB: IO Allocation Failed: _LEN=%lX; _GRA=l%X.\n",res->_LEN, res->_MAX));
//###                 ASSERT_EFI_ERROR(Status);
//###                 return Status;
//###             }
//###         }
...
//###                 AddressLimit = AddressLimit + 1; // make power of 2
//###                 DEBUG((DEBUG_INFO, "PciRB: #%X MMIO32",RootBrgIndex));
...
//###                 AddressLimit = AddressLimit + 1; // make power of 2
//###                 DEBUG((DEBUG_INFO, "PciRB: #%X MMIO64",RootBrgIndex));
...
//###                             RootBrgData->RbHandle);
//###             if(EFI_ERROR(Status)) {
//###                 DEBUG((DEBUG_INFO,"PciRootBrg: Memory Allocation Failed: Length: %lX\n",res->_LEN));
//###                 return Status;
//###             }
//###
...
//###                 if(EFI_ERROR(Status))
//###                 {
//###                     DEBUG((DEBUG_INFO,"PciHostBridge: Setting of WT attributes for prefetchable memory has failed(%r). UC is used.\n",Status));
...
//### //      DEBUG((DEBUG_INFO,"PciRB: #%X Resources: Type=%X; TFlags=%X; GCD asssigned address _MIN=%lX; _MAX=%lX; _GRA=%lX; _LEN=%lX.\n",
