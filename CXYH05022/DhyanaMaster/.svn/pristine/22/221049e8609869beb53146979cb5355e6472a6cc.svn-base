...
// GPIO Init Table
//
AMD_CPM_GPIO_INIT_TABLE             gCpmGpioInitTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
...
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_INIT, sizeof (gCpmGpioInitTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {  
...
// GEVENT Init Table
//
AMD_CPM_GEVENT_INIT_TABLE           gCpmGeventInitTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GEVENT_INIT, sizeof (gCpmGeventInitTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x00000001},
...
AMD_CPM_GPIO_DEVICE_CONFIG_TABLE    gCpmGpioDeviceConfigTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_CONFIG, sizeof (gCpmGpioDeviceConfigTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
...
//
AMD_CPM_GPIO_DEVICE_DETECTION_TABLE gCpmGpioDeviceDetectionTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_DETECTION, sizeof (gCpmGpioDeviceDetectionTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
...
//
AMD_CPM_GPIO_DEVICE_RESET_TABLE gCpmGpioDeviceResetTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_RESET, sizeof (gCpmGpioDeviceResetTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
//
AMD_CPM_GPIO_DEVICE_POWER_TABLE gCpmGpioDevicePowerTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_POWER, sizeof (gCpmGpioDevicePowerTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
// PCIE Clock Table
//
AMD_CPM_PCIE_CLOCK_TABLE    gCpmPcieClockTableHONGHAIA1b = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table content
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_PCIE_CLOCK, sizeof (gCpmPcieClockTableHONGHAIA1b) / sizeof (UINT8), 0, 0, 0, 0x0F},
  {
...
//
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  0,  // SocketId
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
  ...
  { // 4~5: I350
    0,
    DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 4, 5, DxioHotplugDisabled, 1),
  ...
  { // 6: BMC
    0,
    DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 6, 6, DxioHotplugDisabled, 1),
    DXIO_PORT_DATA_INITIALIZER_PCIE (
    DxioPortEnabled,                        // Port Present
    1,                                      // Requested Device
  ...
  { // 7: SlotC
    0,
    DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 7, 7, DxioHotplugDisabled, 1),
    DXIO_PORT_DATA_INITIALIZER_PCIE (
    DxioPortEnabled,                        // Port Present
    1,                                      // Requested Device
...
HYGON_CPM_EQ_CONFIG_TABLE  gCpmEqConfigurationTableHonghaiA1b = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof (gCpmEqConfigurationTableHonghaiA1b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    //PCIE
    ...
    PCIE_PHY_PARA_OVERRIDE(
        ...
        8,
        15,
        0xac, 0x18, 0xb6, 0xff, 0x07, 0x48, 0x55, 0x1, 0x1        
        ),     
