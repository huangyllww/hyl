...
ifeq ($(findstring DebugPortingLib, $(FILE_PLATFORM_DSC)), DebugPortingLib)
	...
	$(error "AMIDEBUG_RX ERROR #0x100004 - Library Mapping Not Found : DebugPortingLib. Refer Debugger Porting Guide Document for more information on porting. Refer http://172.16.96.56/Bios/Documents/Aptio%20V/Porting_Guides/AMI_Debug_for_UEFI_AptioV_Porting_Guide_NDA.doc") 
endif
else
