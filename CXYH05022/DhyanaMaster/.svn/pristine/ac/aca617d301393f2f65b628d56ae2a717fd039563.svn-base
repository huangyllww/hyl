    ...
    IN OEM_DEBUG_LEVEL_DATABASE *pOemDebugLevel_SetupConfig)
{
    ...
    {
        DEBUG((EFI_D_INFO, "DynamicDebugData is NOT Synced with User configuration... Sync Pei Database...!!!\n"));
        ...
        pOemDebugLevelDataBase->CheckPointDebugSupport = pOemDebugLevel_SetupConfig->CheckPointDebugSupport;
        pOemDebugLevelDataBase->CheckPointData = pOemDebugLevel_SetupConfig->CheckPointData;
		//SGEZT#29630:Improve Debug Level Module Logic->
    ...
    {
        DEBUG((EFI_D_INFO, "DynamicDebugData DXE database is NOT Synced with User configuration... Sync DXE Database...!!!\n"));
    ...
    IN BOOLEAN IsPeiPhase)
{
    ...
    DEBUG((EFI_D_INFO, "IsValidHobFound: %x \n", IsValidHobFound));

    // Based on Hob, fill Database
    if (IsValidHobFound)
    {
        //Copy the HobData into Allocated memory
        DEBUG((EFI_D_INFO, "Create Database from Hob Data... \n"));
    ...
    else
    {
        ...
        DEBUG((EFI_D_INFO, "No Memory Cache Found!!!Create Database from Build generated files... \n"));
		...
		//SGEZT#29630:Improve Debug Level Module Logic+>
        OemDebugLevelDebugDatabase->CheckPointDebugSupport = DEFAULT_CHECK_POINT_DEBUG_SUPPORT;
        OemDebugLevelDebugDatabase->CheckPointData = 0xFFFF;
        //SGEZT#29630:Improve Debug Level Module Logic->
		// Fill PEI Table
