    ...
    IN VOID                         *InvokePpi )
{
 ...
 // SATA_CPU0_DETECT1_N = CpmSmnGetGpio(CpmTablePpiPtr, 0, 0, 138);
  ...
  RISERA_TYPE0_N = CpmSmnGetGpio(CpmTablePpiPtr, 0, 1, 6);
  RISERA_TYPE1_N = CpmSmnGetGpio(CpmTablePpiPtr, 0, 1, 5);
 // SATA_CPU1_DETECT0_N = CpmSmnGetGpio(CpmTablePpiPtr, 0, 0, 138);
  OCP_PCIEX8_DET_N = CpmSmnGetGpio(CpmTablePpiPtr, 1, 0, 4);
  RISERB_TYPE0_N = CpmSmnGetGpio(CpmTablePpiPtr, 1, 1, 6);
  RISERB_TYPE1_N = CpmSmnGetGpio(CpmTablePpiPtr, 1, 1, 5);
  ...
  //Socket 0: 
    ...
    if((FALSE == RISERA_TYPE0_N) && (FALSE == RISERA_TYPE1_N)) {
      ...
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 48, 55);
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 56, 63);
    }else if ((TRUE == RISERA_TYPE0_N) && (FALSE == RISERA_TYPE1_N)){
      // CPU0 P2     Lane0-15    2: PCIEX16                   RISERA_TYPE0_N=1, RISERA_TYPE1_N=0
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 48, 63);
    }else if ((TRUE == RISERA_TYPE0_N) && (TRUE == RISERA_TYPE1_N)) {
      // CPU0 P2     Lane0-15    4: PCIEX8+2*PCIEX4           RISERA_Type0_N=1, RISERA_TYPE1_N=1
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 48, 55);
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 56, 59);
      DxioEnableConfig(PeiServices, DxioTopologyTableS0Ptr, DxioPcieEngine, 60, 63);
    }
  ...
  //Socket 1:  
    ...
    if(FALSE == RISERB_TYPE1_N) {
      ...
      DxioEnableConfig(PeiServices, DxioTopologyTableS1Ptr, DxioPcieEngine, 48, 63);
    }else{
      // CPU1 P2     Lane0-15     2: 4*PCIEX4             RISERB_TYPE1_N=1, 
      DxioEnableConfig(PeiServices, DxioTopologyTableS1Ptr, DxioPcieEngine, 48, 51);
      DxioEnableConfig(PeiServices, DxioTopologyTableS1Ptr, DxioPcieEngine, 52, 55);
      DxioEnableConfig(PeiServices, DxioTopologyTableS1Ptr, DxioPcieEngine, 56, 59);
      DxioEnableConfig(PeiServices, DxioTopologyTableS1Ptr, DxioPcieEngine, 60, 63);
    }
