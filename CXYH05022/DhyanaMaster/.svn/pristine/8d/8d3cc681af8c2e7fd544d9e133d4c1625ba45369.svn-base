...
#include "OemIpmiNetFnDefinitions.h"//SGEZT#24420 Add OEM SEL Entry For PCIe Error Record+>
...
//<Kangmm-20190517 Modify OemData Follow Oem SEL spec+>
			...
			if (Status == EFI_SUCCESS){
                ...
                SelRecord->OEMEvData3 = (SelRecord->OEMEvData3<<0x5) | (ChannelNum << 0x2) | (DimmNum << 0x0);
            }
//<Kangmm-20190517 Modify OemData Follow Oem SEL spec->
...
{
    OEM_SEL_EPSR_E0_REQUEST     *SelRecord;
    ...
    SelRecord = (OEM_SEL_EPSR_E0_REQUEST*)ErrorBuffer;
    SelRecord->RecordId=0;
    SelRecord->RecordType=OEM_IPMI_SEL_E0_EPSR_RECORD;
    //AER Uncorrected=1
    SelRecord->ERTP.Field.ErrorType=1;
    if (GenPcieAerErrEntry->GenErrorDataEntry.ErrorSeverity == ERROR_SEVERITY_CORRECTED)
      SelRecord->ERTP.Field.ErrorType=0;//AER Corrected=0
    
    SelRecord->ERPD.Field.Bus=GenPcieAerErrEntry->PcieAerErrorSection.DeviceId.PrimaryBus;
    SelRecord->ERPD.Field.Device=GenPcieAerErrEntry->PcieAerErrorSection.DeviceId.Device;
    SelRecord->ERPD.Field.Function=GenPcieAerErrEntry->PcieAerErrorSection.DeviceId.Function;
    
    MemSet(&SelRecord->Reserved[0],6,0);
