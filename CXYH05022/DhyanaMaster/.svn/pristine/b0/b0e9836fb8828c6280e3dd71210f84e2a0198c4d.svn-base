  ...
  )
{
  ...
  UINT8               Gpio88, Gpio90, Gpio91;
  UINT8               GpioMatrix;

  Gpio88 = CpmTablePpiPtr->CommonFunction.GetGpio (CpmTablePpiPtr, 88);
  Gpio90 = CpmTablePpiPtr->CommonFunction.GetGpio (CpmTablePpiPtr, 90);
  Gpio91 = CpmTablePpiPtr->CommonFunction.GetGpio (CpmTablePpiPtr, 91);
