...
EFI_STATUS EnableOrDisableEachUSBPort() {
    ...
    if(SetupData.J37USBPort0) 
     ...
     if(SetupData.J53USBPort0) 
       {
           AmdCpmTableProtocolPtr->CommonFunction.SmnWrite32 (AmdCpmTableProtocolPtr, XHCI0_SOCKET, XHCI1_DIE, OEM_USB_PORT_DISABLE0, 0, EnableUsbPort);
           ...
           {
               AmdCpmTableProtocolPtr->CommonFunction.SmnWrite32 (AmdCpmTableProtocolPtr, XHCI0_SOCKET, XHCI1_DIE, OEM_USB_PORT_DISABLE0, 0, DisableUsbPort0);
           }      
       }
       else {
       ...
       {
           AmdCpmTableProtocolPtr->CommonFunction.SmnWrite32 (AmdCpmTableProtocolPtr, XHCI1_SOCKET, XHCI0_DIE, OEM_USB_PORT_DISABLE0, 0, EnableUsbPort);
       }
       else {
               AmdCpmTableProtocolPtr->CommonFunction.SmnWrite32 (AmdCpmTableProtocolPtr, XHCI1_SOCKET, XHCI0_DIE, OEM_USB_PORT_DISABLE0, 0, DisableUsbPort0);
            }
