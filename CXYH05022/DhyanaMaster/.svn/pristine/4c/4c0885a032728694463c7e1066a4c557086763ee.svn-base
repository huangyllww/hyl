...
typedef enum {
  SataGen1   = 1,                         ///< SATA port GEN1 speed
  SataGen2   = 2,                         ///< SATA port GEN2 speed
  SataGen3   = 3,                         ///< SATA port GEN3 speed
} SATA_SPEED;
...
#define DDR2666_FREQUENCY 1333    ///< DDR 2666 <Yaosr001-20181009 add memory clock 2666MHz>
#define DDR2933_FREQUENCY 1467    ///< DDR 2933
#define DDR3200_FREQUENCY 1600   ///< DDR 3200 //<libj-20220310 add memory 3200MHz option>
