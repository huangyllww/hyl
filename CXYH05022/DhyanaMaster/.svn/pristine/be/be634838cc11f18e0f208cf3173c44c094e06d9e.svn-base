...
#include "AmdMemSmbiosDxe.h"
#include "Library/UefiBootServicesTableLib.h"
#include "Filecode.h"

#define FILECODE        MEM_AMDMEMSMBIOSDXE_AMDMEMSMBIOSDXE_FILECODE
...
STATIC AMD_MEM_SMBIOS_SERVICES_PROTOCOL   mMemDmiServicesProtocol = {
  SMBIOS_3_0_0,      // Support SMBIOS 3.0
  GetMemDmiInfo
};
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "  AmdMemSmbiosCzDxe Entry\n");
  MemDmiInfo = NULL;

  if (AGESA_SUCCESS == MemConstructDmiInfo (NULL, &MemDmiInfo)) {
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "  AmdMemSmbiosCzDxe Exit\n");
  return Status;
}
