  ...
  )
{
  ...
  if (ApcbParaAttrib != NULL) {
    ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
    ApcbParaAttrib->Token = APCB_TOKEN_CBS_CMN_AVS_CTRL;
    ApcbParaAttrib->Size = (sizeof (UINT8) -1);
    ApcbParaAttrib++;
  }
  _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  //SPI
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_CMN_BIOS_SPI_SPEED_MODE;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  )
{
  ...
  //AVS
  if (ApcbParaValue != NULL) {
    if (Setup_Config->CbsCmnAvsCtrl == 0x1) {
      * ((UINT8 *) ApcbParaValue) = 0x0;
    } else {
      * ((UINT8 *) ApcbParaValue) = 0x1;
    }
    ApcbParaValue += sizeof (UINT8);
  }
  _Size += sizeof (UINT8);
  ...
  //SPISpeed
  if (ApcbParaValue != NULL) {
    * ((UINT8 *) ApcbParaValue) = Setup_Config->CbsCmnSPISpeedCtrl;
    ApcbParaValue += sizeof (UINT8);
  }
  _Size += sizeof (UINT8);
  ...
  )
{
  ...
  if (Setup_Config->CbsCmnMemCtrllerDramEccSymbolSizeDdr4 != 0xFF) {
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_DBG_MEM_CTRLLER_DRAM_ECC_SYMBOL_SIZE_DDR4;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  if (Setup_Config->CbsCmnMemCtrllerDramEccEnDdr4 != 0xFF) {
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_DBG_MEM_CTRLLER_DRAM_ECC_EN_DDR4;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  // Writr CRC Enable
  if (Setup_Config->CbsDbgMemCtrllerWrCrcEnDdr4 != 0) {
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_DBG_MEM_CTRLLER_WR_CRC_EN_DDR4;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  // Writr CRC Retry
  if (Setup_Config->CbsDbgMemWriteCrcRetryDdr4 != 0) {
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_DBG_MEM_WRITE_CRC_RETRY_DDR4;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  if (Setup_Config->CbsDbgMemWriteCrcErrorMaxReplayDdr4 != 0x3F) {
    if (ApcbParaAttrib != NULL) {
      ApcbParaAttrib->TimePoint = APCB_TIME_POINT_ANY;
      ApcbParaAttrib->Token = APCB_TOKEN_CBS_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4;
      ApcbParaAttrib->Size = (sizeof (UINT8) -1);
      ApcbParaAttrib++;
    }
    _Size += sizeof (APCB_PARAM_ATTRIBUTE);
  ...
  )
{
  ...
  if (Setup_Config->CbsDbgMemCtrllerWrCrcEnDdr4 != 0) {
    if (ApcbParaValue != NULL) {
      * ((UINT8 *) ApcbParaValue) = Setup_Config->CbsDbgMemCtrllerWrCrcEnDdr4;
      ApcbParaValue += sizeof (UINT8);
    }
    _Size += sizeof (UINT8);
  }
  ...
  if (Setup_Config->CbsDbgMemWriteCrcRetryDdr4 != 0) {
    if (ApcbParaValue != NULL) {
      * ((UINT8 *) ApcbParaValue) = Setup_Config->CbsDbgMemWriteCrcRetryDdr4;
      ApcbParaValue += sizeof (UINT8);
    }
    _Size += sizeof (UINT8);
  }
  ...
  if (Setup_Config->CbsDbgMemWriteCrcErrorMaxReplayDdr4 != 0x3F) {
    if (ApcbParaValue != NULL) {
      * ((UINT8 *) ApcbParaValue) = Setup_Config->CbsDbgMemWriteCrcErrorMaxReplayDdr4;
      ApcbParaValue += sizeof (UINT8);
    }
    _Size += sizeof (UINT8);
  }
