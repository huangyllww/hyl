...
//<zhouyj1-20220527 send gpio23 (AGPIO23_3  NVME_CARD_DET_N) to BMC. +>
...
//<zhangyan-20200910 Patch for mantis bug-0034029 that there is  different fw version from version gotten by ethtool.-  >
  ...
  NvmeLocationTag=PcdGet8(PcdRetimerPresent);
  DEBUG((EFI_D_ERROR, " *** NvmeLocationTag is  %x    ***\n",NvmeLocationTag));
...
//<zhangyan-20200910 Patch for mantis bug-0034029 that there is  different fw version from version gotten by ethtool.-  >
      ...
      if(NvmeLocationTag == 1 &&  (OemPcieInfo.PcieBusNum == 0x61 || OemPcieInfo.PcieBusNum == 0x62|| OemPcieInfo.PcieBusNum == 0x63|| OemPcieInfo.PcieBusNum == 0x64 )){
          OemPcieInfo.PcieLocation[0]=0x30;
