...
#define APCB_CLDO_BYPASS_CONFIG 	0
...
APCB_PARAM_ATTRIBUTE  InternalParameterListAttribute[] = {
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_MEM_FINE_GRAN_REF_DDR4, sizeof (UINT8) - 1, 0},
  ...
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DF_DBG_CAKE_REQ_ADDR_COMPRESSION, sizeof (BOOLEAN) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DF_DBG_CAKE_RSP_CMD_PACKING, sizeof (BOOLEAN) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DF_DBG_CAKE_PRB_COMBINING, sizeof (BOOLEAN) - 1, 0},
#endif

#if APCB_CLDO_BYPASS_CONFIG
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_E12_GA, sizeof (UINT8) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_DDR, sizeof (UINT8) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_WAFL, sizeof (UINT8) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_E12_GB, sizeof (UINT8) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_VDDM0, sizeof (UINT8) - 1, 0},
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CBS_DBG_CLDO_VDDM1, sizeof (UINT8) - 1, 0},
#endif
...
_1BYTE_ALIGN UINT8  InternalParameterListDefaultsValue[] = {
  BSU08 (0),                        //< DRAM Fine Granularity Refresh Rate.
...
#if APCB_CLDO_BYPASS_CONFIG
  //0:normal, 1:bypass to soc, 2:bypass to memory, 3:off
  BSU08 (0),
  BSU08 (0),
  BSU08 (0),
  BSU08 (0),
