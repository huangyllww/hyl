...
#define FCH_ML_PMIOA_REG04      0x04     // IsaControl
  ...
  )
{
  ...
  SmbusPrivate->SmbusPpi0.RegisterIndex      = FCH_ML_PMIOA_REG00;
  ...
  SmbusPrivate->SmbusPpi1.RegisterIndex      = FCH_ML_PMIOA_REG00;
