...
// AMI PORTING STARTS  
  ...
  EFI_EVENT    CloseEvent;		  ///<  TCP.Close triggering the CloseToken->CompletionToken once it is completed. If we wait until then in loop delays the activity so added event to trigger.
#endif
// AMI PORTING ENDS
