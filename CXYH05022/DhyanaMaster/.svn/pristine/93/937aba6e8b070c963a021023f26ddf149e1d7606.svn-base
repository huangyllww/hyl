...
//<Yaosr002-20211213 Add SMBIOS type130 for report bios minor version. +>
///
/// OEM Table (Type 129)
///
typedef struct {
  SMBIOS_STRUCTURE                  Hdr;
  SMBIOS_TABLE_STRING               BiosMinorVersion;
  SMBIOS_TABLE_STRING               BMCMinorVersion;
...
typedef union {
  ...
  SMBIOS_TABLE_TYPE130  *Type130; //<Yaosr002-20211213 Add SMBIOS type130 for report bios minor version.>
  UINT8                 *Raw;
