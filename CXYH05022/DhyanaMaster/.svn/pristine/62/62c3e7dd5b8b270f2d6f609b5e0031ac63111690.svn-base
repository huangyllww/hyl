...
#define MEM_AMDMBISTPEI_AMDMBISTPEI_FILECODE                              (0x1010)
#define MEM_AMDMEMPPRSMMDRIVER_MEM_AMDMEMPPRSMMDRIVER_FILECODE            (0x1011)
#define MEM_AMDMEMPEI_AGESAPEI_FILECODE                                   (0x1012)
...
#define LIBRARY_CCXSETMCAZPLIB_CCXSETMCAZPLIB_FILECODE                   (0x3023)
#define CCX_ZEN_CCXZENZPDXE_CCXZENZPACPIRAS_FILECODE                     (0x3024)
#define LIBRARY_CCXIDSCUSTOMPSTATESZENLIB_CCXIDSCUSTOMPSTATESZENLIB_FILECODE (0x3025)
#define LIBRARY_CCXIDSCUSTOMPSTATESNULLLIB_CCXIDSCUSTOMPSTATESNULLLIB_FILECODE (0x3026)
#define LIBRARY_CCXSETMMIOCFGBASELIB_CCXSETMMIOCFGBASELIB_FILECODE       (0x3027)
#define LIBRARY_DXECCXBASEX86SERVICESLIB_CCXBASEX86SERVICESDXE_FILECODE  (0x3028)
...
#define LIBRARY_FABRICRESOURCEMANAGERZENZPLIB_FABRICRESOURCEMANAGERZENZPLIB_FILECODE (0xDF0D)
...
#define FABRIC_ZP_FABRICZPDXE_FABRICACPIDOMAININFO_FILECODE              (0xDF16)
#define LIBRARY_PEIFABRICRESOURCESIZEFOREACHDIELIB_PEIFABRICRESOURCESIZEFOREACHDIELIB_FILECODE (0xDF17)
#define LIBRARY_DXEFABRICRESOURCESIZEFOREACHDIELIB_DXEFABRICRESOURCESIZEFOREACHDIELIB_FILECODE (0xDF18)
#define LIBRARY_FABRICRESOURCEMANAGERZENZPLIB_FABRICRESOURCEINITBASEONNVZENZP_FILECODE (0xDF19)
#define LIBRARY_FABRICRESOURCEMANAGERZENZPLIB_FABRICRESOURCEINITZENZPLIB_FILECODE (0xDF1A)
#define FABRIC_ZP_FABRICZPSMM_AMDFABRICZPSMM_FILECODE                    (0xDF1B)
#define LIBRARY_PEIFABRICTOPOLOGYSERVICESLIB_FABRICTOPOLOGYSERVICESPEI_FILECODE (0xDF1C)
#define LIBRARY_DXEFABRICTOPOLOGYSERVICESLIB_FABRICTOPOLOGYSERVICESDXE_FILECODE (0xDF1D)
#define LIBRARY_SMMFABRICTOPOLOGYSERVICESLIB_FABRICTOPOLOGYSERVICESSMM_FILECODE (0xDF1E)
#define FABRIC_ZP_FABRICZPDXE_FABRICACPIMSCT_FILECODE                    (0xDF1F)
...
#define LIBRARY_PCIEMISCCOMMLIB_PCIEMAXREADREQLIB_FILECODE           (0xA129)
#define LIBRARY_NBIOAZALIALIB_NBIOAZALIALIB_FILECODE                 (0xA12A)
#define LIBRARY_SMNACCESSLIB_SMNACCESSLIB_FILECODE                   (0xA12B)
#define LIBRARY_DXIOLIBV1_DXIOANCDATAV1_FILECODE                     (0xA12C)
#define LIBRARY_PCIEMISCCOMMLIB_PCIELTRLIB_FILECODE                  (0xA12D)
#define LIBRARY_PCIEMISCCOMMLIB_PCIEMAXCPLPAYLOADLIB_FILECODE        (0xA12E)
#define LIBRARY_PCIEMISCCOMMLIB_PCIEGEN4WORKAROUND_FILECODE          (0xA12F)
...
#define NBIO_PCIE_AMDNBIOPCIEZPPEI_DXIOCFGPOINTSZP_FILECODE               (0xA227)

#define NBIO_PCIE_AMDNBIOPCIERVPEI_AMDNBIOPCIERVPEI_FILECODE              (0xA228)
#define NBIO_PCIE_AMDNBIOPCIERVPEI_DXIOINITRV_FILECODE                    (0xA229)
#define NBIO_PCIE_AMDNBIOPCIERVPEI_HIDEPORTSRV_FILECODE                   (0xA22A)
#define NBIO_PCIE_AMDNBIOPCIERVPEI_PCIEREMAPRV_FILECODE                   (0xA22B)
#define NBIO_PCIE_AMDNBIOPCIERVPEI_DEVICECONTROLRV_FILECODE               (0xA22C)
#define NBIO_PCIE_AMDNBIOPCIERVPEI_PCIEHOTPLUGRV_FILECODE                 (0xA22D)

#define NBIO_IOMMU_AMDNBIOIOMMUZPPEI_AMDNBIOIOMMUZPPEI_FILECODE           (0xA22E)
#define NBIO_PCIE_AMDNBIOPCIEZPPEI_DPCSTATUSREPORT_FILECODE               (0xA22F)
...
#define NBIO_SMU_AMDNBIOSMUV9DXE_PCIEHOTPLUGV9_FILECODE                   (0xA242)
...
#define LIBRARY_MEM_REPORTINFOLIB_AMDMEMREPORTINFOLIB_FILECODE            (0xF441)
...
#define LIBRARY_MEMSMBIOSV2LIB_MEMSMBIOSV2_320LIB_FILECODE                 (0xF690)
//add smbios 3.2 support
...
#define LIBRARY_SOCCMNIDSHOOKLIB_PEI_SOCCMNIDSHOOKLIBPEI_FILECODE         (0xD00E)
#define LIBRARY_SOCCMNIDSHOOKLIB_DXE_SOCCMNIDSHOOKLIBDXE_FILECODE         (0xD00F)
#define SOC_AMDSOCSP3R2TRPEI_AMDSOCSP3R2TRPEI_FILECODE                    (0xD010)
#define SOC_AMDSOCSP3R2TRDXE_AMDSOCSP3R2TRDXE_FILECODE                    (0xD011)
#define LIBRARY_DXESOCLOGICALIDSERVICESLIB_SOCLOGICALIDSERVICESDXE_FILECODE         (0xD012)
#define LIBRARY_PEISOCLOGICALIDSERVICESLIB_SOCLOGICALIDSERVICESPEI_FILECODE         (0xD013)
#define LIBRARY_BASESOCLOGICALIDXLATBRLIB_BASESOCLOGICALIDXLATBRLIB_FILECODE        (0xD014)
#define LIBRARY_BASESOCLOGICALIDXLATZPDIELIB_BASESOCLOGICALIDXLATZPDIELIB_FILECODE  (0xD015)
#define LIBRARY_BASESOCLOGICALIDXLATRVDIELIB_BASESOCLOGICALIDXLATRVDIELIB_FILECODE  (0xD016)
#define LIBRARY_PEISOCBISTLOGGINGLIB_SOCBISTLOGGINGLIB_FILECODE                     (0xD017)
#define LIBRARY_PEISOCBISTZPLIB_PEISOCBISTZPLIB_FILECODE                            (0xD018)
...
//RAS
#define LIBRARY_RASSMMLIB_RASSMMLIB_FILECODE                              (0xC001)
#define LIBRARY_RASBASELIB_RASBASELIB_FILECODE                            (0xC002)

#define RAS_AMDRASAPEIDXE_AMDRASAPEIDXE_FILECODE                          (0xC101)
#define RAS_AMDRASDXE_AMDRASDXE_FILECODE                                  (0xC102)
#define RAS_AMDRASSMM_AMDRASSMM_FILECODE                                  (0xC103)

//APCB
#define PSP_APCB_APCBZPDXE_APCBZPDXE_FILECODE                              (0xC200)
#define PSP_APCB_APCBZPSMM_APCBZPSMM_FILECODE                              (0xC201)
#define PSP_APCB_TOKENS_CBS_EXT_TOKENS_FILECODE                            (0xC202)
#define PSP_APCB_TOKENS_CONFIG_TOKENS_FILECODE                             (0xC203)

#define LIBRARY_APCBLIB_APCBLIB_FILECODE                                  (0xC210)
#define LIBRARY_APCBLIB_APCBREPLACETYPE_FILECODE                          (0xC211)
#define LIBRARY_APCBLIB_DRAMPOSTPACKAGEREPAIR_FILECODE                    (0xC212)
#define LIBRARY_APCBLIB_GETSETPARAMS_FILECODE                             (0xC213)
