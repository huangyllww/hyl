...
//Fix Pstate
IDS_NV_READ_SKIP (IDSNVID_CPU_PST_FIX, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_CPU_PST_FIX_AUTO:
    break;
  case IDSOPT_CPU_PST_FIX_P0:
    break;
  case IDSOPT_CPU_PST_FIX_P1:
    break;
  case IDSOPT_CPU_PST_FIX_P2:
    break;
  default:
    ASSERT (FALSE);
    break;
...
// Writr CRC Enable
IDS_NV_READ_SKIP (IDSNVID_DBG_MEM_CTRLLER_WR_CRC_EN_DDR4, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_DBG_MEM_CTRLLER_WR_CRC_EN_DDR4_DISABLED:
    break;
  case IDSOPT_DBG_MEM_CTRLLER_WR_CRC_EN_DDR4_ENABLED:
    break;
  default:
    ASSERT (FALSE);
    break;
...
// Writr CRC Retry
IDS_NV_READ_SKIP (IDSNVID_DBG_MEM_WRITE_CRC_RETRY_DDR4, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_DBG_MEM_WRITE_CRC_RETRY_DDR4_DISABLED:
    break;
  case IDSOPT_DBG_MEM_WRITE_CRC_RETRY_DDR4_ENABLED:
    break;
  default:
    ASSERT (FALSE);
    break;
...
IDS_NV_READ_SKIP (IDSNVID_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4, &IdsNvValue) {
  ASSERT (IdsNvValue <= IDSOPT_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4_MAX);
  ASSERT (IdsNvValue >= IDSOPT_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4_MIN);
}
