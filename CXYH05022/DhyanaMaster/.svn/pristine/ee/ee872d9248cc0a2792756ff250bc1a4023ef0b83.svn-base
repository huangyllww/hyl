...
void     *_memcpy(void * __restrict Dest, const void * __restrict Src, size_t N);
#define memcpy(x,y,z) _memcpy(x,y,z)// memcopy renamed because of AmiDxeLib conflict
#else 
//!!!AMI PORTING ENDS!!!
...
**/
void     *_memset(void *S, int C, size_t N); //!!!AMI PORTING!!!

#define memset(x,y,z) _memset(x,y,z) //!!!AMI PORTING!!! memset renamed because of AmiDxeLib conflict
