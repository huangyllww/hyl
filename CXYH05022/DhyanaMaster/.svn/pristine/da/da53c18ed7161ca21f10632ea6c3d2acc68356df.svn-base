...
#define NVME_CARD_DET_N(ValidSeeting) 23,DIE3,SOCKET0,ValidSeeting,"NVME_CARD_DET_N" 
...
SMBIOS_TYPE_8 PortConnectorInfo[] = {        
        ...
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J37 USB0&1", "USB3-REAR UP"},
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J37 USB0&1", "USB3-REAR DOWN"},
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J53 USB0&1", "USB3-FP RIGHT"},
        {{{8, 0x09, 0}, 1, 0x12, 2, 0x12, 0x10}, "J53 USB0&1", "USB3-FP LEFT"},
        {{{8, 0x09, 0}, 1, 0xFF, 0, 0, 0xFF}, "J29 M2_0"},
        {{{8, 0x09, 0}, 1, 0x12, 0, 0, 0X10}, "TypeA_USB (J56)"}, 
      
};

GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo_4Die[] = {
    {    SYS_SLOT_PCIE_3,    DBW_4X, SHORT_LENGTH, 0xFF, 0xFF,  "U.2",    L"PciRoot(0x0)/Pci(0x1,0x1)",    FALSE, FALSE, SATA_CPU0_DET_N(InputHigh), INVALID_SETTING_ARRARY },//J27
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x2, 0x2,   "Slot2",    L"PciRoot(0x0)/Pci(0x1,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY},
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0xFF, 0xFF,   "OCP2.0",    L"PciRoot(0x2)/Pci(0x3,0x1)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x5, 0x5,  "RAID_Slot",    L"PciRoot(0x2)/Pci(0x3,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x4, 0x4,  "Slot4",    L"PciRoot(0x4)/Pci(0x1,0x1)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x3, 0x3,  "Slot3",    L"PciRoot(0x4)/Pci(0x1,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,   "Slot1",    L"PciRoot(0x6)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputHigh), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x6)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo_2Die[] = {
    {    SYS_SLOT_PCIE_3,    DBW_4X, SHORT_LENGTH, 0xFF, 0xFF,  "U.2",    L"PciRoot(0x0)/Pci(0x1,0x1)",    FALSE, FALSE, SATA_CPU0_DET_N(InputHigh), INVALID_SETTING_ARRARY },//J27
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x2, 0x2,   "Slot2",    L"PciRoot(0x0)/Pci(0x1,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY},
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0xFF, 0xFF,   "OCP2.0",    L"PciRoot(0x1)/Pci(0x3,0x1)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x5, 0x5,  "RAID_Slot",    L"PciRoot(0x1)/Pci(0x3,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x4, 0x4,  "Slot4",    L"PciRoot(0x2)/Pci(0x1,0x1)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x3, 0x3,  "Slot3",    L"PciRoot(0x2)/Pci(0x1,0x2)",    FALSE, FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,   "Slot1",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputHigh), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0xFF, 0xFF,   "U.2",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, FALSE, NVME_CARD_DET_N(InputLow), INVALID_SETTING_ARRARY },
    {    0xFF, 0xFF,0xFF, 0xFF,0xFF, NULL, NULL, FALSE, FALSE, INVALID_SETTING_ARRARY },
