...
VOID OemReadyToBootNotify(
  ...
  IN VOID *Context)
{ 
  static BOOLEAN OemReadyToBootNotifyIsSaved = FALSE;//<Lvshh001-20221108 For MemoryLeak Fix,otherwise when the EfiBootServicesData increases too much, the hang60 will occur>

  //<Lvshh001-20221108 For MemoryLeak Fix,otherwise when the EfiBootServicesData increases too much, the hang60 will occur +>
  if (OemReadyToBootNotifyIsSaved){
      return;
  }
  OemReadyToBootNotifyIsSaved = TRUE;
  //<Lvshh001-20221108 For MemoryLeak Fix,otherwise when the EfiBootServicesData increases too much, the hang60 will occur ->
