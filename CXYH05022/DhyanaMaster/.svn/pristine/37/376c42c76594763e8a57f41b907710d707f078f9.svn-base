    ...
    IN volatile VOID *Context)
{
    ...
    UINT32          FeatureFlagsEax; //SGEZT#25449:Version C CPUs are mixed, and CPU information displays are inconsistent->
    ...
    //    WriteMsr(HYGON_MSR_SVM, Msr64Data);
     ...
     //   Get HG CPU FamModStepExt
     //SGEZT#25449:Version C CPUs are mixed, and CPU information displays are inconsistent+>

        CPULib_CpuID(1, &FeatureFlagsEax, NULL, NULL, &FeatureFlagsEdx);
        AmiCpuInfo->FamModStep=FeatureFlagsEax;
        AmiCpuInfo->FeatureId=FeatureFlagsEdx;
        DEBUG((EFI_D_ERROR, "[OemDbg][%a][%d]FeatureFlagsEax:%x(%x)\r\n",__FUNCTION__,__LINE__,FeatureFlagsEax,Cpu));
//SGEZT#25449:Version C CPUs are mixed, and CPU information displays are inconsistent->
