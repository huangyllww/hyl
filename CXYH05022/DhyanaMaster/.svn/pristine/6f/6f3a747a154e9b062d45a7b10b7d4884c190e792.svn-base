...
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHonghaiSL1SLTS1;
extern  AMD_CPM_PLATFORM_ID_TABLE                 gCpmPlatformIdTable;
extern  HYGON_CPM_EQ_CONFIG_TABLE                 gCpmEqConfigurationTableHonghaiSL1SLT;
...
VOID *gCpmTableList[] = {
  ...
  &gCpmDxioTopologyTableHonghaiSL1SLTS1,
  &gCpmEqConfigurationTableHonghaiSL1SLT,
  NULL
};
    ...
    if (EngineDescriptor->EngineData.EngineType == DxioEthernetEngine) {
      ...
      case 5:
        // Initialize this descriptor for Port 1
          ...
          MacPointer += 4;
          //Value = *((UINT32*) MacPointer); // delete it
