...
{
    EFI_STATUS Status;
    static BOOLEAN RegisterTpmMeasurementIsSaved = FALSE;//<Lvshh001-20221108 For MemoryLeak Fix,otherwise when the EfiBootServicesData increases too much, the hang60 will occur>
    ...
    if (RegisterTpmMeasurementIsSaved){
        return;
    }
    RegisterTpmMeasurementIsSaved = TRUE;
    //<Lvshh001-20221108 For MemoryLeak Fix,otherwise when the EfiBootServicesData increases too much, the hang60 will occur ->
