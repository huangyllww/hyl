...
)
{
    ...
    if (EFI_ERROR(Status)) {
    	...
    	NbSetupData->EnableBankIntlv = 0;
        NbSetupData->EnableChannelIntlv = 0;
    	NbSetupData->MemClk = 0;
    	NbSetupData->MemClrFlag = 0;
    	NbSetupData->MemClr = 0;
        // Porting End
...
/*
    	NbSetupData->EnableBankIntlv = SetupData.EnableBankIntlv;
        NbSetupData->EnableChannelIntlv = SetupData.EnableChannelIntlv;
    	NbSetupData->MemClk = SetupData.MemClk;
    	NbSetupData->MemClrFlag = SetupData.MemClrFlag;
    	NbSetupData->MemClr = SetupData.MemClr;*/
