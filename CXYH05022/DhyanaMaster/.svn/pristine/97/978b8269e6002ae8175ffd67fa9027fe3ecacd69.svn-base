  ...
  )
{
  ...
  //<Zhenglch-20230531-Add Data Link Feature Control function+>
  UINT32                          Addr = 0;
  UINT8                           DataLinkFeature = 1;
  //<Zhenglch-20230531-Add Data Link Feature Control function->
  ...
  //<Zhenglch-20230531-Add Data Link Feature Control function+>
  DataLinkFeature = PcdGet8(PcdDataLinkFeature);
  IDS_HDT_CONSOLE (GNB_TRACE, "DataLinkFeature PcdGet = %d\n",DataLinkFeature);
  //<Zhenglch-20230531-Add Data Link Feature Control function->
  ...
  //<Zhenglch-20230531-Add Data Link Feature Control function+>
      if(DataLinkFeature == 0)
      {
        IDS_HDT_CONSOLE (GNB_TRACE, "Data Link Feature needs disabled\n");
        if(PcieEngine->Type.Port.PortId < 8 )
        {
          Addr = DXIO_STRAP_BIF_BASEADDRSS + 0x357 + (PcieEngine->Type.Port.PortId << 4);
        }
        else
        {
          Addr = DXIO_STRAP_BIF_BASEADDRSS + 0x357 + ((PcieEngine->Type.Port.PortId - 8) << 4);
        }
  ...
  //<Zhenglch-20230531-Add Data Link Feature Control function->
      ...
      PcieEqConfigurationBeforeTraining (GnbHandle, PcieEngine);
      PcieEngine = PcieLibGetNextDescriptor (PcieEngine);
    }
    for (Index = 0; Index < 8; Index++) {
