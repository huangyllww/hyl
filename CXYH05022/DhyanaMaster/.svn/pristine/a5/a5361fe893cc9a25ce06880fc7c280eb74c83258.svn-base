...
#define		MTRRFixDRAMEnBit	18
		// Enables Hygon Fixed MTRR extensions
...
#define	HYGON_MSR_IORR_MASK0		0xC0010017
#define	HYGON_MSR_IORR_BASE1		0xC0010018
#define	HYGON_MSR_IORR_MASK1		0xC0010019
#define	HYGON_MSR_TOP_MEM			0xC001001A
#define	HYGON_MSR_TOP_MEM2		0xC001001D
#define	HYGON_MSR_MC4_CTL			0xC0010048
#define	HYGON_MSR_NB_CFG			0xC001001F

#define	HYGON_MSR_SMI_TRIGGER_IO		0xC0010056
#define HYGON_MSR_PSTATE_CONTROL          	0xC0010062
#define	HYGON_MSR_UNLOCK			0x9C5A203A		// MSR unlock code
#define	HYGON_PP_MSR_NB_CFG		0xC001101F
#define	HYGON_PP_MSR_LS_CFG		0xC0011020
#define	HYGON_PP_MSR_IC_CFG		0xC0011021
#define	HYGON_PP_MSR_DC_CFG		0xC0011022
#define	HYGON_PP_MSR_BU_CFG		0xC0011023

#define	HYGON_MSR_EFER				0xC0000080
#define	HYGON_MSR_SYS_CFG				0xC0010010
#define	HYGON_MSR_CLK_CTRL			0xC001001B
#define	HYGON_MSR_PATCH_LOADER		0xC0010020
#define	HYGON_MSR_NAME0				0xC0010030
#define	HYGON_MSR_NAME1				0xC0010031
#define	HYGON_MSR_NAME2				0xC0010032
#define	HYGON_MSR_NAME3				0xC0010033
#define	HYGON_MSR_NAME4				0xC0010034
#define	HYGON_MSR_NAME5				0xC0010035
#define	HYGON_MSR_FIDVID_CTL			0xC0010041
#define	HYGON_MSR_FIDVID_STS			0xC0010042
#define	HYGON_MSR_C1E_INIT			0xC0010055
#define HYGON_MSR_COFVID_STAT			0xC0010071
#define	HYGON_MSR_SYSBUS_IOBASE		0xC0010100
#define	HYGON_MSR_SYSBUS_CONFIGBASE	0xC0010101
#define	HYGON_MSR_SYSBUS_IACKBASE		0xC0010102
#define	HYGON_MSR_SYSBUS_SPEC_CYCBASE	0xC0010103
#define	HYGON_MSR_SYSBUS_UPPER_ADD	0xC0010104
#define	HYGON_MSR_SMM_ENTER_SCYC		0xC0010105
#define	HYGON_MSR_SMM_EXIT_SCYC		0xC0010106
#define	HYGON_MSR_SMM_BASE			0xC0010111
#define	HYGON_MSR_SMM_ADDR_HL			0xC0010112
#define	HYGON_MSR_SMM_MASK_HL			0xC0010113
#define HYGON_MSR_SVM                 0xC0010114
#define	BIT_SMM_AValid		        0		        // Enable SMRAM access 

#define HYGON_MSR_MMIO_CFG_BASE		0xC0010058
#define HYGON_MSR_PSP_ADDR            0xC00110A2

#define HYGON_MSR_CPUID_NAME_STRING0  0xC0010030      // First CPUID namestring register
#define HYGON_MSR_CPUID_NAME_STRING1  0xC0010031
#define HYGON_MSR_CPUID_NAME_STRING2  0XC0010032
#define HYGON_MSR_CPUID_NAME_STRING3  0xC0010033
#define HYGON_MSR_CPUID_NAME_STRING4  0xC0010034
#define HYGON_MSR_CPUID_NAME_STRING5  0xC0010035      // Last CPUID namestring register
//-----------------------------------------------------------------------------
//		Extended CPUID Equates
//-----------------------------------------------------------------------------
#define HYGON_EXT_CPUID_0             0x80000000
#define HYGON_EXT_CPUID_1             0x80000001
#define HYGON_EXT_CPUID_2             0x80000002
#define HYGON_EXT_CPUID_3             0x80000003
#define HYGON_EXT_CPUID_4             0x80000004
#define HYGON_EXT_CPUID_5             0x80000005
#define HYGON_EXT_CPUID_6             0x80000006
#define HYGON_EXT_CPUID_7             0x80000007
#define HYGON_EXT_CPUID_8             0x80000008
#define HYGON_EXT_CPUID_1E            0x8000001E
#define HYGON_CPU_NAME_CPUID_1        HYGON_EXT_CPUID_2
#define HYGON_CPU_NAME_CPUID_2        HYGON_EXT_CPUID_3
#define HYGON_CPU_NAME_CPUID_3        HYGON_EXT_CPUID_4
#define HYGON_L1_CACHE_CPUID          HYGON_EXT_CPUID_5
#define HYGON_L2_CACHE_CPUID          HYGON_EXT_CPUID_6
#define HYGON_CORE_IDENTIFIERS		HYGON_EXT_CPUID_1E
#define HYGON_MSR_MCODE_SIGNATURE     0x8b
                                                    // to the A000 Segment
...
static UINT32  MtrrRegs[] = {
    ...
    HYGON_MSR_SMM_ADDR_HL, HYGON_MSR_SMM_MASK_HL,
    HYGON_MSR_IORR_BASE0, HYGON_MSR_IORR_MASK0,
    HYGON_MSR_IORR_BASE1, HYGON_MSR_IORR_MASK1,
    MSR_SYS_CFG,
    HYGON_MSR_MMIO_CFG_BASE,
    HYGON_MSR_SMI_TRIGGER_IO
};
