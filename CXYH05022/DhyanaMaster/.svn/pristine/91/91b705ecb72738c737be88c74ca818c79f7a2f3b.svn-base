  ...
  )
{
  ...
  if ((SectionAlignment & (EFI_ACPI_RUNTIME_PAGE_ALLOCATION_ALIGNMENT - 1)) != 0) {
    //*** AMI PORTING BEGIN ***//
    // Improvement: Since properties table is an optional feature, do not report the message with EFI_D_WARN category.
    //DEBUG ((EFI_D_WARN, "!!!!!!!!  InsertImageRecord - Section Alignment(0x%x) is not %dK  !!!!!!!!\n",
      DEBUG ((EFI_D_VERBOSE, "!!!!!!!!  InsertImageRecord - Section Alignment(0x%x) is not %dK  !!!!!!!!\n",
