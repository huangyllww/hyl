...
wchar_t *HiiLib_GetHiiString( UINT8 *DataTable, UINT8 *HiiData, UINT16 Token ,BOOLEAN MapLangFlag)
{
...
VOID _GetStdMfgDefaultsBuffer()
{
	...
	gu32StdAttributes = 0;
	gu64StdSize = 0;
	gpStdBuf = ( char* )HiiLib_VarGetNvramName( STD_DEFAULTS, &DefaultsGuid, &gu32StdAttributes, (UINTN *)&gu64StdSize );
	if(gpStdBuf != NULL)
		gIsStdBuf = 1;

	gu32MfgAttributes = 0;
	gu64MfgSize = 0;
	gpMfgBuf = ( char* )HiiLib_VarGetNvramName( MFG_DEFAULTS, &DefaultsGuid, &gu32MfgAttributes, (UINTN *)&gu64MfgSize );
	if(gpMfgBuf != NULL)
		gIsMfgBuf = 1;
}
...
//<AMI_PHDR_START>
//--------------------------------------------------------------------------------
// Procedure	: InitializeStdLibrary
//
...
//---------------------------------------------------------------------------------
//<AMI_PHDR_END>
VOID InitializeStdLibrary(VOID)
{
	UINTN   ExitVal;
	UINTN i = 0;
