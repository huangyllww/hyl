        ...
        if (!gTerminalSerialSupport.SerialPortsEnabledVar.PortsEnabled[gTotalSioSerialPorts+i]) {
            if(!gTerminalSerialSupport.PciSerialPortsLocationVar.AmiPciSerialPresent[i]){
                if ((gTerminalSerialSupport.PciSerialPortsLocationVar.Bus[i] == 0) &&
                    ...
                    //
                    //Its not PCI serial Device, Initialise Bus,Dev,func,AmiPciSerialPresent,Port to Zero and set variable to represent that device is not present.
                    //
                    gTerminalSerialSupport.PciSerialPortsLocationVar.Bus[i] = 0;
                    gTerminalSerialSupport.PciSerialPortsLocationVar.Device[i] = 0;
                    gTerminalSerialSupport.PciSerialPortsLocationVar.Function[i] = 0;
                    gTerminalSerialSupport.PciSerialPortsLocationVar.AmiPciSerialPresent[i] = 0;
                    gTerminalSerialSupport.PciSerialPortsLocationVar.Port[i] = 0;
                    //
