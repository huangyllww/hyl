...
//
// AMI PORTING for Pre PXE boot STARTS.
// 
...
//
// Description		:	Empty function which does nothing. Without this CreateEventEx fails.
//
// Input			:	None
//
// Output			:	None
...
//----------------------------------------------------------------------------
//
// Procedure		:	NotifyPrePxeBoot
//
// Description		:	Notifies the events that are registered with gReadyToPxeBootGuid.
//
// Input			:	EFI_LOAD_FILE_PROTOCOL	*ThisCopy
//
// Output			:	None
//----------------------------------------------------------------------------
//<AMI_PHDR_END>
...
//
// AMI PORTING for Pre PXE boot ENDS.
// 
  ...
  )
{
  ...
  //SGMTB#163016:NO MAC Info During PXE Loop+>
  MacDevicePath = Private->DevicePath;
  ...
  NotifyPrePxeBoot(This);		// AMI PORTING for pre PXE boot
  //
  ...
  //
  //AsciiPrint ("\n\r>>Checking Media Presence......"); //SGMTB#163016:NO MAC Info During PXE Loop+>
  ...
  while (TRUE) {
    ...
    AsciiPrint ("\n\r>>Checking Media Presence(PXE:%d)......",FilePathIndex);//SGMTB#163016:NO MAC Info During PXE Loop+>
    //<Wangyia001-20180116 Mantis 18274: User can not get the effect when Media detect count is set to different value ->
