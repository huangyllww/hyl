...
STRING_TOKEN(STR_SAVE_SHUTDOWN)
STRING_TOKEN(STR_SAVE_SHUTDOWN_MSG)
#endif
//<Chendl001-20191221 System can power off under BIOS Setup ->
...
//<zhanghy2010-20200413 add new token +>
STRING_TOKEN(STR_NAV_STRINGS_5_AK)
STRING_TOKEN(STR_NAV_STRINGS_6_AK)
STRING_TOKEN(STR_MAIN_TITLE_AK)
STRING_TOKEN(STR_HELP_TITLE_AK)
//<zhanghy2010-20200413 add new token ->
#endif
