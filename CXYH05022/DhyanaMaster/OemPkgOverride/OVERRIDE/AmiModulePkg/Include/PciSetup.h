...
#define PCI_CLOBAL_ARI_QID		0x7030 
...
typedef struct _PCI_COMMON_SETUP_DATA {
    ...
    UINT8	AriSupport;  			///[Disable]\ Enable
...
#endif
#if defined(ACS_CONTROL_SUPPORT) && (ACS_CONTROL_SUPPORT == 1)
    UINT8   ACSControl;             //[Disable]\ Enable  
#endif //_ACS_CONTROL_SUPPORT
