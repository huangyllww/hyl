  ...
  )
{
  ...
  if (Setup_Config->CbsCmnCpuPfeh != 0x0) {
    ...
    PcdSet16S (PcdMcaProErrThreshCount, (4095 - Setup_Config->McaProErrThreshCount));//SGMTB#161493:PcdMcaProErrThreshCount is assigned to an incorrect value
  ...
  PcdSet8S (PcdSeparateDIMMECCLog, Setup_Config->SeparateDIMMECCLog);
  #endif
  //SGEZT#26230:Mask ECC Error For OS ->
