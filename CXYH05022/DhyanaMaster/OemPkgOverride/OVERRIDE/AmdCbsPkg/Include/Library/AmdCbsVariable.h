...
#include "Token.h"  //SGEZT#23035:PCIe Leaky Buckey +>
...
//<hujf1001-20200512 Add Fix P state feature +>
  UINT8         CbsCpuPstateFix;                                  ///< Fix Pstate
  UINT8         CbsCpuPstFid[3];                                  ///<   default Pstate FID
  UINT8         CbsCpuPstDid[3];                                  ///<   default Pstate DID
  UINT8         CbsCpuPstVid[3];                                  ///<   default Pstate VID
//<hujf1001-20200512 Add Fix P state feature ->
  ...
  UINT16        McaMemErrThreshCount;                             ///< McaMemErrThreshCount;
  UINT16        McaProErrThreshCount;                             ///< McaProErrThreshCount;
  UINT32        MemLeakyBucketInterval;                                ///< McaMemErrInterval;
  UINT16        MemLeakyBucketDropOutCnt;                                 ///< McaProErrDropOut
  //mizl-2021-12-09-Sync Setup Setting With BIOS Setup Layout V0.5->
  UINT8         CbsDfCmnNumaMode;                                 ///< Numa mode //<Yaosr-20211104 Control NUMA enable or disable.>

//SGEZT#23035:PCIe Leaky Buckey +>
#if defined(PCIE_LEAKY_BUCKET_SUPPORT) && (PCIE_LEAKY_BUCKET_SUPPORT ==1)  
  UINT16        McaPcieErrThreshCount;
  UINT32        PcieLeakyBucketInterval;
  UINT16        PcieLeakyBucketDropOutCnt;
  UINT8         SeparateAERLog;
#endif  
//SGEZT#23035:PCIe Leaky Buckey ->
//SGEZT#26230:Mask ECC Error For OS +>
#if defined(DEFAULT_SEPARATE_DIMM_ECC_LOG)
  UINT8         SeparateDIMMECCLog; 
#endif
//SGEZT#26230:Mask ECC Error For OS =>
} CBS_CONFIG;
