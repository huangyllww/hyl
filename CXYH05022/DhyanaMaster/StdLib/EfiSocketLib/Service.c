...
extern	ESLLAYERINFO	*gEslLayerInfo;
extern	UINTN			gEslLayerInstance;
extern	UINTN			gEntryCount;
      ...
      if (EFI_SUCCESS == Status)
      {
          ...
          if ( !EFI_ERROR ( Status ))
          {
             ...
             *ppServiceListHead = pService;
             ...
             gEslLayerInfo[gEslLayerInstance].Address[gEntryCount] = (UINT64)pService;
             gEntryCount++;
