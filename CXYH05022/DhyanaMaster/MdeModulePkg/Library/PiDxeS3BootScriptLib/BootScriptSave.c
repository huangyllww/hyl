...

{
  ...
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SaveIoWrite8 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Buffer));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SaveIoWrite16 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Buffer));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SaveIoWrite32 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Buffer));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SaveIoWrite64 - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, *(UINT64 *)Buffer));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SaveIoReadWrite8 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Data, *(UINT8 *)DataMask));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SaveIoReadWrite16 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Data, *(UINT16 *)DataMask));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SaveIoReadWrite32 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Data, *(UINT32 *)DataMask));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SaveIoReadWrite64 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT64 *)Data, *(UINT64 *)DataMask));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SaveMemWrite8 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Buffer));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SaveMemWrite16 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Buffer));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SaveMemWrite32 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Buffer));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SaveMemWrite64 - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, *(UINT64 *)Buffer));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SaveMemReadWrite8 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Data, *(UINT8 *)DataMask));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SaveMemReadWrite16 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Data, *(UINT16 *)DataMask));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SaveMemReadWrite32 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Data, *(UINT32 *)DataMask));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SaveMemReadWrite64 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT64 *)Data, *(UINT64 *)DataMask));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SavePciCfgWrite8 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Buffer));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SavePciCfgWrite16 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Buffer));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SavePciCfgWrite32 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Buffer));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SavePciCfgWrite64 - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, *(UINT64 *)Buffer));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SavePciCfgReadWrite8 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Data, *(UINT8 *)DataMask));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SavePciCfgReadWrite16 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Data, *(UINT16 *)DataMask));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SavePciCfgReadWrite32 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Data, *(UINT32 *)DataMask));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SavePciCfgReadWrite64 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT64 *)Data, *(UINT64 *)DataMask));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SavePciCfg2Write8 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Buffer));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SavePciCfg2Write16 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Buffer));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SavePciCfg2Write32 - 0x%08x (%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Buffer));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SavePciCfg2Write64 - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, *(UINT64 *)Buffer));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case S3BootScriptWidthUint8:
      DEBUG ((EFI_D_INFO, "SavePciCfg2ReadWrite8 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT8 *)Data, *(UINT8 *)DataMask));
      break;
  case S3BootScriptWidthUint16:
      DEBUG ((EFI_D_INFO, "SavePciCfg2ReadWrite16 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT16 *)Data, *(UINT16 *)DataMask));
      break;
  case S3BootScriptWidthUint32:
      DEBUG ((EFI_D_INFO, "SavePciCfg2ReadWrite32 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT32 *)Data, *(UINT32 *)DataMask));
      break;
  case S3BootScriptWidthUint64:
      DEBUG ((EFI_D_INFO, "SavePciCfg2ReadWrite64 - 0x%08x (%x-%x-%x)\n", Script, (UINT32)Address, *(UINT64 *)Data, *(UINT64 *)DataMask));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  {
  case 8:
      DEBUG ((EFI_D_INFO, "SaveSmbusExecute8 - 0x%08x (%x-%x)\n", Script, (UINT32)SmBusAddress, *(UINT8 *)Buffer));
      break;
  case 16:
      DEBUG ((EFI_D_INFO, "SaveSmbusExecute16 - 0x%08x (%x-%x)\n", Script, (UINT32)SmBusAddress, *(UINT16 *)Buffer));
      break;
  case 32:
      DEBUG ((EFI_D_INFO, "SaveSmbusExecute32 - 0x%08x (%x-%x)\n", Script, (UINT32)SmBusAddress, *(UINT32 *)Buffer));
      break;
  case 64:
      DEBUG ((EFI_D_INFO, "SaveSmbusExecute64 - 0x%08x (%x-%x)\n", Script, (UINT32)SmBusAddress, *(UINT64 *)Buffer));
      break;
  default:
      break;
  }
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "ScriptSaveStall - 0x%08x (%lx)\n", Script, Duration));
  SyncBootScript (Script);
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "ScriptSaveDispatch2 - 0x%08x (%lx)\n", Script, Context));
  SyncBootScript (Script);
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "SaveMemPoll - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, LoopTimes));
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "ScriptSaveInformation2 - 0x%08x (%lx)\n", Script, Information));
  SyncBootScript (Script);
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "ScriptSaveDispatch - 0x%08x (%lx)\n", Script, EntryPoint));
  SyncBootScript (Script);
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "SaveIoPoll - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, Delay));
  SyncBootScript (Script);
...
)
{
  ...
  DEBUG ((EFI_D_INFO, "SavePciPoll - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, Delay));
  SyncBootScript (Script);
...
)
{
  ...
  DEBUG ((EFI_D_INFO, "SavePci2Poll - 0x%08x (%x-%lx)\n", Script, (UINT32)Address, Delay));
  SyncBootScript (Script);
