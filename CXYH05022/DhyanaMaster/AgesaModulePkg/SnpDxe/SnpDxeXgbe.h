...
#define SLOT_MUX_PUT 0
#define SLOT_MUX_GET 1

#define INIT_AN_RETRY_CNT 2
#define RUNTIME_AN_RETRY_CNT 30
...
#define XGBE_AN_CL37_INT_CMPLT    BIT0//BIT(0)
#define XGBE_AN_CL37_INT_MASK    0x01
#define XGBE_SGMII_AN_LINK_STATUS  BIT4//BIT(4)
...
#define XPCS_IOREAD16(xpcs_regs, _off) \
  ...
  #define XI2C_IOWRITE(_pdata, _reg, _val)                \
        MmioWrite32 ((_val), (_pdata)->i2c_regs + _reg)
...
typedef struct _xgmac_prv_data {
  ...
  typedef struct {
	...
	UINTN comm_owned;
	//Slot switch support
	UINTN Slot_Mux_address;    ///< address of slot  Mux PCA 9545
	UINTN Slot_Bus_Seg;        ///< Slot BUS Segment. Downstream channels of PCA9545
	// SFP Support
  ...
  VOID xgbe_x_mode (ENET_DXE_PRIVATE_DATA *pdata);
