...
#include <Filecode.h>
#include "AGESA.h"
#include "FabricTopologyServicesPei.h"

#define FILECODE LIBRARY_PEIFABRICTOPOLOGYSERVICESLIB_FABRICTOPOLOGYSERVICESPEI_FILECODE

STATIC AMD_PEI_FABRIC_TOPOLOGY_SERVICES_PPI  mFabricTopologyServicesPpi = {
...
STATIC EFI_PEI_PPI_DESCRIPTOR mFabricTopologyPpiList =
{
  (EFI_PEI_PPI_DESCRIPTOR_PPI | EFI_PEI_PPI_DESCRIPTOR_TERMINATE_LIST),
  &gAmdFabricTopologyServicesPpiGuid,
  &mFabricTopologyServicesPpi
};
...
EFI_STATUS
EFIAPI
FabricTopologyServicePpiInstall (
  ...
  )
{
  ...
  Status = (**PeiServices).InstallPpi (PeiServices, &mFabricTopologyPpiList);
