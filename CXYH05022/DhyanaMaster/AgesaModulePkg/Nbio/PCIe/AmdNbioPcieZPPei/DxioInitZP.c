...
/*----------------------------------------------------------------------------------------*/
/**
 * Get PCIe Core Gen4 Preset setting 
 * @param[in]     Die       die number
 * @param[in]     Core      PCIe Core number 
 */
UINT8 
GetPcieCorePresetPcdGen4(
    UINT8 Die,
    UINT8 Core
)
{
  SOC_LOGICAL_ID            LogicalId;
  //Check if HYGON_CX or HYGON_DX for Gen4
  BaseGetLogicalIdOnExecutingCore (&LogicalId); 
  if(LogicalId.Revision & (HYGON_REV_F18_DN_Cx)){
    switch(Die){
    case 0:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen4CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen4CfgDie7Pcie1Preset);
        }
        break;
    }
  }else if(LogicalId.Revision & (HYGON_REV_F18_DN_Dx)) {
    switch(Die){
    case 0:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen4CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen4CfgDie7Pcie1Preset);
        }
        break;
     }        
  }
...
/*----------------------------------------------------------------------------------------*/
/**
 * Get PCIe Core Gen3 Preset setting 
 * @param[in]     Die       die number
 * @param[in]     Core      PCIe Core number 
 */
UINT8 
GetPcieCorePresetPcdGen3(
        UINT8 Die,
        UINT8 Core
)
{
  SOC_LOGICAL_ID            LogicalId;
  //Check if HYGON_CX or HYGON_DX for Gen3
  BaseGetLogicalIdOnExecutingCore (&LogicalId); 
  if(LogicalId.Revision & (HYGON_REV_F18_DN_Dx)){
    switch(Die){
    case 0:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdHygonDxGen3CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonDxGen3CfgDie7Pcie1Preset);
        }
        break;
    }  
    ...
    case 0:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdHygonCxGen3CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdHygonCxGen3CfgDie7Pcie1Preset);
        }
        break;
     }  
  }
  ...
  )
{
  ...
  while (PcieWrapper != NULL) {
      ...
      while (PcieEngine != NULL) {
          if((CpuGen == CPU_HYGON_CX) || (CpuGen == CPU_HYGON_DX)){ 
          ...
          //Add waiting time for all lane and decrease rate of lane_lost which only for HYGON_DX
          if(CpuGen == CPU_HYGON_DX){            
            MappingPortID = (PcieEngine->Type.Port.PortId) % 8;
            Address = (PcieWrapper->WrapId == 0) ? PCIE0_PCIE_LC_CNTL2_ADDRESS : PCIE1_PCIE_LC_CNTL2_ADDRESS;
            Address += (MappingPortID * 0x1000);
            NbioRegisterRMW (
              ...
              1 << PCIE_LC_CNTL2_LC_WAIT_FOR_OTHER_LANES_MODE_OFFSET,
              0
              );  
          }
  ...
  )
{
  ...
  while (PcieWrapper != NULL) {
    ...
    //set HYGON_CX PCIe default Tx Preset
    if(CpuGen == CPU_HYGON_CX){
      //set HYGON_CX Gen3 PCIe default Tx Preset
      if(GetPcieCorePresetPcdGen3(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        ...
        Value = 7;
        // Value = GetPcieCorePresetPcdGen3(GnbHandle->InstanceId,PcieWrapper->WrapId);
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
                          (PcieWrapper->WrapId == 0) ?  PCIE0_STRAP_DATA_ADDRESS : PCIE1_STRAP_DATA_ADDRESS,
                          &Value,
      ...
      if(GetPcieCorePresetPcdGen4(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        //set HYGON_CX Gen4 PCIe default Tx Preset    
        ...
        Value = GetPcieCorePresetPcdGen4(GnbHandle->InstanceId,PcieWrapper->WrapId);
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
                         (PcieWrapper->WrapId == 0) ?  PCIE0_STRAP_DATA_ADDRESS : PCIE1_STRAP_DATA_ADDRESS,
                          &Value,
    ...
    //set HYGON_DX PCIe default Tx Preset 
    if(CpuGen == CPU_HYGON_DX){
      //set HYGON_DX Gen3 PCIe default Tx Preset 
      if(GetPcieCorePresetPcdGen3(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        Index = DXIO_STRAP_BIF_BASEADDRSS | 0x8a;//0xfffe0090;
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
      ...
      //set HYGON_DX PCIe Gen4 default Tx Preset
      if(GetPcieCorePresetPcdGen4(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        Index = DXIO_STRAP_BIF_BASEADDRSS | 0x347;
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
  ...
  )
{
  ...
  NbioRegisterRead (GnbHandle, TYPE_SMN, CpuStepMirrorAddr, &Data32, 0);
  CpuGen    = (UINT8)((Data32 & 0xF0) >> 4);
  Stepping  = (UINT8)(Data32 & 0xF);
  Data32    = 0;
  ...
  while (PcieWrapper != NULL) {
    ...
    while (PcieEngine != NULL) {
      if (PcieLibIsEngineAllocated(PcieEngine)) {
          ...
          if((CpuGen == CPU_HYGON_CX) && (Stepping <= 1)){
              MappingPortID = (PcieEngine->Type.Port.PortId) % 8;
              ...
              if((LinkWidth==4)||(LinkWidth==2)||(LinkWidth==1)){
                  ...
                  if(TargetSupportSpeedGen3) {
                      ...
                      NbioRegisterRMW(GnbHandle, TYPE_SMN, SmnAddress, ~((UINT32)(BIT6)), (UINT32)(BIT6), 0);
                  }
              }
          }
          //WA for pcie error with EDS Pattern (x1/x2/x4) when  HYGON_DX stepping 0
          if((CpuGen == CPU_HYGON_DX) && (Stepping < 1)){
              MappingPortID = (PcieEngine->Type.Port.PortId) % 8;
              SmnAddress =  (PcieWrapper->WrapId == 0) ? PCIE0_LINK_STATUS_SMN_ADDRESS : PCIE1_LINK_STATUS_SMN_ADDRESS;
              SmnAddress += (MappingPortID<<12);
              NbioRegisterRead(GnbHandle,TYPE_SMN,SmnAddress,&LinkStatus,0);
