...
/// Writr CRC Enable
/// Use this option to enable / disable Write CRC.
typedef enum {
...
/// Writr CRC Retry
/// Use this option to enable / disable Writr CRC Retry.
typedef enum {
...
/// Valid value 3Fh-02h
#define IDSOPT_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4_MIN 0x2 ///< Min of Writr CRC Error Max Replay
#define IDSOPT_DBG_MEM_WRITE_CRC_ERROR_MAX_REPLAY_DDR4_MAX 0x3F ///< Max of Writr CRC Error Max Replay
...
///LCLK
typedef enum {
  IDSOPT_CMM_NBIO_LCLK_FREQ_AUTO = 0xF,///<Auto
  IDSOPT_CMM_NBIO_LCLK_FREQ_1000MHz = 0x10,///<1000Hz
  IDSOPT_CMM_NBIO_LCLK_FREQ_889MHz = 0x12,///<889MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_800MHz = 0x14,///<800MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_727MHz = 0x16,///<727MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_667MHz = 0x18,///<667MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_615MHz = 0x1A,///<615MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_571MHz = 0x1C,///<571MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_533MHz = 0x1E,///<533MHz
  IDSOPT_CMM_NBIO_LCLK_FREQ_500MHz = 0x20,///<500Mhz
} IDSOPT_CMN_NBIO_LCLK_FREQ;
