...
typedef struct _FIRMWARE_ENTRY_TABLEV2 {
  ...
  UINT32  Soc0BiosDirBase;      ///< Base Address for HYGON_AX BIOS directory
  UINT32  Soc1BiosDirBase;      ///< Base Address for HYGON_BX BIOS directory
  UINT32  Soc2BiosDirBase;      ///< Base Address for HYGON_CX BIOS directory
  UINT32  Soc3BiosDirBase;      ///< Base Address for HYGON_DX BIOS directory
...
#define SOC0_PSP_CHIP_ID       0xBC090000
#define SOC1_PSP_CHIP_ID       0xBC090200
#define SOC2_PSP_CHIP_ID       0xBC090201
#define SOC3_PSP_CHIP_ID       0xBC090300
typedef struct {
