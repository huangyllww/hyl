...
extern EFI_GUID gHygonProcessorTempServicesProtocolGuid;
...
typedef EFI_STATUS(EFIAPI *DXE_HYGON_PROCESSOR_TMP)(
  IN       UINT8                               Socket,
  IN       UINT8                               Die,
...
typedef struct _HYGON_PROCESSOR_TEMPERATURE_PROTOCOL {
  UINTN                              Revision;                 ///< Protocol Revision
  DXE_HYGON_PROCESSOR_TMP            GetProcessorTMP;
} HYGON_PROCESSOR_TEMPERATURE_PROTOCOL;
