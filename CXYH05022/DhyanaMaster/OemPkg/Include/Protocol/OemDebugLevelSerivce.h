...
#ifndef __OEM_DEBUG_LEVEL_SERVICE_PROTOCOL_H__
#define __OEM_DEBUG_LEVEL_SERVICE_PROTOCOL_H__

#include "Uefi/UefiBaseType.h"
#include "OemDebugAlways_DebugLevel.h"
/// AMI Debug Print Error Level Service Protocol GUID definition
#define OEM_DEBUG_LEVEL_SERVICE_PROTOCOL_GUID \
    { 0x1103ce13, 0x8f69, 0x4cf2, { 0x8d, 0x41, 0xb8, 0x9, 0x28, 0x6c, 0xe5, 0x14 } }

typedef struct _OEM_DEBUG_LEVEL_SERVICE_PROTOCOL OEM_DEBUG_LEVEL_SERVICE_PROTOCOL;


#define DXE_DEBUG_LEVEL_SIGNATURE   SIGNATURE_32 ('D', 'X', 'L', 'B')
...
typedef struct
{
  /* data */
  UINT64               Signature;
  OEM_DEBUG_LEVEL_SERVICE_PROTOCOL  DxeDedebugLevelProtocol;
  OEM_DEBUG_LEVEL_DATABASE *DxePhaseDebugLevelDataBase;
}OEM_DEBUG_LEVEL_OBJECT;


#define DXE_DEBUG_LEVEL_FROM_PROTOCOL_THIS(a) \
  CR (a, OEM_DEBUG_LEVEL_OBJECT, DxeDedebugLevelProtocol, DXE_DEBUG_LEVEL_SIGNATURE)
