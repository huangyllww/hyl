#ifndef __OEM_DMI_INFO_H__
#define __OEM_DMI_INFO_H__
...
EFI_STATUS OemIpmiSetUUIDInfo(EFI_GUID *uuid);
EFI_STATUS NetLibGetSystemGuid(EFI_GUID *SystemGuid);

//
//OEM IPMI Command
//
//#define EFI_SM_OEM_GROUP    0x2E
#define  NETFN_OEM          0x3A  //OEM
  #define  SET_CPU_INFO       0x01
  #define  GET_CPU_INFO       0x02
  #define  SET_DIMM_INFO      0x03  
  #define  GET_DIMM_INFO      0x04
  #define  SET_MEM_ECC_THRESHOLD          0x05
  #define  GET_MEM_ECC_THRESHOLD          0x06
  #define  SET_MEM_ECC_INFO   0x07
  #define  GET_MEM_ECC_INFO   0x08
  #define  SET_PCIE_CARD_INFO       0x09
  #define  GET_PCIE_CARD_INFO       0x0A
  #define  SET_DISK_INFO      0x0B
  #define  GET_DISK_INFO      0x0C
  #define  SET_FAN_DUTYCYCLE_INFO   0x0D    
  #define  GET_FAN_DUTYCYCLE_INFO     0x0E
  #define  SET_SYS_UUID     0x30 /*LZQ052[m] 0x20*/
