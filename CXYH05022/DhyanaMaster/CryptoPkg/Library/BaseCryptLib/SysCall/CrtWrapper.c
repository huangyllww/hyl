...
//AptioV server override start - Controlling build of wrapper methods based on SDL token
#include <Token.h>

#if defined DISABLE_STDLIB_WRAPPER_METHODS && DISABLE_STDLIB_WRAPPER_METHODS==0
int errno = 0;
#endif
//AptioV server override end - Controlling build of wrapper methods based on SDL token
...
//AptioV server override start - Commented build of CryptoPkg related methods as openssl already defines them.
//Commented as Openssl library provides these methods. Users not using openssl can uncomment these lines to prevent build error.

//
//  -- Dummy OpenSSL Support Routines --
//
/*
//AptioV - porting , Remove it after adding b_print.c for BIOS remote module
