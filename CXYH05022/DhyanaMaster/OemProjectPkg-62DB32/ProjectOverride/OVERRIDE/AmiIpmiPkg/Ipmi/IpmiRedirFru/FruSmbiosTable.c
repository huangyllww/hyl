...
//<hety-20220921 Support sync BIOS vendor by fru ->
    ...
    //dengyh-20220430-update smbios type 3 height with fru +
    UINT8                           height = 0; 
...
//<hety-20220921 Support sync BIOS vendor by fru ->
    ...
    Type3Structure->NumberofPowerCords = 0x00;
    ...
    if((StrCmp(ProductName,L"X7340H0")==0) || (StrCmp(L"R6240H0",ProductName)==0))
    {
       height = 2;
    }else if(StrCmp(L"R6140H0",ProductName)==0){
        height = 1;
    }else if(StrCmp(L"R6440H0",ProductName)==0){
        height = 4;
    }
    CopyMem (&(Type3Structure->Height), &height, sizeof(UINT8));
