...
#endif
#include "Library/HiiLib.h"//dengyh-20220409-add create chinese and english database
...
// AMI Test KEK (TBD)
    ...
    EFI_SIGNATURE_DATA *SigData;
    INTN err;
    EFI_STRING tempstr = NULL;//dengyh-20220409-add create chinese and english database
    EFI_STRING messagestr = NULL;//dengyh-20220409-add create chinese and english database
    Index = 0;
...
#if !defined( TSE_FOR_APTIO_4_50)
        //dengyh-20220409-add create chinese and english database+
        switch(bKey[Index]) 
        {
            case Custom:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_CUSTOM_KEY), "en-US");
                break;
            case Vendor:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_DEFAULT_KEY), "en-US");
                break;
            case Mixed: messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_MIXED_KEY), "en-US");
                break;
            case AmiTest:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_AMI_TEST_KEY), "en-US");
                break;
            case Absent:
            default:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_ABSENT_KEY), "en-US");
                break;
        }
...
//        TRACE((TRACE_ALWAYS,"StrTitle '%S'\n", StrTitle));
        ...
        tempstr = HiiGetString(gHiiHandle, SecureVariableStringRef[Index], "en-US");
        Swprintf_s(StrTitle, sizeof(StrTitle), tempstr, Size, SigCount, messagestr);
        HiiSetString(gHiiHandle, SecureVariableStringTitle[Index], StrTitle, "en-US");
        
        switch(bKey[Index]) 
        {
            case Custom:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_CUSTOM_KEY), "zh-chs");
                break;
            case Vendor:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_DEFAULT_KEY), "zh-chs");
                break;
            case Mixed: messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_MIXED_KEY), "zh-chs");
                break;
            case AmiTest:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_AMI_TEST_KEY), "zh-chs");
                break;
            case Absent:
            default:messagestr = HiiGetString(gHiiHandle,STRING_TOKEN(STR_ABSENT_KEY), "zh-chs");
                break;
        }
        tempstr = HiiGetString(gHiiHandle, SecureVariableStringRef[Index], "zh-chs");
        Swprintf_s(StrTitle, sizeof(StrTitle), tempstr, Size, SigCount, messagestr);
        HiiSetString(gHiiHandle, SecureVariableStringTitle[Index], StrTitle, "zh-chs");
        //dengyh-20220409-add create chinese and english database-
#endif
        Index++;
    }
