...
//<dengyh 20220216 sata phy setting +>
#define J43_SATA_PHY_SETTING\
      PHY_PARAMS_START\
...
#define J135_SATA_PHY_SETTING\
      PHY_PARAMS_START\
      PHY_PARAM (GEN3_txX_eq_main, 0x14),\
  ...
  //
    ...
    0xFF,*/
          //CPU0          
              ...
              //Mizl-20220317- SGMTB#0143543-CPLDResetBMC+>
              GPIO_DEF_V2(0, 0,42  , GPIO_FUNCTION_1, GPIO_OUTPUT_LOW         , GPIO_PD_EN        ),  // DISABLE BMC AUTO RST
              //Mizl-20220317- SGMTB#0143543-CPLDResetBMC->
        ...
        {   // DXIO_PORT_DESCRIPTOR
          ...
          { // S0D0P0 Type A (PCIe) - x8 Lane8~15
                ...
                DXIO_PORT_DATA_INITIALIZER_PCIE (
                  ...
                  6,                                    // Requested Function
                  DxioHotplugDisabled,                  // Hotplug
                  DxioGen3,                             // Max Link Speed //SGMTB#148911:LSI 9560 Report AER Error,Downgrade to Gen3
                  DxioGen3,                             // Max Link Capability //SGMTB#148911:LSI 9560 Report AER Error,Downgrade to Gen3
                  DxioAspmDisabled,                     // ASPM
                  DxioAspmDisabled,                     // ASPM L1.1 disabled
                  DxioAspmDisabled,                     // ASPM L1.2 disabled
                  DxioClkPmSupportDisabled              // Clock PM
          ...
          { // S0D1P1 Type A (PCIe) - x8 PCIe
                ...
                DXIO_PORT_DATA_INITIALIZER_PCIE (
                  ...
                  1,                                    // Requested Device
                  3,                                    // Requested Function
                  DxioHotplugEnhanced,                  // Hotplug //SGEZT#29572:Enable OCP Hotplug In Default
                  DxioGenMaxSupported,                  // Max Link Speed
                  DxioGenMaxSupported,                  // Max Link Capability
                  DxioAspmDisabled,                           // ASPM
                  DxioAspmDisabled,                     // ASPM L1.1 disabled
...
//SGEZT#25974-Improve-Code-For-Preset +>
//Define NULL EQ Table For DXE Phase HP Logic
