  ...
  )
{
    ...
    //
#if (SPD_I2C_MUX_ADDRESS == 0xE0)
    if (SpdData->SocketId == 0) {
      if ((SpdData->MemChannelId >= 0) && (SpdData->MemChannelId < 4)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x01, 0x01);
      }
      if ((SpdData->MemChannelId >= 4) && (SpdData->MemChannelId < 8)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x02, 0x02);
      }
    }
    
   if (SpdData->SocketId == 1) {
      if ((SpdData->MemChannelId >= 0) && (SpdData->MemChannelId < 4)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x04, 0x04);
      }
      if ((SpdData->MemChannelId >= 4) && (SpdData->MemChannelId < 8)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x08, 0x08);
      }
  }
#elif (SPD_I2C_MUX_ADDRESS == 0x94)
    if (SpdData->SocketId == 0) {
      if ((SpdData->MemChannelId >= 0) && (SpdData->MemChannelId < 4)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x03, 0x80);
      }
      if ((SpdData->MemChannelId >= 4) && (SpdData->MemChannelId < 8)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x03, 0x40);
      }
    }
    
   if (SpdData->SocketId == 1) {
      if ((SpdData->MemChannelId >= 0) && (SpdData->MemChannelId < 4)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x03, 0x20);
      }
      if ((SpdData->MemChannelId >= 4) && (SpdData->MemChannelId < 8)) {
        SmbusI2CMuxSelection (PeiServices, SPD_I2C_MUX_ADDRESS, 0x03, 0x10);
      }
    }   
#endif
