...
#include <IndustryStandard/PciCodeId.h> //xuyj1-20210729-Filter NVMe Disk From PCIeList+>
UINT8                             FabricId = 0;
...
ROOTB_DATA PciRootPortTable[MAX_DEV_COUNT] = {
  ...
  //RbType   //RbSeg   //RbBus   //RbDev   //RbFunc  //Socket  //Die   //Data3
  //PCH
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page+>
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x03}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x04}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x05}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x06}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x07}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x08}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x09}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x0A}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x0C}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0x0D}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x00,     0xFF}, //(S0D0P0,typeA)
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page->
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update->
  {0x00,     0x00,     0xFF,     0x01,     0x02,     0xFF,     0x00,     0xFF},
  ...
  {0x00,     0x00,     0xFF,     0x01,     0x06,     0xFF,     0x00,     0xFF},
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x02,     0x01,     0xFF,     0x00,     0xFF}, //(DownStream Port,typeA)
  /*{0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x0B}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x0C}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x0D}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x0E}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x0F}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x10}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x11}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x12}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x13}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x14}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x15}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x16}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x17}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0x18}, //(DownStream Port,typeA)
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update->
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x00,     0xFF},
  {0x00,     0x00,     0xFF,     0x02,     0x01,     0xFF,     0x00,     0xFF},*/
  ...
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page+>
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x03}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x04}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x05}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x06}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x07}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x08}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x09}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x0a}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x0b}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x0c}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0x0d}, //(DownStream Port,typeB)*/
  {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x02,     0xFF}, //(S0D2G2,typeB)
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page->
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update->
  {0x00,     0x00,     0xFF,     0x03,     0x02,     0xFF,     0x02,     0xFF},
  ...
  {0x00,     0x00,     0xFF,     0x03,     0x06,     0xFF,     0x02,     0xFF},
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x04,     0x01,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  /*{0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x0b}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x0c}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x0d}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x0e}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x0f}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x10}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x11}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x12}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x13}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x14}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x15}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x16}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x17}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x02,     0x18}, //(DownStream Port,typeB)
  ...
  {0x00,     0x00,     0xFF,     0x03,     0x06,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x04,     0x07,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x03,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x03,     0xFF},
  ...
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page+>
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x03}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x04}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x05}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x06}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x07}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x08}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x09}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x0a}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x0b}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x0c}, //(DownStream Port,typeA)
  // {0x00,     0x00,     0xFF,     0x01,     0x01,     0xFF,     0x05,     0x0d}, //(DownStream Port,typeA)
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page->
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update->
  ...
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x02,     0x01,     0xFF,     0x05,     0xFF}, //(DownStream Port,typeA)
  /*{0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0xFF}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x08}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x09}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0a}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0b}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0c}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0d}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0e}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x0f}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x10}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x11}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x12}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x13}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x14}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x15}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x16}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x17}, //(DownStream Port,typeA)
  {0x00,     0x00,     0xFF,     0x01,     0x07,     0xFF,     0x05,     0x18}, //(DownStream Port,typeA)
  ...
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page+>
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x03}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x04}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x05}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x06}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x07}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x08}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x09}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x0a}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x0b}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x0c}, //(DownStream Port,typeB)
  // {0x00,     0x00,     0xFF,     0x03,     0x01,     0xFF,     0x06,     0x0d}, //(DownStream Port,typeB)
  //Mizl-20200403-Device Display Abnormal Under Pci Devices List Page->
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update->*/
  ...
  //Mizl-20200601-Device Display Abnormal Under Pci Devices List Page Becauseof the PCIe Topy's Update+>
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0xFF}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x04,     0x01,     0xFF,     0x06,     0xFF}, //(DownStream Port,typeB)
  /*{0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x05}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x06}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x07}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x08}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x09}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0a}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0b}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0c}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0d}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0e}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x0f}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x10}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x11}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x12}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x13}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x14}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x15}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x16}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x17}, //(DownStream Port,typeB)
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x06,     0x18}, //(DownStream Port,typeB)
  ...
  {0x00,     0x00,     0xFF,     0x04,     0x07,     0xFF,     0x07,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x07,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x07,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x07,     0xFF},
  {0x00,     0x00,     0xFF,     0x03,     0x07,     0xFF,     0x07,     0xFF},
    ...
    )
{
  ...
  for(i=0;i<sizeof(gPciSlotMapTable) / sizeof(PCI_SLOT_MAP);PCISlotEntry++,i++){
    ...
    switch (CpuPkg){
        ...
        case PKG_SL1R2:
            pRb->Socket = pRb->DieNum/2;
            break;
        default:
            break;
    }
    pRb->Data3 = 0xFF;
    pRb->RbBus = GetCPURbBusNumAndFabricId(pRb->Socket,pRb->DieNum,&FabricId);
...
EFI_STATUS DynamicGenerationRbtable(VOID *Dev)
{
  ...
  while(Prt->ParentBrg != NULL && Prt->Type!=tPciRootBrg) {
      if(Prt->Type==tPciDevice) {
         ...
         if(Status == EFI_SUCCESS) {
             DEBUG((EFI_D_INFO,"AddDevInfoInRbtable\n"));
  ...
  DEBUG((EFI_D_INFO,"DynamicGenerationRbtablecount= %d\n", count));
  return Status;
}
...
/*EFI_STATUS DynamicGenerationRbtable(VOID *Dev)
{
    ...
    if ( NULL == Dev ) {
       ...
       while(PreDev->ParentBrg != NULL && PreDev->Type!=tPciRootBrg) {
           if(PreDev->Type==tPciDevice) {
                   Status = IsNotCPUInternalDevices(PreDev);
                   if(Status == EFI_SUCCESS) {
                       Status = AddDevInfoInRbtable(PreDev);
                   }
                      }
                   PreDev=PreDev->ParentBrg;
                  }
                  return Status;                
}*/
EFI_STATUS GetDevRootPortIndexAndDevEnLib(ROOTB_DATA *Rb,UINTN *RPIndex,UINT8 *DevEn)
...
EFI_STATUS GetDeviceRootPortData2(VOID *Dev,ROOTB_DATA *Rb,UINTN *DevIndex,UINT8 *DevEn)
{
  ...
  Status = GetDeviceRootBrgEX(Dev,&Prt);
  if(EFI_ERROR(Status)) {
...
//<Yinnn-20180830-Fix up pcie switch device list.+>
EFI_STATUS GetDeviceRootBrgEX(VOID *Dev,VOID **rBrg)
{
  PCI_DEV_INFO          *Prt,*PreDev;
  PCI_DEV_INFO          *Prt_tem;
  ...
  if (count <3){    
    *rBrg = Prt;
    DEBUG((EFI_D_INFO,"rBrg->Type= %d\n", Prt->Type));
  }
  else {
    *rBrg = Prt_tem;
    DEBUG((EFI_D_INFO,"rBrg->Type= %d\n", Prt_tem->Type));
    DEBUG((EFI_D_INFO,"switch is B%02x|D%02x|F%02x\n", Prt_tem->Address.Addr.Bus, Prt_tem->Address.Addr.Device, Prt_tem->Address.Addr.Function));      
  }
  DEBUG((EFI_D_INFO,"RootPort is B%02x|D%02x|F%02x\n", Prt->Address.Addr.Bus, Prt->Address.Addr.Device, Prt->Address.Addr.Function));
...
EFI_STATUS GetDeviceRootBrg(VOID *Dev,VOID **rBrg)
{
  ...
  *rBrg = Prt;
  ...
  DEBUG((EFI_D_INFO,"RootPort is DieNum:%02x, DevNum:%02x, FuncNum:%02x\n", DieNum, Prt->Address.Addr.Device, Prt->Address.Addr.Function));
...
EFI_STATUS GetDeviceRootPortData(VOID *Dev,ROOTB_DATA *Rb,UINTN *DevIndex)
{
  ...
  pRb->Socket = pRb->DieNum/4; 
  pRb->Data3  = 0xFF;
  DEBUG((EFI_D_INFO,"GetDeviceRootPortData"));
  DEBUG((EFI_D_INFO,"RootPort is DevNum:%02x, FuncNum:%02x\n",Prt->Address.Addr.Device, Prt->Address.Addr.Function));
...
//xuyj1-20210729-Filter NVMe Disk From PCIeList+>
/**
    Got the device based on the Class,Sub-Class and interface.

    @param  Options       boot device
**/
/*BOOLEAN NVMeFilterFromPCIeDeviceList(
    IN PCI_DEV_INFO  *Device
)
{

    if((Device->Class.BaseClassCode == 0x01)
        &&(Device->Class.SubClassCode == 0x08)
        &&(Device->Class.ProgInterface == 0x02))
    {
                return TRUE;
        }
    ...
    )
{
  ...
  /*//xuyj1-20210729-Filter NVMe Disk From PCIeList+>
  if(NVMeFilterFromPCIeDeviceList((PCI_DEV_INFO*)Dev))
      return EFI_UNSUPPORTED;
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]PciDevListData->PciDevCount =%d DevIdx =%x\n\n",__FUNCTION__,__LINE__,PciDevListData->PciDevCount,DevIdx));
  //xuyj1-20210729-Filter NVMe Disk From PCIeList->*/
  for(i=0;i<PciDevListData->PciDevCount;i++){
    Devitem = PciDevListData->PciDevIdxData[i];
    if(Devitem->PciDevIdx == DevIdx){
        DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]Devitem->PortCount =%d Dev =%x\n\n",__FUNCTION__,__LINE__,Devitem->PortCount,Dev));
...
)
{
    ...
    for(Index=0;Index<PciDevListData->PciDevCount;Index++){
     ...
     DEBUG((EFI_D_INFO, " ***Pcie GetDeviceRootBrgEX***\n"));
      //Prt = (PCI_DEV_INFO *)dev;
      //PreDev = Prt->ParentBrg;
      //Prt_tem = PreDev;
     ...
     // while(PreDev->ParentBrg != NULL && PreDev->Type!=tPciRootBrg) {
      ...
      //else {        
        //DEBUG((-1,"rBrg->Type= %d\n", Prt_tem->Type));
        //DEBUG((-1,"switch is B%02x|D%02x|F%02x\n", Prt_tem->Address.Addr.Bus, Prt_tem->Address.Addr.Device, Prt_tem->Address.Addr.Function));      
      //}
      
      //DEBUG((-1,"RootPort is B%02x|D%02x|F%02x\n", Prt->Address.Addr.Bus, Prt->Address.Addr.Device, Prt->Address.Addr.Function));
    if (Devitem == NULL)
        return  EFI_INVALID_PARAMETER;
    ...
    DEBUG((EFI_D_INFO,"RootPort is DevNum:%02x, FuncNum:%02x\n", RbPtr->Address.Addr.Device, RbPtr->Address.Addr.Function));
    DEBUG((EFI_D_INFO, " ***Pcie Rb  Bus/Dev/Fun is 0x%02x 0x%02x 0x%02x ***\n",RbPtr->Address.Addr.Bus,RbPtr->Address.Addr.Device,RbPtr->Address.Addr.Function));
...
//Get PCIE device infomation
   ...
   //<Nieht-20181119- Additional port's BrandName is obtained form port 0 for X710->
   AsciiStrCpy(PcieDevInfo->PcieLocation,IdxDev->PcieLocation);
   ...
   DEBUG((EFI_D_INFO, " *** Num %2d PcieDevInfo->PcieLocation is  %s                ***\n", DevIndex, PcieDevInfo->PcieLocation));
...
//<huangjin001 20191206 Add lan Mac address in SETUP PCIE device list help message ->
/*
 * Print All Root Port Table List
 */
VOID PrintRbTable(){
    ROOTB_DATA *Prb;
    PCIeListLinkNode *PHead = NULL;
    PHead=&gPCIeLinkListEntry;
    DEBUG((EFI_D_INFO,"RbSeg RbBus RbDev RbFunc Sockt RbNum Data3 Index Deven\n"));
    do{
        Prb=&PHead->PciPortInfo;
        DEBUG((EFI_D_INFO,"%02x    %02x    %02x    %02x    %02x    %02x    %02x    %02x    %02x\n",Prb->RbType,
                Prb->RbSeg,Prb->RbBus,Prb->RbDev,Prb->RbFunc,Prb->Data1,Prb->Data2,Prb->Data3,
                PHead->Index,PHead->DevEn));
        PHead=PHead->Next;
    }while(PHead->Next!=NULL);
