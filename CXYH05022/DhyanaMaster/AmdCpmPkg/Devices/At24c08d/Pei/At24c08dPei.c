...
#include <At24c08dPei.h>

STATIC EFI_PEI_At24c08d_PPI mAt24c08dPpi = {
  At24c08d_PPI_REVISION,
  At24c08dSet,
  At24c08dGet
};

STATIC EFI_PEI_PPI_DESCRIPTOR mAt24c08dPpiList = {
...
/*----------------------------------------------------------------------------------------*/
/**
 * Entry point of the AMD CPM At24c08d PEI driver
 *
 * This function registers the function to publish At24c08d EEPROM access ppi.
 *
