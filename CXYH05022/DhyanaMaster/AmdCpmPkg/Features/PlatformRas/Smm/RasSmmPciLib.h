...
#ifndef _RASSMMPCILIB_H_
#define _RASSMMPCILIB_H_
#include  <AMD.h>
...
#define PCIE_PCIE_HDR_LOG0_PTR      (0x1C)
#define PCIE_PCIE_HDR_LOG1_PTR      (0x20)
#define PCIE_PCIE_HDR_LOG2_PTR      (0x24)
#define PCIE_PCIE_HDR_LOG3_PTR      (0x28)
