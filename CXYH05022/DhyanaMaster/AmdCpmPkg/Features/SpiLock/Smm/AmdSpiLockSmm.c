...
#include <Protocol/SpiLockSmmProtocol.h>
...
SmmSpilock(VOID)
{
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + LPC_REG50, ~(UINT32) BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + LPC_REG54, ~(UINT32) BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + LPC_REG58, ~(UINT32) BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + LPC_REG5C, ~(UINT32) BIT10, 1 << 10);
