...
// GPIO Init Table
//
AMD_CPM_GPIO_INIT_TABLE             gCpmGpioInitTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
...
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_INIT, sizeof (gCpmGpioInitTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {  
   // (socket, die, gpio, function, output, pullup)
    GPIO_DEF_V2 (0, 0, 10,    GPIO_FUNCTION_3,  GPIO_NA,          GPIO_PD_EN    ),   // CPLD
    GPIO_DEF_V2 (0, 0, 40,    GPIO_FUNCTION_2,  GPIO_NA,          GPIO_PD_EN    ),   // CPLD
    GPIO_DEF_V2 (0, 0, 147,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //for xgbe SPF_SCL
    GPIO_DEF_V2 (1, 0, 147,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //for xgbe SPF_SCL
    GPIO_DEF_V2 (0, 0, 148,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //for xgbe SPF_SDA
    GPIO_DEF_V2 (1, 0, 148,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //for xgbe SPF_SDA
    GPIO_DEF_V2 (1, 0, 92,    GPIO_FUNCTION_3,  GPIO_INPUT,       GPIO_PU_EN    ),   // HY_CARD_DETECT_N
    GPIO_DEF_V2 (1, 0, 115,   GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PD_EN    ),   // HY_CARD_ID1
    GPIO_DEF_V2 (1, 0, 116,   GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PD_EN    ),   // HY_CARD_ID0
    0xFF,
  }
};
...
// GEVENT Init Table
//
AMD_CPM_GEVENT_INIT_TABLE           gCpmGeventInitTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GEVENT_INIT, sizeof (gCpmGeventInitTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x00000001},
...
AMD_CPM_GPIO_DEVICE_CONFIG_TABLE    gCpmGpioDeviceConfigTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_CONFIG, sizeof (gCpmGpioDeviceConfigTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
...
//
AMD_CPM_GPIO_DEVICE_DETECTION_TABLE gCpmGpioDeviceDetectionTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_DETECTION, sizeof (gCpmGpioDeviceDetectionTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
...
//
AMD_CPM_GPIO_DEVICE_RESET_TABLE gCpmGpioDeviceResetTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_RESET, sizeof (gCpmGpioDeviceResetTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
//
AMD_CPM_GPIO_DEVICE_POWER_TABLE gCpmGpioDevicePowerTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_GPIO_DEVICE_POWER, sizeof (gCpmGpioDevicePowerTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
//  {UINT8  DeviceId;       // Device Id
...
// PCIE Clock Table
//
AMD_CPM_PCIE_CLOCK_TABLE    gCpmPcieClockTableHONGHAIA2d = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table content
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_PCIE_CLOCK, sizeof (gCpmPcieClockTableHONGHAIA2d) / sizeof (UINT8), 0, 0, 0, 0x0F},
  {
...
//
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA2dS0 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA2dS0) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  0,  // SocketId
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
  ...
  { // P0 - EtherNet Port 0
       ...
       8, /// mPlatConf   8
        ...
        0, ///InfoRomLocation,0=on board,1=field card
...
//
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA2dS1 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY_S1, sizeof (gCpmDxioTopologyTableHONGHAIA2dS1) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  1,  // SocketId
  {   // DXIO_PORT_DESCRIPTOR
//  { UINT32  Flags;                    /**< Descriptor flags
//    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
