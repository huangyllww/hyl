...
extern  AMD_CPM_GPIO_INIT_TABLE                   gCpmGpioInitTableHONGHAIA2d;
extern  AMD_CPM_GEVENT_INIT_TABLE                 gCpmGeventInitTableHONGHAIA2d;
extern  AMD_CPM_GPIO_DEVICE_CONFIG_TABLE          gCpmGpioDeviceConfigTableHONGHAIA2d;
extern  AMD_CPM_GPIO_DEVICE_DETECTION_TABLE       gCpmGpioDeviceDetectionTableHONGHAIA2d;
extern  AMD_CPM_GPIO_DEVICE_RESET_TABLE           gCpmGpioDeviceResetTableHONGHAIA2d;
extern  AMD_CPM_GPIO_DEVICE_POWER_TABLE           gCpmGpioDevicePowerTableHONGHAIA2d;
extern  AMD_CPM_PCIE_CLOCK_TABLE                  gCpmPcieClockTableHONGHAIA2d;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHONGHAIA2dS0; 
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHONGHAIA2dS1;
...
VOID *gCpmTableList[] = {
  ...
  &gCpmPreInitTable,
  &gCpmGpioInitTableHONGHAIA2d,
  &gCpmGeventInitTableHONGHAIA2d,
  &gCpmGpioDeviceConfigTableHONGHAIA2d,
  &gCpmGpioDevicePowerTableHONGHAIA2d,
  &gCpmGpioDeviceDetectionTableHONGHAIA2d,
  &gCpmGpioDeviceResetTableHONGHAIA2d,
  &gCpmPcieClockTableHONGHAIA2d,
  &gCpmDxioTopologyTableHONGHAIA2dS0,
  &gCpmDxioTopologyTableHONGHAIA2dS1,
