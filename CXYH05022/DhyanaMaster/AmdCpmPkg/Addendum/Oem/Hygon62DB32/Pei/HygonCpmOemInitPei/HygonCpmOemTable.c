...
//   UINT32 Attribute;        // Table attribute},
  ...
  //
    ...
    GPIO_DEF_V2 (0, 2, 10,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_PD_DIS),   //  BOARD_ID0
    GPIO_DEF_V2 (0, 3, 10,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_PD_DIS),   //  RISERA_TYPE0_N
    ...
    // GPIO_DEF_V2 (0, 0, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -FW config pcie_rst as low
    // GPIO_DEF_V2 (0, 1, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -bios release it before pcie training
    // GPIO_DEF_V2 (0, 2, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -we don't touch it here
    // GPIO_DEF_V2 (0, 3, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // 
    ...
    GPIO_DEF_V2 (0, 2, 40,  GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN),   // BRD_ID1
    GPIO_DEF_V2 (0, 3, 40,  GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN),   // RISERA_TYPE1_N
  ...
  //
    ...
    GPIO_DEF_V2 (1, 2, 9,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   //  Not used
    ...
    GPIO_DEF_V2 (1, 2, 10,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_PD_DIS),   //  Not used
    GPIO_DEF_V2 (1, 3, 10,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_PD_DIS),   //  RISERB_TYPE0_N
    ...
    GPIO_DEF_V2 (1, 2, 23,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_EN),   // Not used
    GPIO_DEF_V2 (1, 3, 23,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_EN),   // RISERB_NVME1_DETECT_N
    // GPIO_DEF_V2 (1, 0, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -FW config pcie_rst as low
    // GPIO_DEF_V2 (1, 1, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -bios release it before pcie training
    // GPIO_DEF_V2 (1, 2, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // -we don't touch it here
    // GPIO_DEF_V2 (1, 3, 26,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // 
    ...
    GPIO_DEF_V2 (1, 2, 40,  GPIO_FUNCTION_0,  GPIO_NA,       GPIO_PU_PD_DIS),   // Not used
...
//   UINT32 Attribute;        // Table attribute},
  ...
  {   // DXIO_PORT_DESCRIPTOR
       ...
       { //S0D0P0 Lane 8~15 PCIE X8 RAID_SLOT_NVME_DET_N=1
          ...
          PHY_PARAMS_START
            PHY_PARAM (txX_term_cntl, 0x7),
          PHY_PARAMS_END
       },

       { //S0D1P0 Lane 0~15 SATA X8 + PCIE X8 SATA_CPU0_DETECT1_N=0
          0,
       ...
       { //S0D1P0 Lane 0~15 SATA X8 + PCIE X8 SATA_CPU0_DETECT1_N=0
         //S0D1P0 Lane 0~15 2 * PCIE X4 + PCIE X8 SATA_CPU0_DETECT1_N=1, OCP_PCIEX16_DET_N=1
          0,
       ...
       { //S0D2P0 Lane 0~15  PCIEX16 RISERA_TYPE0_N=1, RISERA_TYPE1_N=0
          0,
       ...
       { //S0D3P0 Lane 0~3  PCIE x4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 112, 115, DxioHotplugDisabled, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
       ...
       { //S0D3P0 Lane 4~7  PCIE x4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 116, 119, DxioHotplugDisabled, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
       ...
       { //S0D3P0 Lane 8~15   PCIEX8  RISERA_TYPE1_N=0
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
      ...
      { // P1     Lane0-15     PCIE X16             RISERB_TYPE0_N=1, RISERB_TYPE1_N=0
        0,
      ...
      { // P2     Lane0-15     PCIE X16             RISERB_TYPE1_N=0
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 80, 95, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
      ...
      { // P3     Lane0-15     PCIEX16              RISERC_TYPE0_N=1, RISERC_NVME_DETECT_N=1
        DESCRIPTOR_TERMINATE_LIST,
  ...
  {CPM_SIGNATURE_EQ_CONFIG, sizeof ( gCpmEqConfigurationTableHygon62DB32) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    ...
    PCIE_EQ(
      ...
      PCIE_PHY_PARA_OVERRIDE(
        ...
        8,
        15,
        0xac, 0x18, 0xb6, 0x7d, 0x07, 0x48, 0x11, 0x01, 0x01        
        ),
		
	  //Set P4500/P4600 Cx Gen3 preset as 4
    PCIE_EQ( 
	      FLAG_SPECIFIED, 
