...
HYGON_CPM_EQ_CONFIG_TABLE  gCpmEqConfigurationTableHygon35N16 = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof (gCpmEqConfigurationTableHygon35N16) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    //PCIE
