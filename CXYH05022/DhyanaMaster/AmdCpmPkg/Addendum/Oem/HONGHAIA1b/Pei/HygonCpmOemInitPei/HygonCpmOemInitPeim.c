...
extern  AMD_CPM_GPIO_INIT_TABLE                   gCpmGpioInitTableHONGHAIA1b;
extern  AMD_CPM_GEVENT_INIT_TABLE                 gCpmGeventInitTableHONGHAIA1b;
extern  AMD_CPM_GPIO_DEVICE_CONFIG_TABLE          gCpmGpioDeviceConfigTableHONGHAIA1b;
extern  AMD_CPM_GPIO_DEVICE_DETECTION_TABLE       gCpmGpioDeviceDetectionTableHONGHAIA1b;
extern  AMD_CPM_GPIO_DEVICE_RESET_TABLE           gCpmGpioDeviceResetTableHONGHAIA1b;
extern  AMD_CPM_GPIO_DEVICE_POWER_TABLE           gCpmGpioDevicePowerTableHONGHAIA1b;
extern  AMD_CPM_PCIE_CLOCK_TABLE                  gCpmPcieClockTableHONGHAIA1b;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHONGHAIA1bS0;
extern  HYGON_CPM_EQ_CONFIG_TABLE                 gCpmEqConfigurationTableHonghaiA1b;
...
VOID *gCpmTableList[] = {
  ...
  &gCpmPreInitTable,
  &gCpmGpioInitTableHONGHAIA1b,
  &gCpmGeventInitTableHONGHAIA1b,
  &gCpmGpioDeviceConfigTableHONGHAIA1b,
  &gCpmGpioDevicePowerTableHONGHAIA1b,
  &gCpmGpioDeviceDetectionTableHONGHAIA1b,
  &gCpmGpioDeviceResetTableHONGHAIA1b,
  &gCpmPcieClockTableHONGHAIA1b,
  &gCpmDxioTopologyTableHONGHAIA1bS0,
  &gCpmEqConfigurationTableHonghaiA1b,
  NULL
};
