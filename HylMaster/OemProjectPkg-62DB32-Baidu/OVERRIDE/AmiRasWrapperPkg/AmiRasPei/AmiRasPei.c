  ...
  )
{
	...
	//<Chendl001-20180626 Memory Leaky Bucket Design +>
    if((CbsConfig.McaMemErrThreshCount == 0) && (CbsConfig.McaProErrThreshCount == 0)){    
      
        PcdSetBool(PcdMcaErrThreshEn, FALSE);
    }

    //<Wangyia001-20181017  Modify as Baidu BIOS spec v1.1 +>
    switch (CbsConfig.McaMemErrThreshCount)
    {
      case 0 :
        PcdSet16(PcdMcaMemErrThresh, 0);
        break;
	  case 1 :
        PcdSet16(PcdMcaMemErrThresh, 1200);
        break;
      case 2 :
        PcdSet16(PcdMcaMemErrThresh, 1);
        break;
      case 3 :
        PcdSet16(PcdMcaMemErrThresh, 1500);
        break;
      case 4 :
        PcdSet16(PcdMcaMemErrThresh, 1000);
        break;
      case 5 :
        PcdSet16(PcdMcaMemErrThresh, 2000);
        break;
      case 6 :
        PcdSet16(PcdMcaMemErrThresh, 5000);
        break;
      case 7 :
        PcdSet16(PcdMcaMemErrThresh, 10000);
        break;
    }
    switch (CbsConfig.McaMemCeStormThreshCount)
    {
      case 0 :
        PcdSet16(PcdMcaMemCeStormThreshCount, 0);
        break;
	  case 1 :
        PcdSet16(PcdMcaMemCeStormThreshCount, 120);
        break;
      case 2 :
        PcdSet16(PcdMcaMemCeStormThreshCount, 60);
        break;
      case 3 :
        PcdSet16(PcdMcaMemCeStormThreshCount, 240);
        break;
      case 4 :
        PcdSet16(PcdMcaMemCeStormThreshCount, 1200);
        break;
    }
    if ((0 == CbsConfig.McaMemErrThreshCount) && (0 == CbsConfig.McaMemCeStormThreshCount))
      PcdSet16(PcdMcaMemErrThreshCount, 1);
    else
      PcdSet16(PcdMcaMemErrThreshCount, 0xFFE);
    //<Wangyia001-20181017  Modify as Baidu BIOS spec v1.1 ->
