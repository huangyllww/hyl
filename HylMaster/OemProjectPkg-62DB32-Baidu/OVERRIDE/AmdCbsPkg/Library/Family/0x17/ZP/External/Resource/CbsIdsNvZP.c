  ...
  )
{
  ...
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Id = IDSNVID_CMN_MCA_PRO_ERR_THRESH_COUNT_CONTROL;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Attrib.size = IDS_NV_ATTRIB_SIZE_WORD;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Value = Setup_Config->McaProErrThreshCount;
  IdsNvRecord += sizeof (IDS_NV_RECORD_U16);    

  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Id = IDSNVID_CMN_MCA_MEM_ERR_THRESH_COUNT_BAIDU_CONTROL;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Attrib.size = IDS_NV_ATTRIB_SIZE_WORD;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Value = Setup_Config->McaMemErrThreshCount;
  IdsNvRecord += sizeof (IDS_NV_RECORD_U16);    

  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Id = IDSNVID_CMN_MCA_MEM_CE_STORM_THRESH_BAIDU_CONTROL;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Attrib.size = IDS_NV_ATTRIB_SIZE_WORD;
  ((IDS_NV_RECORD_U16 *) IdsNvRecord)->Value = Setup_Config->McaMemCeStormThreshCount;
  IdsNvRecord += sizeof (IDS_NV_RECORD_U16);    
