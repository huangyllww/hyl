...
#ifndef __XGBE_INIT_PEI_H__
#define __XGBE_INIT_PEI_H__

#define AT24C08D_I2C_OWNER     1
#define PCA9545_I2C_OWNER      1
#define MAX_XGBE_INFO_COUNT    32
#define POLY                   (0x8005)
...
typedef struct{
    XGBE_INFO_HEADER  Header;
    XGBE_PORT_DATA    PortData[MAX_XGBE_INFO_COUNT];
}XGBE_INFO;
#pragma pack (pop)
#endif
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_a = {
...
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_a) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  0,  // SocketId
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_b = {    //PNS
        ...
        //   UINT32 PlatformMask;     // The mask of platform table supports
        //   UINT32 Attribute;        // Table attribute},
          {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_b) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
          0,  // SocketId
          {   // DXIO_PORT_DESCRIPTOR
        //  { UINT32  Flags;                    /**< Descriptor flags
        //    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_c = { //2FSP-2SGMII
        ...
        //   UINT32 PlatformMask;     // The mask of platform table supports
        //   UINT32 Attribute;        // Table attribute},
          {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_c) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
          0,  // SocketId
          {   // DXIO_PORT_DESCRIPTOR
        //  { UINT32  Flags;                    /**< Descriptor flags
        //    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_d = { //4SGMII
        ...
        //   UINT32 PlatformMask;     // The mask of platform table supports
        //   UINT32 Attribute;        // Table attribute},
          {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_d) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
          0,  // SocketId
          {   // DXIO_PORT_DESCRIPTOR
        //  { UINT32  Flags;                    /**< Descriptor flags
        //    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_e = { //KR_BCM84328
        ...
        //   UINT32 PlatformMask;     // The mask of platform table supports
        //   UINT32 Attribute;        // Table attribute},
          {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_e) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
          0,  // SocketId
          {   // DXIO_PORT_DESCRIPTOR
        //  { UINT32  Flags;                    /**< Descriptor flags
        //    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHONGHAIA1bS0_f = {   //Kp_inphi4223
        ...
        //   UINT32 PlatformMask;     // The mask of platform table supports
        //   UINT32 Attribute;        // Table attribute},
          {CPM_SIGNATURE_DXIO_TOPOLOGY, sizeof (gCpmDxioTopologyTableHONGHAIA1bS0_f) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
          0,  // SocketId
          {   // DXIO_PORT_DESCRIPTOR
        //  { UINT32  Flags;                    /**< Descriptor flags
        //    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
