  ...
  )
{
  ...
  if (PackageType == ZP_SOCKET_SP4) {
      if ((LogicalId.Family == HYGON_FAMILY_18) && (LogicalId.Revision & HYGON_REV_F18_DN_Dx)) {
          NbioSmuServices->AmdSmuRegisterRead (NbioSmuServices, 0, HG4_OPNFUSEPKG_SP3R2, &FuseValue);
          if ((FuseValue & HG4_OPEN_FUSE_BIT) != 0) {
  ...
  if ((LogicalId.Family == HYGON_FAMILY_18) && (LogicalId.Revision & HYGON_REV_F18_DN_Dx))
      NbioSmuServices->AmdSmuRegisterRead (NbioSmuServices, 0, HG4_MP0_CORE_DISABLE, &CoreDisFusePerDie);
  else
  ...
  // Get OPN TDP
  if ((LogicalId.Family == HYGON_FAMILY_18) && (LogicalId.Revision & HYGON_REV_F18_DN_Dx)) {
      NbioSmuServices->AmdSmuRegisterRead (NbioSmuServices, 0, HG4_MP1_MAX_TDP, &FuseValue);
      OpnMaxTdp = (FuseValue >> HG4_MP1_MAX_TDP_START_BITS) & 0xFF;
  } else {
