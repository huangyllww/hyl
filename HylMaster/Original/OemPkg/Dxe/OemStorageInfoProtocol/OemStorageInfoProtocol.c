    ...
    if (!EFI_ERROR(Status)) {
      ...
      if ( CompareGuid(&DiskInfo->Interface, &gEfiDiskInfoAhciInterfaceGuid) ) {
          ...
          if (EFI_ERROR(Status)) {
            ...
            if (PciDevicePath->Function == 0) {//<zhaoyf1-20191223 Judge board Sata Controller by Function for AMD and Hygon platform 2:board Sata controller 0:not board Sata controller>
              continue;
            }
