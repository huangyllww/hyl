...
//----------------------------	
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.ComplTimeOut==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateOneOfOptionOpCode (
    ...
    //Don't display ARI option, using global control
    DontTouch=TRUE;
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.AriFwd==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.AtomOpReq==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.AtomOpEgressBlk==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.IDOReq==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.IDOCompl==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.LtrReport==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
    ...
    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.E2ETlpPrBlk==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
    if(!DontTouch){
        HiiCreateCheckBoxOpCode (
            gPciDevForm.Pcie2StartOpCodeHandle,
	...
	if (!gIntegratedPcie){
	    ...
	    if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.LnkSpeed==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
	    if(!DontTouch){
            HiiCreateOneOfOptionOpCode (
        ...
        if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.ComplSos==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
    	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
        if(!DontTouch){
            HiiCreateCheckBoxOpCode (
                gPciDevForm.Pcie2StartOpCodeHandle,
        ...
        if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.HwAutoWidth==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
    	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
        if(!DontTouch){
            HiiCreateCheckBoxOpCode (
                gPciDevForm.Pcie2StartOpCodeHandle,
        ...
        if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie2->Pcie2Setup.HwAutoSpeed==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
    	if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
        if(!DontTouch){
            HiiCreateCheckBoxOpCode (
                gPciDevForm.Pcie2StartOpCodeHandle,
...
//----------------------------	
	...
	if (!gIntegratedPcie){
        ...
        DontTouch=FALSE;
		if(GotoData->ParentBrgInfo!=NULL && GotoData->ParentBrgInfo->PciExpress->Pcie1Setup.LnkTrRetry==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie1Setup.LnkTrRetry==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
		if(!DontTouch){
			HiiCreateOneOfOptionOpCode (
		...
		DontTouch=FALSE;
		if(GotoData->ParentBrgInfo!=NULL && GotoData->ParentBrgInfo->PciExpress->Pcie1Setup.LnkTrTimeout==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie1Setup.LnkTrTimeout==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
		if(!DontTouch){
		...
		DontTouch=FALSE;
		if(GotoData->ParentBrgInfo!=NULL && GotoData->ParentBrgInfo->PciExpress->Pcie1Setup.LnkDisable==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo!=NULL && GotoData->PciDevInfo->PciExpress->Pcie1Setup.LnkDisable==PCI_SETUP_DONT_TOUCH) DontTouch=TRUE; 
		if(GotoData->PciDevInfo==NULL && GotoData->ParentBrgInfo==NULL) DontTouch=TRUE;	
		if(!DontTouch){
			HiiCreateCheckBoxOpCode (
				gPciDevForm.Pcie1StartOpCodeHandle,
