...
/** @file FirmwareConfigDrvSrc.h
    Contains structure declarations for FirmwareConfigDrvSrc module part

**/

#ifndef _FW_CONFIG_DRV_SRC_H_
#define	_FW_CONFIG_DRV_SRC_H_
...
#define TRANS_SIZE_PER_REQ_30KB 0x7F00
#define MAX_FILENAME_SIZE       64

#pragma pack(1)
typedef struct _UPLOAD_FILE_PAYLOAD_REQ
{
  UINT8     UploadFlag;    //Byte[1]     0x00-reserved 0x01-last block data
  UINT32    Offset;        //Byte[2:5]   LS byte first
  UINT16    size;          //Byte[6:7]   LS byte first
  UINT32    CheckSum;      //Byte[8:11]  LS byte first
  CHAR8     FileName[64];  //Byte[12:75]
} UPLOAD_FILE_PAYLOAD_REQ;
#pragma pack()

EFI_STATUS SendBiosRfData(CHAR8 *Data, UINTN DataLength, CHAR8 *fileType);

GLOBAL_REMOVE_IF_UNREFERENCED CONST UINT32  tCrcTable[256] = {
  0x00000000,
  0x77073096,
  0xEE0E612C,
  0x990951BA,
...
#define MAX_DEBUG_DISPLAY_CHAR   1024

#define BIOS_INDEX_ATTRIBUTES    "Attributes"
...
EFI_STATUS 	GetNetRequest (EFI_HTTP_METHOD Method, CHAR16 *UrlStr, EFI_HTTP_HEADER  *Headers, UINTN HeaderCount, VOID *Body, VOID **Response, UINTN *ResponseLength);
CHAR8 *		ConvertChar16toChar8(CHAR16 *InputString16);
EFI_STATUS 	FirmwareConfigurationEntry();
CHAR16 		*GetProjectWideTag ();
...
UINT8 		FWCGetResetType();
EFI_STATUS 	GetMacAddress(CHAR16 **MacAddress);
...
extern EFI_GUID 			FwcgEfiRestProtocolGuid;
extern EFI_GUID 			FwcgEfiHttpUtilitiesProtocolGuid;
extern EFI_REST_PROTOCOL 	*gRestInstance;
extern EFI_HANDLE           gProtocolHandle;//<kuaibai-20181222-fix hang b2 when ipmi abnormal>
extern EFI_GUID				gEfiIp4Config2ProtocolGuid;
extern EFI_GUID gResetTypeGuid;
extern EFI_GUID gEMAIndicationsGuid;
...
extern void InitializingFWConfigHIIString() ;
...
extern CHAR16   *RestoreBIOSSetting;
extern CHAR16 *RestoreBIOSSetting;
#endif
//<xuyj1-20211207 Add BIOS Save Configuration after update BIOS ->

#endif /* _FW_CONFIG_DRV_SRC_H_ */
