...
///
typedef struct {
  UINT32                SdConfig;                       ///< SD Mode configuration
                                                        ///   @li <b>00</b> - Disabled
                                                        ///   @li <b>00</b> - AMDA
                                                        ///   @li <b>01</b> - DMA
                                                        ///   @li <b>10</b> - PIO
...
///
typedef struct _SB_SPI_DEVICE_PROFILE {
...
} SB_SPI_DEVICE_PROFILE;

///
/// _SPI_CONTROLLER_PROFILE Spi Device Profile structure
///
typedef struct _SB_SPI_CONTROLLER_PROFILE {
...
//  UINT8                 SpiProtectEn0_1d_34;                  ///
  ...
  SB_SPI_DEVICE_PROFILE    SpiDeviceProfile;               ///< Spi Device Profile
} SB_SPI;
...
typedef struct {
    ...
    union {
        UINT8   PciClks;
        struct {
            UINT8   PciClk0:1;  ///< 33MHz PCICLK0/1/2/3 Enable, bits [0:3] used
            UINT8   PciClk1:1;  ///   @li <b>0</b> - disable
            UINT8   PciClk2:1;  ///   @li <b>1</b> - enable
            UINT8   PciClk3:1;  ///
            UINT8   PciClk4:1;
            UINT8   PciClk5:1;
            UINT8   PciClk6:1;
...
///
typedef struct _SB_SATA_PHY_SETTING {
...
///
/// SB_SATA_PORT_ST - SATA PORT structure
///
typedef union _SB_SATA_PORT_ST {
    UINT8   SataPortReg;                    ///< SATA Port bit map - bits[0:7] for ports 0 ~ 7
                                                        ///  @li <b>0</b> - disable
                                                        ///  @li <b>1</b> - enable
                                                        ///
    struct {
    UINT8   Port0:1;                          ///< PORT0 - 0:disable, 1:enable
    UINT8   Port1:1;                          ///< PORT1 - 0:disable, 1:enable
    UINT8   Port2:1;                          ///< PORT2 - 0:disable, 1:enable
    UINT8   Port3:1;                          ///< PORT3 - 0:disable, 1:enable
    UINT8   Port4:1;                          ///< PORT4 - 0:disable, 1:enable
    UINT8   Port5:1;                          ///< PORT5 - 0:disable, 1:enable
    UINT8   Port6:1;                          ///< PORT6 - 0:disable, 1:enable
    UINT8   Port7:1;                          ///< PORT7 - 0:disable, 1:enable
    };
} SB_SATA_PORT_ST;

///
///< _SB_SATA_PORT_MD - Force Each PORT to GEN1/GEN2 mode
///
typedef union _SB_SATA_PORT_MD {
    UINT16  SataPortMode;                   ///< SATA Port GEN1/GEN2 mode bit map - bits [0:15] for ports 0 ~ 7
    struct {
    UINT8  Port0:2;                          ///< PORT0 - set BIT0 to GEN1, BIT1 - PORT0 set to GEN2
    UINT8  Port1:2;                          ///< PORT1 - set BIT2 to GEN1, BIT3 - PORT1 set to GEN2
    UINT8  Port2:2;                          ///< PORT2 - set BIT4 to GEN1, BIT5 - PORT2 set to GEN2
    UINT8  Port3:2;                          ///< PORT3 - set BIT6 to GEN1, BIT7 - PORT3 set to GEN2
    UINT8  Port4:2;                          ///< PORT4 - set BIT8 to GEN1, BIT9 - PORT4 set to GEN2
    UINT8  Port5:2;                          ///< PORT5 - set BIT10 to GEN1, BIT11 - PORT5 set to GEN2
    UINT8  Port6:2;                          ///< PORT6 - set BIT12 to GEN1, BIT13 - PORT6 set to GEN2
    UINT8  Port7:2;                          ///< PORT7 - set BIT14 to GEN1, BIT15 - PORT7 set to GEN2
    };
} SB_SATA_PORT_MD;
///
/// SATA structure
...
typedef struct {
  ...
  SB_SATA_ST            SataMode;                       /// SataMode - Reserved
  UINT32                SataClass;                      ///< SataClass - SATA Controller mode [2:0]
  ...
  SB_SATA_PORT_ST       SataEspPort;                    ///<  SataEspPort - SATA port is external accessible on a signal only connector (eSATA:)

  SB_SATA_PORT_ST       SataPortPower;                  ///<  SataPortPower - Port Power configuration

  SB_SATA_PORT_MD       SataPortMd;                     ///<  SataPortMd - Port Mode
  ...
  SB_SATA_PORT_ST       SataHotRemovalEnhPort;          ///<  SataHotRemovalEnhPort - Hot Remove
...
typedef struct {
  ...
  SB_TIMER_SMI          LongTimer;                      ///< Long Timer SMI
  SB_TIMER_SMI          ShortTimer;                     ///< Short Timer SMI
  ...
  SB_CS                 FchCsSupport;                   ///< FCH Cs function structure
} SB_MISC;
...
typedef struct {
  ...
  BOOLEAN               SpreadSpectrum;                 ///< SpreadSpectrum
                                                        ...
                                                        ///   @li <b>1</b> - enable
                                                        ///
  UINT32                PwrFailShadow;                  ///< PwrFailShadow = PM_Reg: 5Bh [3:0]
                                                        ///  @par
...
///
typedef struct _SB_AB_TBL_ENTRY {
...
///
/// SB_GPP_PORT_CONFIG - Fch GPP port config structure
///
typedef struct {
...
///
typedef struct {
  SB_GPP_PORT_CONFIG    PortCfg[4];                     /// GPP port configuration structure
  UINT32                GppLinkConfig;                  ///< GppLinkConfig - PCIE_GPP_Enable[3:0]
...
// AMD definition
    ...
    ///////////////////////////////////////////
    // FCH_DATA_BLOCK
    SB_ACPI              HwAcpi;                         ///< ACPI structure
    SB_AB                Ab;                             ///< AB structure
    SB_USB               Usb;                            ///< USB structure
    SB_SATA              Sata;                           ///< SATA structure
    SB_SMBUS             Smbus;                          ///< SMBus structure
    SB_IDE               Ide;                            ///< IDE structure
    SB_SPI               Spi;                            ///< SPI structure
    SB_PCIB              Pcib;                           ///< PCIB structure
    SB_SD                Sd;                             ///< SD structure
    SB_DEVENMAP          FchDevEnMap;                    ///< SB FchDeviceEnableMap
    SB_DEVD3MAP          FchDevD3Map;                    ///< SB FchDeviceD3ColdMap
    SB_IR                Ir;                             ///< IR structure
    SB_HPET              Hpet;                           ///< HPET structure
    SB_GCPU              Gcpu;                           ///< GCPU structure
    SB_IMC               Imc;                            ///< IMC structure
    SB_MISC              Misc;                           ///< MISC structure
    // FCH_DATA_BLOCK
    ///////////////////////////////////////////
// AMD definition
