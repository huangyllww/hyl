...
SyncSetupSetting()
{
  ...
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]DebugModeSupport:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->DebugModeSupport));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]DxePrintSupport:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->DxePrintSupport));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]PeiPrintSupport:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->PeiPrintSupport));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]RTSPrintSupport:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->RTSPrintSupport));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]PeiErrorLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->PeiErrorLevel));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]PeiInfoLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->PeiInfoLevel));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]PeiWarnLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->PeiWarnLevel));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]DxeErrorLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->DxeErrorLevel));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]DxeInfoLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->DxeInfoLevel));
  DEBUG((EFI_D_INFO, "[OemDbg][%a][%d]DxeWarnLevel:%x\r\n", __FUNCTION__, __LINE__, OemDebugLevelConfigData->DxeWarnLevel));
...
SyncCMOSSetting()
{
  UINT8                                 DebugModeMask=GetDebugFlag();

  MODULE_START

  if((pOemDebugLevel_SetupConfig->DebugModeSupport == 1) && (pOemDebugLevel_SetupConfig->DxePrintSupport ==1))
    DebugModeMask |=DXE_DEBUG_ENABLED;
  else
    DebugModeMask &=~DXE_DEBUG_ENABLED;
  
  if((pOemDebugLevel_SetupConfig->DebugModeSupport == 1) && (pOemDebugLevel_SetupConfig->RTSPrintSupport ==1))
