...
SyncCMOSSetting()
{
  ...
  if((gOemDebugLevelDataBase->DebugModeSupport == 0) || (gOemDebugLevelDataBase->DxePrintSupport ==0))
    DebugModeMask &=~BIT1;

  if((gOemDebugLevelDataBase->DebugModeSupport == 0) || (gOemDebugLevelDataBase->RTSPrintSupport ==0))
    DebugModeMask &=~BIT3;
