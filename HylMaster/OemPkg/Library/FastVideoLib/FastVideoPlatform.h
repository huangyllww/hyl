...
#define ROW_NUMBER_FOR_CHECKPOINT   24
#define ROW_NUMBER_FOR_MODULE_INFO  23


static DEV_PATH mVidPath [] = {
    {AST_SB_DEV_NUM,AST_SB_FUNC_NUM},   //PCIe-PCI bridge
    {0x00,0x0},   //PCI-PCI bridge
    {0x00,0x0}    //Video Controller
};

static UINT8 mFontData[] = {
//0x20, ' '
...
static FONT_MAP_INFO mFontMapInfo = {
  mFontData,
