...
_1BYTE_ALIGN UINT8  ParameterListValue[] = {
  ...
  BSBLN (BLDCFG_MEM_INTERNAL_SPD_DIS),              //< Use internal fixed spd information
  BSBLN (BLDCFG_MEM_SUPPORT_1SPC_AND_2SPC_MIXED_MODE_DIS),     //< Support 1SPC and 2SPC design scheme or not
  BSU08 (0xFF)
};
