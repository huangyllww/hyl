...
SL1R2_MAKE_TX_EQ_FREQ_TABLE_COMPACT(XGMI_TX_EQ_SPEED_96, SOC_GEN_1, SOC_SL1R2,
    MAKE_TX_EQ_LIST_COMPACT(MAKE_TX_EQ_SOCKET0_DIE0_EACH_LANES_COMPACT(),
        MAKE_TX_EQ_LANE_DATA( 30, 36,  4 ), // lane  0
    ...
    MAKE_TX_EQ_LIST_COMPACT(MAKE_TX_EQ_SOCKET0_DIE1_EACH_LANES_COMPACT(),
        ...
        MAKE_TX_EQ_LANE_DATA( 29, 44,  0 ), // lane  3
        MAKE_TX_EQ_LANE_DATA( 28, 44,  4 ), // lane  4
        MAKE_TX_EQ_LANE_DATA( 29, 44,  0 ), // lane  5
        MAKE_TX_EQ_LANE_DATA( 29, 40,  4 ), // lane  6
        MAKE_TX_EQ_LANE_DATA( 29, 44,  0 ), // lane  7
        MAKE_TX_EQ_LANE_DATA( 30, 40,  0 ), // lane  8
        MAKE_TX_EQ_LANE_DATA( 29, 44,  0 ), // lane  9
        MAKE_TX_EQ_LANE_DATA( 30, 40,  0 ), // lane 10
        MAKE_TX_EQ_LANE_DATA( 28, 40,  8 ), // lane 11
        MAKE_TX_EQ_LANE_DATA( 29, 44,  0 ), // lane 12
        MAKE_TX_EQ_LANE_DATA( 28, 44,  4 ), // lane 13
    ...
    MAKE_TX_EQ_LIST_COMPACT(MAKE_TX_EQ_SOCKET1_DIE0_EACH_LANES_COMPACT(),
        MAKE_TX_EQ_LANE_DATA( 29, 40,  4 ), // lane  0
        MAKE_TX_EQ_LANE_DATA( 30, 40,  0 ), // lane  1
        MAKE_TX_EQ_LANE_DATA( 29, 40,  4 ), // lane  2
        ...
        MAKE_TX_EQ_LANE_DATA( 29, 40,  4 ), // lane 11
        MAKE_TX_EQ_LANE_DATA( 28, 44,  4 ), // lane 12
