...
APCB_TYPE_HEADER       ApcbTypeHeader = {
  APCB_GROUP_CCX,
  APCB_CCX_TYPE_CONFIG_DEFAULT_PARAMETERS,
  (
...
APCB_PARAM_ATTRIBUTE  ParameterListDefaultsAttribute[] = {
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CONFIG_CCX_MIN_SEV_ASID, sizeof (UINT32) - 1, 0},
  {0, APCB_TOKEN_CONFIG_LIMIT, 0, 0},
};

_1BYTE_ALIGN UINT8  ParameterListDefaultsValue[] = {
  BSU32 (BLDCFG_CCX_MIN_SEV_ASID),                 //< MIN_SEV_ASID
  BSU08 (0xFF)
};
