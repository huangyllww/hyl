...
APCB_PARAM_ATTRIBUTE  ParameterListAttribute[] = {
  ...
  {APCB_TIME_POINT_ANY, APCB_TOKEN_CONFIG_DF_BUS_NUM_ASSIGN_STRATEGY, sizeof (UINT64) - 1, 0},
...
_1BYTE_ALIGN UINT8  ParameterListValue[] = {
  ...
  BSU64 (BLDCFG_DF_BUS_NUM_ASSIGN_STRATEGY),      //< Enable PCI_BUS_Allocate Feature
  BSU08 (0xFF)
};
