...
//<Kangmm-20220224-SGEZT According BoardId to adjust CbsCpuSmtCtrl item +>
  UINT32 Value;
  UINT8 BoardId;
//<Kangmm-20220224-SGEZT According BoardId to adjust CbsCpuSmtCtrl item ->  
  ...
  //<Kangmm-20220224-SGEZT22429 According BoardId to adjust CbsCpuSmtCtrl item +> 
    ...
    DEBUG ((-1, "AmdSetup BoardId 1 = %x\n",BoardId));
    //clear in case other functions don't pay attention to this reg
    PciWrite32(NB_SMN_INDEX_EXT_3_BIOS, 0);
    if(BoardId == 1)
    {
        DEBUG ((-1, "AmdSetup SMT disable\n"));
        ((IDS_NV_RECORD_U8 *) IdsNvRecord)->Value = 0;                                    // SMT Control
    }else{
        DEBUG ((-1, "AmdSetup SMT enable \n"));
        ((IDS_NV_RECORD_U8 *) IdsNvRecord)->Value = 1;                                    // SMT Control 
    }
  //<Kangmm-20220224-SGEZT22429 According BoardId to adjust CbsCpuSmtCtrl item ->
  IdsNvRecord += sizeof (IDS_NV_RECORD_U8);    
