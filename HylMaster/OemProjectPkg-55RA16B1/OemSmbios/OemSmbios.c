...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE_9 SystemSlotsInfo[] = {
    {    SYS_SLOT_PCIE_4,    DBW_16X, LONG_LENGTH, 0x1, 0x1,  "CPU0 PCIe Riser2 Slot1",    L"PciRoot(0x3)/Pci(0x3,0x1)",    FALSE, INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_4,    DBW_8X, SHORT_LENGTH, 0x2, 0x2,   "CPU0 PCIe Riser1 Slot2",    L"PciRoot(0x2)/Pci(0x3,0x2)",    FALSE, PRSNT_HDDBP_N(InputHigh), INVALID_SETTING_ARRARY},
    {    SYS_SLOT_PCIE_3,    DBW_8X, SHORT_LENGTH, 0x1, 0x1,   "CPU0 PCIe Riser3 Slot1",    L"PciRoot(0x1)/Pci(0x1,0x1)",    FALSE, INVALID_SETTING_ARRARY },
    
//for rear slot
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,  "CPU1 PCIe Slot 1",    L"PciRoot(0x7)/Pci(0x3,0x1)",    FALSE, PRSNT_REAR_PCIE_0_N(InputHigh),PRSNT_REAR_PCIE_1_N(InputHigh), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,  "CPU1 PCIe Slot 1",    L"PciRoot(0x7)/Pci(0x3,0x1)",    FALSE, PRSNT_REAR_PCIE_0_N(InputHigh),PRSNT_REAR_PCIE_1_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_16X, LONG_LENGTH, 0x1, 0x1,  "CPU1 PCIe Slot 1",    L"PciRoot(0x7)/Pci(0x3,0x1)",    FALSE, PRSNT_REAR_PCIE_0_N(InputLow),PRSNT_REAR_PCIE_1_N(InputHigh), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x1, 0x1,   "CPU1 PCIe Slot 1",    L"PciRoot(0x7)/Pci(0x3,0x1)",    FALSE, PRSNT_REAR_PCIE_0_N(InputLow),PRSNT_REAR_PCIE_1_N(InputLow), INVALID_SETTING_ARRARY },
    {    SYS_SLOT_PCIE_3,    DBW_8X, LONG_LENGTH, 0x2, 0x2,   "CPU1 PCIe Slot 2",    L"PciRoot(0x7)/Pci(0x3,0x2)",    FALSE, PRSNT_REAR_PCIE_0_N(InputLow),PRSNT_REAR_PCIE_1_N(InputLow), INVALID_SETTING_ARRARY },
