...
typedef struct {
  ...
  UINT32          PlatformDm1:1;              ///< BIT_1 DM1 package
  UINT32          :(31 - 2);                  ///< The possibilities are (not quite) endless.
