...
typedef enum {
  ...
  // ABL5 test points
  TpAbl5End                                  = 0xE100, ///< ABL 5 End
  TpAbl5ResumeInitialization                 = 0xE101, ///< ABL 5 Resume boot
  ...
  TpAblErrorNoDimmOnAnyChannelInSystem                = 0xE310,  ///< ABL Error No Dimms On Any Channel in sysem 
  TpAblMemAlertPmuMajorMsg                            = 0xE311,  ///< ABL Alert PMU Major Message captured
  TpAblMemAlertPmuResultsRxTmg                        = 0xE312,  ///< ABL Alert PMU REsults Rx Timing captured
  TpAblMemAlertPmuResultsTxTmg                        = 0xE313,  ///< ABL Alert PMU REsults Tx Timing captured
  TpAblMemAlertPmuResultsRxVref                       = 0xE314,  ///< ABL Alert PMU REsults Rx Vref captured
  TpAblMemAlertPmuResultsTxVref                       = 0xE315,  ///< ABL Alert PMU REsults Tx Vref captured
  TpAblErrorNoMemoryAvailableInSystem                 = 0xE316,  ///< ABL Error No memory available in system
  TpAblApcbLoadError                                  = 0xEACB,   ///< ABL Alert APCB Failed to Load
