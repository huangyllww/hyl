...
#define  HSTI_AMD_V2_IMPLEMENTATIONID           L"AMD HSTI Implementation V2"
  ...
  )
{
  ...
  StrCpyS (Hsti->ImplementationID, 256, HSTI_AMD_V2_IMPLEMENTATIONID);
  ...
  HstiLibSetFeaturesVerified (PLATFORM_SECURITY_ROLE_PLATFORM_REFERENCE, HSTI_AMD_V2_IMPLEMENTATIONID, HSTI_AMD_FEATURE_BYTE_INDEX_4, HstiData[HSTI_AMD_FEATURE_BYTE_INDEX_4]);
