...
#define APOB_VERSION          0x0010      ///< AP0B Version
...
#define APOB_STATUS_REPAIR_SOCKET_INVALID_ERROR   10  ///< Repair Error, Socket is not valid
#define APOB_STATUS_REPAIR_CHANNEL_INVALID_ERROR  20  ///< Repair Error, Channel is not valid  
#define APOB_STATUS_REPAIR_DEVICE_INVALID_ERROR  40   ///< Repair Error, Device is not valid
#define APOB_STATUS_REPAIR_DEVICE_MISSMATCH_ERROR 80  ///< Repair Error, Device missmatch
...
#define APOB_MAX_DPPRCL_ENTRY 24
