...
)
{
  ...
  //Check if H3 or H4 for Gen4
  BaseGetLogicalIdOnExecutingCore (&LogicalId); 
  if(LogicalId.Revision & (HYGON_REV_F18_DN_Cx)){
    switch(Die){
    case 0:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdH3Gen4CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen4CfgDie7Pcie1Preset);
        }
        break;
    }
    ...
    case 0:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdH4Gen4CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen4CfgDie7Pcie1Preset);
        }
        break;
     }        
  }
...
{
  SOC_LOGICAL_ID            LogicalId;
  //Check if H3 or H4 for Gen3
  BaseGetLogicalIdOnExecutingCore (&LogicalId); 
  if(LogicalId.Revision & (HYGON_REV_F18_DN_Dx)){
    switch(Die){
    case 0:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdH4Gen3CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdH4Gen3CfgDie7Pcie1Preset);
        }
        break;
    }  
    ...
    case 0:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie0Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie0Pcie1Preset);
        }
        break;
    case 1:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie1Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie1Pcie1Preset);
        }
        break;
    case 2:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie2Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie2Pcie1Preset);
        }
        break;
    case 3:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie3Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie3Pcie1Preset);
        }
        break;
    case 4:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie4Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie4Pcie1Preset);
        }
        break;
    case 5:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie5Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie5Pcie1Preset);
        }
        break;
    case 6:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie6Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie6Pcie1Preset);
        }
        break;
    case 7:
        if(Core==0){
          return PcdGet8(PcdH3Gen3CfgDie7Pcie0Preset);
        }else{
          return PcdGet8(PcdH3Gen3CfgDie7Pcie1Preset);
        }
        break;
     }  
  }
  ...
  )
{
  ...
  while (PcieWrapper != NULL) {
      ...
      while (PcieEngine != NULL) {
          if((CpuGen == CPU_HG3) || (CpuGen == CPU_HG4)){ 
  ...
  )
{
  ...
  while (PcieWrapper != NULL) {
    ...
    //set H3 PCIe default Tx Preset
    if(CpuGen == CPU_HG3){
      //set H3 Gen3 PCIe default Tx Preset
      ...
      if(GetPcieCorePresetPcdGen4(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        //set H3 Gen4 PCIe default Tx Preset    
    ...
    //set H4 PCIe default Tx Preset 
    if(CpuGen == CPU_HG4){
      //set H4 Gen3 PCIe default Tx Preset 
      if(GetPcieCorePresetPcdGen3(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        Index = DXIO_STRAP_BIF_BASEADDRSS | 0x8a;//0xfffe0090;
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
      ...
      //set H4 PCIe Gen4 default Tx Preset
      if(GetPcieCorePresetPcdGen4(GnbHandle->InstanceId, PcieWrapper->WrapId) != 0xff){
        Index = DXIO_STRAP_BIF_BASEADDRSS | 0x347;
        NbioRegisterWrite (GnbHandle,
                          TYPE_SMN,
