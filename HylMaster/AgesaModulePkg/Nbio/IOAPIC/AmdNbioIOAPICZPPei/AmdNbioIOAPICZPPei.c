...
#define FILECODE   NBIO_IOAPIC_AMDNBIOIOAPICZPPEI_AMDNBIOIOAPICZPPEI_FILECODE
...
/*----------------------------------------------------------------------------------------*/
/**
 * AmdNbio IOAPIC ZP PEI driver entry point
 *
 *
 *
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "AmdNbioIOAPICZPPEIEntry Entry\n");
  ...
  if (Status == EFI_SUCCESS) {
    ...
    while (GnbHandle != NULL) {
      ...
      GnbRegisterWriteZP (GnbHandle, TYPE_SMN, IOAPIC_BASE_ADDR_LOW_REG, &Value, 0, (AMD_CONFIG_PARAMS *) NULL);
      GnbHandle = GnbGetNextHandle (GnbHandle);
    }
  }

  IDS_HDT_CONSOLE (MAIN_FLOW, "AmdNbioIOAPICZPPEIEntry Exit\n");
