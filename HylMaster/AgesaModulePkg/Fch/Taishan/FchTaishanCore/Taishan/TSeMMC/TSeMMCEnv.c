...
#include "Filecode.h"
#define FILECODE PROC_FCH_TAISHAN_TSEMMC_TSEMMCENV_FILECODE
...
//    RwMem (ACPI_MMIO_BASE + PMIO_BASE + FCH_PMIOA_REGE8, AccessWidth8, ~(UINT32) BIT4, 0);
//    FchAoacPowerOnDev (FCH_AOAC_EMMC, 0);
  }
}
