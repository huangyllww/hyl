...
#include <Library/SmmFabricTopologyServicesLib.h>
#include "Filecode.h"

#define FILECODE FABRIC_ZP_FABRICZPSMM_AMDFABRICZPSMM_FILECODE
...
EFI_STATUS
EFIAPI
AmdFabricZpSmmDriverEntryPoint (
  ...
  )
{
  ...
  Status = FabricTopologyServiceSmmProtocolInstall (ImageHandle, SystemTable);
