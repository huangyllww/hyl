...
/** @file JedecNvdimmSmbus.h
    Header file for JedecNvdimmSmbus Driver

**/

#ifndef _JEDEC_NVDIMM_SMBUS_H_
#define _JEDEC_NVDIMM_SMBUS_H_
...
#ifndef FCH_ML_PMIOA_REG00
#define FCH_ML_PMIOA_REG00      0x00     // DecodeEn
#endif
