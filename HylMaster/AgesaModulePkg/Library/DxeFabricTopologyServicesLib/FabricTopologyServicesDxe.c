...
#include <Filecode.h>
#include "AGESA.h"
#include "FabricTopologyServicesDxe.h"

#define FILECODE LIBRARY_DXEFABRICTOPOLOGYSERVICESLIB_FABRICTOPOLOGYSERVICESDXE_FILECODE

STATIC AMD_FABRIC_TOPOLOGY_SERVICES_PROTOCOL  mFabricTopologyServicesProtocol = {
...
EFI_STATUS
EFIAPI
FabricTopologyServiceProtocolInstall (
  ...
  )
{
  ...
  Status = gBS->InstallProtocolInterface (
                ...
                &mFabricTopologyServicesProtocol
                );
