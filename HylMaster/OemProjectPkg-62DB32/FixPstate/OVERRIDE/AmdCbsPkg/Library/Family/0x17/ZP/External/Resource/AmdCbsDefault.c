...
#include <Token.h> //<Xielsh-20190809 default value as token defined in SDL +>
  ...
  )
{
  ...
  Setup_Config->CbsCmnCpuRdseedRdrandCtrl = 3;                          // Enable CPU RdseedRdrand Feature, hzp20170921+ //PS-625
  Setup_Config->CbsCmnCpuLoadUcodeCtrl = 1;                             // Enable CPU load ucode Feature, <PS-315+>
  //add new available ccp vq count item 2019/12/05 ---> 
  Setup_Config->CbsCmnAvailableVqCount=0;
  //<--- add new available ccp vq count item 2019/12/05
  Setup_Config->CbsCmnCpuRdseedRdrandCap = 1;                           // Display RdseedRdrand configuration item in CBS, <PS-625+>
  ...
  //<Lvshh001-20200426 Hygon CBS Default Setting +>
  ...
  //<Chendl001-20190808 Hygon CBS Default Setting +>
  ...
  Setup_Config->CbsCmnGnbNbIOMMU = DEFAULT_CBS_IOMMU;                                   // IOMMU
  //<Chendl001-20190808 20190808 Hygon CBS Default Setting, IOMMU=Enabled ->
