...
/*----------------------------------------------------------------------------------------*/
/**
 * Entry point of the AMD CPM BoardID PEIM driver
 *
...
//  ASSERT_EFI_ERROR (Status);
  ...
  Status = M24Lc128Ppi->Read (PeiServices, 5, 0x50, 0, sizeof (AMD_EEPROM_ROOT_TABLE), (UINT8*)BoardIdBuffer);
