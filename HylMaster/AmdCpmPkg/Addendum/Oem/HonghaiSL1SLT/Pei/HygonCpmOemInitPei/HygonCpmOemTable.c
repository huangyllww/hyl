...
//    GPIO_DEF_V2 (0, 0, 131, GPIO_FUNCTION_3,  GPIO_OUTPUT_HIGH, GPIO_PU_EN    ),   // 0: SATA, 1: PCIE
    ...
    GPIO_DEF_V2 (0, 2, 147,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //Die 2 xgbe SPF_SCL
    GPIO_DEF_V2 (0, 2, 148,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //Die 2 for xgbe SPF_SDA
    GPIO_DEF_V2 (0, 3, 147,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //Die 3 xgbe SPF_SCL
    GPIO_DEF_V2 (0, 3, 148,  GPIO_FUNCTION_1,  GPIO_NA,       GPIO_PU_PD_DIS),   //Die 3 for xgbe SPF_SDA
    0xFF,
  }
};
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
      ...
      { // G2 - x16 slot
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 64, 79, DxioHotplugDisabled, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          1,                                    // Requested Device
          1,                                    // Requested Function
     ...
     { // G3 - x16 slot
         0,
         DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 96, 111, DxioHotplugDisabled, 1),
         DXIO_PORT_DATA_INITIALIZER_PCIE (
         DxioPortEnabled,                      // Port Present
         1,                                    // Requested Device
         1,                                    // Requested Function
...
HYGON_CPM_EQ_CONFIG_TABLE  gCpmEqConfigurationTableHonghaiSL1SLT = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof (gCpmEqConfigurationTableHonghaiSL1SLT) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    ...
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 2, 0xFFFFFFFF, 0xFFFFFFFF, 0,  15, TRUE, {4}},
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 3, 0xFFFFFFFF, 0xFFFFFFFF, 16,  31, TRUE, {4}},
