...
extern  AMD_CPM_GPIO_INIT_TABLE                   gCpmGpioInitTableHygon62DB32SL1r2;
extern  AMD_CPM_GEVENT_INIT_TABLE                 gCpmGeventInitTableHygon62DB32SL1r2;
extern  AMD_CPM_GPIO_DEVICE_CONFIG_TABLE          gCpmGpioDeviceConfigTableHygon62DB32SL1r2;
extern  AMD_CPM_GPIO_DEVICE_DETECTION_TABLE       gCpmGpioDeviceDetectionTableHygon62DB32SL1r2;
extern  AMD_CPM_GPIO_DEVICE_RESET_TABLE           gCpmGpioDeviceResetTableHygon62DB32SL1r2;
extern  AMD_CPM_GPIO_DEVICE_POWER_TABLE           gCpmGpioDevicePowerTableHygon62DB32SL1r2;
extern  AMD_CPM_PCIE_CLOCK_TABLE                  gCpmPcieClockTableHygon62DB32SL1r2;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHygon62DB32SL1r2S0;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHygon62DB32SL1r2S1;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHygon62DB32SL1r2S0_4DIE;
extern  AMD_CPM_DXIO_TOPOLOGY_TABLE               gCpmDxioTopologyTableHygon62DB32SL1r2S1_4DIE;
extern  HYGON_CPM_EQ_CONFIG_TABLE                 gCpmEqConfigurationTableHygon62DB32SL1r2;
...
VOID *gCpmTableList[] = {
  ...
  &gCpmPreInitTable,
  &gCpmGpioInitTableHygon62DB32SL1r2,
  &gCpmGeventInitTableHygon62DB32SL1r2,
  &gCpmGpioDeviceConfigTableHygon62DB32SL1r2,
  &gCpmGpioDevicePowerTableHygon62DB32SL1r2,
  &gCpmGpioDeviceDetectionTableHygon62DB32SL1r2,
  &gCpmGpioDeviceResetTableHygon62DB32SL1r2,
  &gCpmPcieClockTableHygon62DB32SL1r2,
  &gCpmDxioTopologyTableHygon62DB32SL1r2S0,
  &gCpmDxioTopologyTableHygon62DB32SL1r2S1,
  &gCpmEqConfigurationTableHygon62DB32SL1r2,
  NULL
};
//<duanjun-20200427-support 5xx cpu && 7xx cpu +>
VOID *gCpmTableList_4DIE[] = {
  &gCpmMainTable,
  &gCpmPlatformIdTable,
  &gCpmPlatformIdConvertTable,
  &gCpmPreInitTable,
  ...
  &gCpmGpioDeviceResetTableHygon62DB32SL1r2,
  &gCpmPcieClockTableHygon62DB32SL1r2,
  &gCpmDxioTopologyTableHygon62DB32SL1r2S0_4DIE,
  &gCpmDxioTopologyTableHygon62DB32SL1r2S1_4DIE,
  &gCpmEqConfigurationTableHygon62DB32SL1r2,
  NULL
};
//<duanjun-20200427-support 5xx cpu && 7xx cpu ->
...
//<duanjun-20200427-support 5xx cpu && 7xx cpu +>	
    if (Is2diecpu()) {
        ...
        AmdCpmOemTablePpi->TableList = &gCpmTableList_4DIE[0];
    }
//<duanjun-20200427-support 5xx cpu && 7xx cpu ->	
    Status = (*PeiServices)->AllocatePool (
                               PeiServices,
