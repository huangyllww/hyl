...
extern LPC_AHB_DATA AST2500_SCU_Access_For_Debug_Table[];
extern UINT8 AST2500_SCU_Access_For_Debug_Table_Count;
...
#if (AST2500_SCU_ACCESS_ENABLE)
    // initialize SCU part.
    for(i=0; i< AST2500_SCU_Access_For_Debug_Table_Count; i++) {
        address = (UINT32)(AST2500_SCU_BASE | (AST2500_SCU_Access_For_Debug_Table[i].Offset));
        lpc_read(address , &Value);
        Value &= (AST2500_SCU_Access_For_Debug_Table[i].And);
        Value |= (AST2500_SCU_Access_For_Debug_Table[i].Or);
