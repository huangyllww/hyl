  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gAmdFabricTopologyServicesProtocolGuid, NULL, &FabricTopology);
  ...
  for (SocketLoop = 0; SocketLoop < NumberOfSockets; SocketLoop++) {
    ...
    LogicalCoreNum = 0;
    LApicIdLoop = 0;
    if (FabricTopology->GetProcessorInfo (FabricTopology, SocketLoop, &NumberOfDies, NULL, NULL, NULL) == EFI_SUCCESS) {
  ...
  )
{
  ...
  CalledStatus = gBS->LocateProtocol (&gAmdFabricTopologyServicesProtocolGuid, NULL, (VOID **) &FabricTopology);
