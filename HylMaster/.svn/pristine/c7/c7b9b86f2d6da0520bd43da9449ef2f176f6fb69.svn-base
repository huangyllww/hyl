...
// <hety-20220521 Modify "Release Version Information" follow Tencent spec V1.5 +>
#if     defined(TENCENT_ERRATA)
...
//<LiuYB006-20170105 Change project version format>        L"%s %d.%02d x64",
        L"%s%d%02d x64",  //<LiuYB006-20170105 Change project version format>
#else
        L"%s %d.%02d",
#endif
...
#endif //if defined(TENCENT_ERRATA)
