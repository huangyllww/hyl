		...
		case ACTION_TYPE_TIMER:
			{
				...
				//Mizl-20210617-EIP 618398 System Hang When Enter LSI UEFI Driver+>
				UINT32       OriControlCount = frame->ControlCount;
        FRAME_DATA   *OriFrame = frame;
        CONTROL_DATA *OriControl;
				//Mizl-20210617-EIP 618398 System Hang When Enter LSI UEFI Driver->
          ...
          OriControl = *control;
					...
					TempStatus = (*control)->Methods->HandleAction( *control, action );
					//EFI_STATUS TempStatus = (*control)->Methods->HandleAction( *control, action );

					if (frame != OriFrame || frame->ControlCount != OriControlCount || *control != OriControl)
          {
            return EFI_UNSUPPORTED;
          }
					//Mizl-20210617-EIP 618398 System Hang When Enter LSI UEFI Driver->
