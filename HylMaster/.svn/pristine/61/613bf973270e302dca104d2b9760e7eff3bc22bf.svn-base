...
// UART2
  ...
  Device(COM3) {  // COM Port
    Name(_HID, EISAID("PNP0501"))
    Name(_DDN, "COM2")  //<hujf1001-20190315 Enable SIO COM port and pass Loopback test by QTPRO tool +>
    Name(_UID, 0x2)  //<hujf1001-20190315 Enable SIO COM port and pass Loopback test by QTPRO tool +>
    Name(TIRQ, 0)
