...
HYGON_CPM_EQ_CONFIG_TABLE   gCpmEqConfigurationTableHygon62DB32 = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof ( gCpmEqConfigurationTableHygon62DB32) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    ...
    /*{FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0xa813144d, 0, 3, TRUE, {8,8,8,8}},//libj-20220325-adject C0P0 NVME EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0xa813144d, 4, 7, TRUE, {7,7,7,7}},//libj-20220325-adject C0P0 NVME EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0xa813144d, 8, 11, TRUE, {8,8,8,8}},//libj-20220325-adject C0P0 NVME EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0xa813144d, 12, 15, TRUE, {7,7,7,7}},//libj-20220325-adject C0P0 NVME EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0x00000138, 0, 15, TRUE, {8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8}},//libj-20220406-adject C0P0 sw EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 2, 0xffffffff, 0x805915b3, 16, 23, TRUE, {7,7,7,7,7,7,7,7}},//libj-20220325-adject C0P2 OCP EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 2, 0xffffffff, 0x03131dcf, 16, 31, TRUE, {4,4,4,4,4,4,4,4}},//libj-20220406-adject C0P2 OCP EQ*/
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0x00000138, 0, 15, TRUE, {8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8}},//libj-20220325-adject C0P0 
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 2, 0xffffffff, 0x805915b3, 16, 23, TRUE, {7,7,7,7,7,7,7,7}},//libj-20220325-adject C0P2 OCP EQ
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 6, 0xffffffff, 0x40601000, 24, 31, TRUE, {7,7,7,7,7,7,7,7}},//libj-20220412-adject C1P2 EQ
