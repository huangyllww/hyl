...
typedef struct _FIRMWARE_ENTRY_TABLEV2 {
  ...
  UINT32  H1BiosDirBase;   ///< Base Address for H1 BIOS directory
  UINT32  H2BiosDirBase;   ///< Base Address for H2 BIOS directory
  UINT32  H3BiosDirBase;   ///< Base Address for H3 BIOS directory
  UINT32  H4BiosDirBase;   ///< Base Address for H4 BIOS directory
...
#define H1_PSP_CHIP_ID   0xBC090000
#define H2_PSP_CHIP_ID   0xBC090200
#define H3_PSP_CHIP_ID   0xBC090201
#define H4_PSP_CHIP_ID   0xBC090300
typedef struct {
