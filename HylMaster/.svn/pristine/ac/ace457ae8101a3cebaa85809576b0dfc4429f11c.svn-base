...
//(EIP65788+)       >>>
    ...
    //####IoWrite8(SMBUS1_BASE_ADDRESS+0xE, 0x70); // SM address of Remote Control device.
...
// SM address of Remote Control device.
    IoWrite8(SMBUS1_BASE_ADDRESS+0xE, 0x70);
//PEC enable
  ...
  )
{
    ...
    if (Private->Context->SmBusBase == SMBUS1_BASE_ADDRESS) 
        RW_IO8_PMIO(FCH_PMIOA_REG00 + 2, 0, BIT0);  //Set AsfSlave
#endif
