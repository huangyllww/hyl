...
//*******************************************************
typedef struct {
    EFI_GUID    TableVersion;
    UINTN       ApicID;
    UINTN       ProcessorEnabledFlag;
    UINTN       ProcessorDesignationFlags;
    UINTN       ProcessorHealthFlags;
    UINTN       ProcessorPALCompatibilityFlags;
    UINTN       ProcessorTestMask;
    UINTN       ProcessorPackageNumber;
    UINTN       ProcessorCoreNumber;
    UINTN       ProcessorThreadNumber;
} EFI_MP_PROC_CONTEXT;
#pragma pack (pop)
