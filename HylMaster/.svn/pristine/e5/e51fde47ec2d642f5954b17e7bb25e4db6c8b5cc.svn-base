...
// {5B5D1D38-1FA9-433B-97D6-F82677AB3FE4}
...
//<lvych00120160314+>
#define OEM_NO_DEFAULT_VARIABLES_ID   0xF040
//<lvych00120160314->
...
#define SAVE_AND_SHUTDOWN_VALUE        25
#define DISCARD_AND_SHUTDOWN_VALUE     26
#endif
//Chendl001-20191221 System can power off under BIOS Setup  ->
...
typedef struct _AMITSESETUP
{
	...
	// AMI SilentBoot
    UINT8   AMISilentBoot;
    UINT8   UEFIShellDisableSelect;//<Lvshh001-20181103 Add UEFI Shell disable token >
}
AMITSESETUP;
