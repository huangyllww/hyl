...
#define IDSNVID_CMN_MEM_MCA_ERROR_THRESH_COUNT_CONTROL   (0x0A17) 
#define IDSNVID_CMN_PRO_MCA_ERROR_THRESH_COUNT_CONTROL   (0x0A18) 

#define IDSNVID_CMN_MEM_MCA_ERROR_INTERVAL_CONTROL   (0x0A19) 
#define IDSNVID_CMN_MEM_MCA_ERROR_DROP_OUT_CONTROL   (0x0A1A) 
//mizl-2021-12-09-Sync Setup Setting With BIOS Setup Layout V0.5->
#define IDSNVID_DF_CMN_NUMA_MODE   (0x0A1B) //Numa mode control//<Yaosr-20211104 Control NUMA enable or disable.>
#define IDSNVID_CMN_MCA_PRO_ERR_THRESH_COUNT_CONTROL   (0x0A1C) 
#define IDSNVID_CMN_MCA_MEM_ERR_THRESH_COUNT_BAIDU_CONTROL   (0x0A1D) 
#define IDSNVID_CMN_MCA_MEM_CE_STORM_THRESH_BAIDU_CONTROL   (0x0A1E) 
