...
#ifndef _LIBRARY_CCXSMBIOSXVLIB_CCXSMBIOSXVCOMMONLIB_H_
#define _LIBRARY_CCXSMBIOSXVLIB_CCXSMBIOSXVCOMMONLIB_H_
...
#pragma pack (pop)
#endif  // _LIBRARY_CCXSMBIOSXVLIB_CCXSMBIOSXVCOMMONLIB_H_
