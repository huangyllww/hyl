...
#define GnbGetSocketId(Handle) (Handle != NULL ? (Handle)->SocketId : NULL)
#define GnbGetDieNumber(Handle) (Handle != NULL ? (Handle)->DieNumber : NULL)
#define GnbGetRBIndex(Handle) (Handle != NULL ? (Handle)->RBIndex : NULL)
