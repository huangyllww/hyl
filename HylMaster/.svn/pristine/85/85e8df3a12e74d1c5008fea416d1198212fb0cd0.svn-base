...
#if defined(OEM_PASSWORD_LOCK_POLICY)&& (OEM_PASSWORD_LOCK_POLICY == 1)  
#include "AMITSEOem.h"
...
#endif
#if defined(OEM_PASSWORD_LOCK_POLICY)&& (OEM_PASSWORD_LOCK_POLICY == 0) 
    //If Fixed lock time mode is set, LockTime should be the time set by Setup
