...
HYGON_CPM_EQ_CONFIG_TABLE   gCpmEqConfigurationTableHygon62DB32 = {
  {CPM_SIGNATURE_EQ_CONFIG, sizeof ( gCpmEqConfigurationTableHygon62DB32) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  {
    ...
    {FLAG_SPECIFIED, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 6, 0x0370cabc, 0x0057cabc, 16, 31, TRUE, {7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7}},//MLU370-X4
    {FLAG_FORCE, pcie_gen4_ttx_force_otherside_preset, CPU_HG3, 0, 0xffffffff, 0x40501000, 8, 15, TRUE, {4,4,4,4,4,4,4,4}},//dengyh-20220301-adject J43 GEN4 EQ
