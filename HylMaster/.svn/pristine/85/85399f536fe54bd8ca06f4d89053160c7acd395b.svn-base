...
#define FILECODE FCH_TAISHAN_FCHTAISHANCORE_TAISHAN_TSESPI_TSESPIRESET_FILECODE
  ...
  )
{
  ...
  if (LocalCfgPtr->EspiKbc6064Enable) {
    FchinitTSEspiEnableKbc6064 (TRUE);
  } else {
    FchinitTSEspiEnableKbc6064 (FALSE);
  }
}
