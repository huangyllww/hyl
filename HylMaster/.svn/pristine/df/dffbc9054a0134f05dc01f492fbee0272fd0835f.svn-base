...
//----------------------------------------------------------------------------
// New SIO componend required
//----------------------------------------------------------------------------

// The definition is for HYGON SB LPC ISA Bridge (Device 20, Function 3)
// from IO Port Decode Enable Register 1- RW - 8 bits - [PCI_Reg: 44h]
// to IO Port Decode Enable Register 4- RW - 8 bits - [PCI_Reg: 47h]
typedef union _HYGON_SB_IO_DECODE_REG1_4{
    struct {
    ...
    UINT32      CONFIG;
}HYGON_SB_IO_DECODE_REG1_4;

typedef union _HYGON_SB_IO_MEM_DECODE_REG5{
    struct  {
    ...
    UINT8       CONFIG;
}HYGON_SB_IO_MEM_DECODE_REG5;

typedef union _HYGON_SB_IO_MEM_DECODE_REG6{
    struct  {
        UINT8   IoPort0:1;                  // 0
        UINT8   IoPort1:1;                  // 1
        UINT8   IoPort2:1;                  // 2
    ...
    UINT8       CONFIG;
}HYGON_SB_IO_MEM_DECODE_REG6;

typedef union _HYGON_SB_IO_MEM_DECODE_REG7{
    struct  {
        UINT8   WideIo1:1;              // 0
        UINT8   WideIo2:1;              // 1
    ...
    UINT8       CONFIG;
}HYGON_SB_IO_MEM_DECODE_REG7;

typedef struct _HYGON_SB_LPC_DECODER{
    HYGON_SB_IO_DECODE_REG1_4     SbIoDecodeReg1;
    HYGON_SB_IO_MEM_DECODE_REG5   SbIoMemDecodeReg5;
    HYGON_SB_IO_MEM_DECODE_REG6   SbIoMemDecodeReg6;
    HYGON_SB_IO_MEM_DECODE_REG7   SbIoMemDecodeReg7;
    BOOLEAN                     SbIoDecodeReg1En;
    BOOLEAN                     SbIoMemDecodeReg5En;
    BOOLEAN                     SbIoMemDecodeReg6En;
    BOOLEAN                     SbIoMemDecodeReg7En;
}HYGON_SB_LPC_DECODER;
    ...
    )
{
    ...
    UINT8                   Index;
    UINT16                  IoBase;
    HYGON_SB_LPC_DECODER      dr;
    BOOLEAN                 isWideIoOverwrite = TRUE;
    ...
    if (Enable) {
        ...
        if ((dr.SbIoMemDecodeReg5.CONFIG & BIT02) == 0) Index = 0;
