...
static BOOLEAN gTerminateAcceptWork;	// Setting this variable means user wants to break the AcceptWork() function.
/** 
  This function helps to stop the function AcceptWork() by setting the variable gTerminateAcceptWork to TRUE.
  @param [in] VOID
  
  @param [out] VOID
 **/
VOID ForceExitAcceptWork()
{
	gTerminateAcceptWork = TRUE;
}
  ...
  )
{
  ...
  gTerminateAcceptWork = FALSE;	// AMI PORTING - To exit this function forcefully.
  ...
  if ( NULL != pSocketProtocol ) {
    ...
    //
    do {
    	// AMI PORTING STARTS - gTerminateAcceptWork will be TRUE when ForceExitAcceptWork() is called.
    	// It means user wants to terminate this function.
    	if(gTerminateAcceptWork)
    	{
    		Status = EFI_ABORTED;
    		break;
    	}
    	// AMI PORTING ENDS - gTerminateAcceptWork will be TRUE when ForceExitAcceptWork() is called.
    	// It means user wants to terminate this function.
