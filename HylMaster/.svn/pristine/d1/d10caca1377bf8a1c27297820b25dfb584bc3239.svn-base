...
CPU_CACHE_TABLE         tCache[] =
    {{ EFI_CACHE_L1, EfiCacheTypeInstruction, HYGON_EXT_CPUID_5,
       EDX, 24, 0xFF, 16, 0xFF, {L1AMap, L1ASIZE} },
     { EFI_CACHE_L1, EfiCacheTypeData, HYGON_EXT_CPUID_5,
       ECX, 24, 0xFF, 16, 0xFF, {L1AMap, L1ASIZE} },
     { EFI_CACHE_L2, EfiCacheTypeData, HYGON_EXT_CPUID_6,
       ECX, 16, 0xFFFF, 12, 0xF, {L2AMap, L2ASIZE} },
     { EFI_CACHE_L3, EfiCacheTypeData, HYGON_EXT_CPUID_6,
