...
{
#if defined(BIOS_HOTKEY_SUPPORT) && (BIOS_HOTKEY_SUPPORT == 1) //<Yaosr001-20190731 Support BIOS HotKey select. +>
    ...
    DEBUG ((DEBUG_INFO, "[IsPopupMenuEnterSetupEnabled] gRT->GetVariable status %r, SetupData.BiosHotKeySupport: %d \n", SetupStatus, SetupData.BiosHotKeySupport));
...
#else  //<Yaosr001-20190731 Support BIOS HotKey select. ->
#if POPUP_MENU_ENTER_SETUP
    return TRUE;
#else
    return FALSE;
#endif
#endif //<Yaosr001-20190731 Support BIOS HotKey select.>
