...
//**********************************************************************
#include "minisetup.h"
#include "Token.h" //<zhanghy2013-20200413 change STR_NAV_STRINGS_5 and STR_NAV_STRINGS_6 value>

//<zhanghy2013-20200413 change STR_NAV_STRINGS_5 and STR_NAV_STRINGS_6 value +>
...
//<Lvshh001-20200421 Add token for Setup interface style,0 is normal(AMI default) ,1 is EzportPlus(Byo) ->
#undef  STR_NAV_STRINGS_5
#define STR_NAV_STRINGS_5    STR_NAV_STRINGS_5_AK
#undef  STR_NAV_STRINGS_6 
#define STR_NAV_STRINGS_6    STR_NAV_STRINGS_6_AK
#endif
//<zhanghy2013-20200413 change STR_NAV_STRINGS_5 and STR_NAV_STRINGS_6 value ->
...
#if defined(TSE_STYLE_FIRST_PAGE_NEW) && (TSE_STYLE_FIRST_PAGE_NEW==0) //<Songkl001-20211120 Add a token to the new first page style of the setting interface >         
...
#endif //<Songkl001-20211120 Add a token to the new first page style of the setting interface >   
