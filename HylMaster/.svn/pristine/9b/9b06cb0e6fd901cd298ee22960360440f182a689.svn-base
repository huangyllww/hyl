...
$(EOL)@echo ----sign BIOS image using external rom map file\
$(EOL)$(CRYPTCON) -r $(ROM_LAYOUT_EX) $(CRYPTOCON_CMDLINE_SIG)"\
...
$(EOL)=============================================================\
$(EOL)\
$(EOL) $(notdir $(CRYPTCON)) $(notdir $(CRYPTOCON_CMDLINE_SIG))\
$(EOL)\
$(EOL)=============================================================\
...
#####
#An example of an alternative way to build PKCS#7 signed Fw Capsule using Cryptocon.exe 
#as a packaging tool and the signing done by an external signing tool
#ifeq ($(FWCAPSULE_CERT_FORMAT),1)
#
...
#	$(CRYPTCON) -c2 -s -f $(UNSIGNED_BIOS_ROM) -o fwcap_serialized
#
...
#	$(CRYPTCON) -c2 -s -x fwcap_serialized.p7 -f $(UNSIGNED_BIOS_ROM) -o $(FWCAPSULE_FILE_NAME)
