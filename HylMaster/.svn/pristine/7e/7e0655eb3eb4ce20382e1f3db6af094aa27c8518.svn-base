  ...
  )
{
  ...
  if (Setup_Config->CbsCmnCpuPfeh != 0x0) {
      ...
      switch (Setup_Config->McaMemErrThreshCount)
      {
        case 0 :
          PcdSet16S(PcdMcaMemErrThresh, 0);
          break;
        case 1 :
          PcdSet16S(PcdMcaMemErrThresh, 1200);
          break;
        case 2 :
          PcdSet16S(PcdMcaMemErrThresh, 1);
          break;
        case 3 :
          PcdSet16S(PcdMcaMemErrThresh, 1500);
          break;
        case 4 :
          PcdSet16S(PcdMcaMemErrThresh, 1000);
          break;
        case 5 :
          PcdSet16S(PcdMcaMemErrThresh, 2000);
          break;
        case 6 :
          PcdSet16S(PcdMcaMemErrThresh, 5000);
          break;
        case 7 :
          PcdSet16S(PcdMcaMemErrThresh, 10000);
          break;
      }
      switch (Setup_Config->McaMemCeStormThreshCount)
      {
        case 0 :
          PcdSet16S(PcdMcaMemCeStormThreshCount, 0);
          break;
        case 1 :
          PcdSet16S(PcdMcaMemCeStormThreshCount, 120);
          break;
        case 2 :
          PcdSet16S(PcdMcaMemCeStormThreshCount, 60);
          break;
        case 3 :
          PcdSet16S(PcdMcaMemCeStormThreshCount, 240);
          break;
        case 4 :
          PcdSet16S(PcdMcaMemCeStormThreshCount, 1200);
          break;
      }
      if ((0 == Setup_Config->McaMemErrThreshCount) && (0 == Setup_Config->McaMemCeStormThreshCount))
        PcdSet16S(PcdMcaMemErrThreshCount, 1);
      else
        PcdSet16S(PcdMcaMemErrThreshCount, 0xFFE);
      //<Wangyia001-20181017  Modify as Baidu BIOS spec v1.1 ->
      PcdSet16S(PcdMcaProErrThreshCount, (4095 - Setup_Config->McaProErrThreshCount));
  }
  //mizl-2021-12-09-Sync Setup Setting With BIOS Setup Layout V0.5->
