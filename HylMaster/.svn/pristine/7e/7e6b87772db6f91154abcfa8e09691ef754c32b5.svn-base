...
//    break;
//  case DxioSATAEngine:
//    IDS_HDT_CONSOLE (PCIE_MISC, "        Engine Type - SATA Port\n        Start Phy Lane - %d\n        End   Phy Lane - %d\n",
//      EngineList->EngineData.StartLane,
//      EngineList->EngineData.EndLane
//      );
//    break;
//  case DxioEthernetEngine:
//    IDS_HDT_CONSOLE (PCIE_MISC, "        Engine Type - EtherNet Port\n        Start Phy Lane - %d\n        End   Phy Lane - %d\n",
//      EngineList->EngineData.StartLane,
//      EngineList->EngineData.EndLane
//      );
//    EtherNetValue = (UINT32*) &(EngineList->EtherNet);
//    IDS_HDT_CONSOLE (PCIE_MISC, "          ETH_PORT_PROPERTY0 : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          ETH_PORT_PROPERTY3 : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          ETH_PORT_PROPERTY4 : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          PadMux0            : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          PadMux1            : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          MacAddressLo       : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          MacAddressHi       : 0x%x\n", *EtherNetValue);
//    EtherNetValue++;
//    IDS_HDT_CONSOLE (PCIE_MISC, "          ETH_PORT_TXEQ      : 0x%x\n", *EtherNetValue);
//    break;
//  }
}
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (PCIE_MISC, "  GFX Workaround - %a\n",
  ...
  while (ComplexList != NULL) {
    ...
    while (SiliconList != NULL) {
      ...
      IDS_HDT_CONSOLE (PCIE_MISC, "      Module ID - %d\n", SiliconList->DieNumber);
