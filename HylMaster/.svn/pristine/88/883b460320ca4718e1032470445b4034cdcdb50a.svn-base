...
)
{
    ...
    VOID                        *Registration;
//<hety-20220521 Enabled "AES Mode" for Tencent. +>
...
//<hety-20220521 Enabled "AES Mode" for Tencent. +>
//<Yao002-20201210 whether show 'AES Mode' option by CPU reversion. +>
    AsmCpuid(0x00000001, &FeatureFlagsEax, NULL, NULL, NULL);
    ...
    if (!EFI_ERROR(Status)) {
      if (RawBaseModel == 1) {//Hygon CPU B0
        SetupData.CPUMode = 1;
      } else {
        //SetupData.CPUMode = 0; //Hygon CPU A0 
        SetupData.CPUMode = 1; //Hygon CPU A0 //Temp set to 1
      }
