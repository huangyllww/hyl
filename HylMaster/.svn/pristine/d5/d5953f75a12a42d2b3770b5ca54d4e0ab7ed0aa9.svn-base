...
// AMI PORTING STARTS
/**
  Read Ip6 Config Policy.

  @param[out]    Ip6ConfigPolicy       The Ip6ConfigPolicy read from setup.

  @retval 1  returns 1 for Ip6ConfigPolicyAutomatic.
  @retval 0  returns 0 for Ip6ConfigPolicyManual.

**/
UINT8 ReadIp6ConfigPolicy()
{
	EFI_STATUS			Status;
	...
	if (Status == EFI_SUCCESS) {
	    ...
	    //
		return NetworkStackSetupData.Ip6ConfigPolicy; 
	}
	return 0;
}
// AMI PORTING ENDS
