...
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsCadBusLRDIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsDataBusLRDIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsOdtPatLRDIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsMaxFreqLRDIMMDdr4
REM SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_ZP_GID_0x1704_Type_PsStretchFreqLRDIMMDdr4
