  ...
  )
{
    ...
    //SGMTB#0144069-ImproveHintMesssageForOOB +>
    OOBInterfaceStatus |= (1<<OOBStatus_DeviceCheck);
    PcdSet8S (OOBInterfaceSelfTestStatus,OOBInterfaceStatus);
    //SGMTB#0144069-ImproveHintMesssageForOOB ->
    //
    ...
    if (EFI_ERROR (Status)) {
        ...
        switch (UsbBstStatus.Result) {
            ...
            case IPMI_APP_SELFTEST_RESERVED: // 0xFF
                gIpmiUsbInstance->BmcStatus = EFI_BMC_OK;
                //SGMTB#0144069-ImproveHintMesssageForOOB +>
                OOBInterfaceStatus |= (1<<OOBStatus_BMCSelfTest);
                PcdSet8S (OOBInterfaceSelfTestStatus,OOBInterfaceStatus);
                //SGMTB#0144069-ImproveHintMesssageForOOB ->
                break;
    ...
    if (gIpmiUsbInstance->BmcStatus != EFI_BMC_HARDFAIL) {
        ...
        //SGMTB#0144069-ImproveHintMesssageForOOB +>
        OOBInterfaceStatus |= (1<<OOBStatus_IpmiTransferProtocol);
        PcdSet8S (OOBInterfaceSelfTestStatus,OOBInterfaceStatus);
        //SGMTB#0144069-ImproveHintMesssageForOOB ->
