...
PlatformConfigInit ( VOID )
{
  ...
  mPlatformApeiPrivate->PlatRasPolicy.McaMemErrThresh = PcdGet16 (PcdMcaMemErrThresh);
  mPlatformApeiPrivate->PlatRasPolicy.McaMemCeStormThreshCount = PcdGet16 (PcdMcaMemCeStormThreshCount);
  //<Wangyia001-20181017  Modify as Baidu BIOS spec v1.1 ->
#endif
