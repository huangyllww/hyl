...
ApeiHestInstall ( VOID )
{
  ...
  CmcStruc->NotificationStructure.ErrorThresholdValue = 0xFFF - mPlatformApeiPrivate->PlatRasPolicy.McaMemErrThreshCount;//<Chendl001-20180626 Memory Leaky Bucket Design +>
