...
extern DEBUG_SERVICE_PRINT_FUNCTION RT_DEBUG_PRINT_LIST EndOfDebugPrintList;
DEBUG_SERVICE_PRINT_FUNCTION* RtDebugServicePrintList[] = {RT_DEBUG_PRINT_LIST NULL};

extern DEBUG_SERVICE_ASSERT_FUNCTION RT_DEBUG_ASSERT_LIST EndOfDebugAssertList;
DEBUG_SERVICE_ASSERT_FUNCTION* RtDebugServiceAssertList[] = {RT_DEBUG_ASSERT_LIST NULL};
...
extern DEBUG_SERVICE_PRINT_FUNCTION DXE_DEBUG_PRINT_LIST EndOfDebugPrintList;
DEBUG_SERVICE_PRINT_FUNCTION* DebugServicePrintList[] = {DXE_DEBUG_PRINT_LIST NULL, RT_DEBUG_PRINT_LIST NULL};

extern DEBUG_SERVICE_ASSERT_FUNCTION DXE_DEBUG_ASSERT_LIST EndOfDebugAssertList;
DEBUG_SERVICE_ASSERT_FUNCTION* DebugServiceAssertList[] = {DXE_DEBUG_ASSERT_LIST NULL, RT_DEBUG_ASSERT_LIST NULL};

extern DEBUG_SERVICE_PRINT_GATE_FUNCTION DXE_RT_DEBUG_SERVICE_PRINT_GATE;
DEBUG_SERVICE_PRINT_GATE_FUNCTION* DebugServicePrintGate = DXE_RT_DEBUG_SERVICE_PRINT_GATE;

extern DEBUG_SERVICE_ASSERT_GATE_FUNCTION DXE_RT_DEBUG_SERVICE_ASSERT_GATE;
DEBUG_SERVICE_ASSERT_GATE_FUNCTION* DebugServiceAssertGate = DXE_RT_DEBUG_SERVICE_ASSERT_GATE;
...
VOID ScRuntimeVirtualAddressChange (IN EFI_EVENT Event, IN VOID *Context)
{
    ...
    for (i=0; DebugServicePrintList[i]; i++){
    	pRS->ConvertPointer(0,(VOID**)&(DebugServicePrintList[i]));
    }
    
    for (i=0; DebugServiceAssertList[i]; i++){
    	pRS->ConvertPointer(0,(VOID**)&(DebugServiceAssertList[i]));
    }
...
VOID RuntimeStatusCodeExitBS (IN EFI_EVENT Event, IN VOID *Context)
{
	...
	SwitchToRtHandlers(DebugServicePrintList);
    SwitchToRtHandlers(DebugServiceAssertList);
}
