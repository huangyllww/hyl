...
STRING_REF gHddSecurityName[24] =
{
    ...
    //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk +>
    STRING_TOKEN(STR_SECURITY_HDD_SEVEN), STRING_TOKEN(STR_SECURITY_HDD_EIGHT),
    STRING_TOKEN(STR_SECURITY_HDD_NINE), STRING_TOKEN(STR_SECURITY_HDD_TEN),
    STRING_TOKEN(STR_SECURITY_HDD_ELEVEN), STRING_TOKEN(STR_SECURITY_HDD_TWELVE),
    STRING_TOKEN(STR_SECURITY_HDD_THIRTEEN), STRING_TOKEN(STR_SECURITY_HDD_FORTEEN),
    STRING_TOKEN(STR_SECURITY_HDD_FIFTEEN), STRING_TOKEN(STR_SECURITY_HDD_SIXTEEN),
    STRING_TOKEN(STR_SECURITY_HDD_SEVENTEEN), STRING_TOKEN(STR_SECURITY_HDD_EIGHTEEN),
    STRING_TOKEN(STR_SECURITY_HDD_NINETEEN), STRING_TOKEN(STR_SECURITY_HDD_TWENTY),
    STRING_TOKEN(STR_SECURITY_HDD_TWENTY_ONE), STRING_TOKEN(STR_SECURITY_HDD_TWENTY_TWO),
    STRING_TOKEN(STR_SECURITY_HDD_TWENTY_THREE), STRING_TOKEN(STR_SECURITY_HDD_TWENTY_FOUR)
    //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk ->
};
...
{
    DEBUG ((EFI_D_ERROR, "In NotifyEscPressed\n"));//park
...
)
{
    ...
    case HDD_SECURITY_GET_USERPASSWORD6_KEY:
        ...
        break;
    //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk +>
    case HDD_SECURITY_GET_USERPASSWORD7_KEY:  
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 6;
        break;
    case HDD_SECURITY_GET_USERPASSWORD8_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 7;
        break;
    case HDD_SECURITY_GET_USERPASSWORD9_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 8;
        break;
    case HDD_SECURITY_GET_USERPASSWORD10_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 9;
        break;
    case HDD_SECURITY_GET_USERPASSWORD11_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 10;
        break;
    case HDD_SECURITY_GET_USERPASSWORD12_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 11;
        break;
    case HDD_SECURITY_GET_USERPASSWORD13_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 12;
        break;
    case HDD_SECURITY_GET_USERPASSWORD14_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 13;
        break;
    case HDD_SECURITY_GET_USERPASSWORD15_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 14;
        break;
    case HDD_SECURITY_GET_USERPASSWORD16_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 15;
        break;
    case HDD_SECURITY_GET_USERPASSWORD17_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 16;
        break;
    case HDD_SECURITY_GET_USERPASSWORD18_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 17;
        break;
    case HDD_SECURITY_GET_USERPASSWORD19_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 18;
        break;
    case HDD_SECURITY_GET_USERPASSWORD20_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 19;
        break;
    case HDD_SECURITY_GET_USERPASSWORD21_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 20;
        break;
    case HDD_SECURITY_GET_USERPASSWORD22_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 21;
        break;
    case HDD_SECURITY_GET_USERPASSWORD23_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 22;
        break;
    case HDD_SECURITY_GET_USERPASSWORD24_KEY:
        bCheckUser = TRUE;
        CurrentHardDiskNumber = 23;
        break;       
   //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk ->
    ...
    case HDD_SECURITY_GET_MASTERPASSWORD6_KEY:
        ...
        break;
    //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk +>
    case HDD_SECURITY_GET_MASTERPASSWORD7_KEY:
    	bCheckUser = FALSE;
        CurrentHardDiskNumber = 6;
        break;
    case HDD_SECURITY_GET_MASTERPASSWORD8_KEY:
    	bCheckUser = FALSE;
        CurrentHardDiskNumber = 7;
        break;
     case HDD_SECURITY_GET_MASTERPASSWORD9_KEY:
        bCheckUser = FALSE;
        CurrentHardDiskNumber = 8;
        break;
     case HDD_SECURITY_GET_MASTERPASSWORD10_KEY:
        bCheckUser = FALSE;
        CurrentHardDiskNumber = 9;
        break;
     case HDD_SECURITY_GET_MASTERPASSWORD11_KEY:
        bCheckUser = FALSE;
        CurrentHardDiskNumber = 10;
        break;
     case HDD_SECURITY_GET_MASTERPASSWORD12_KEY:
         bCheckUser = FALSE;
         CurrentHardDiskNumber = 11;
         break;
      case HDD_SECURITY_GET_MASTERPASSWORD13_KEY:
         bCheckUser = FALSE;
         CurrentHardDiskNumber = 12;
         break;
      case HDD_SECURITY_GET_MASTERPASSWORD14_KEY:
         bCheckUser = FALSE;
         CurrentHardDiskNumber = 13;
         break;
      case HDD_SECURITY_GET_MASTERPASSWORD15_KEY:
         bCheckUser = FALSE;
         CurrentHardDiskNumber = 14;
         break;
      case HDD_SECURITY_GET_MASTERPASSWORD16_KEY:
          bCheckUser = FALSE;
          CurrentHardDiskNumber = 15;
          break;
       case HDD_SECURITY_GET_MASTERPASSWORD17_KEY:
          bCheckUser = FALSE;
          CurrentHardDiskNumber = 16;
          break;
       case HDD_SECURITY_GET_MASTERPASSWORD18_KEY:
          bCheckUser = FALSE;
          CurrentHardDiskNumber = 17;
          break;
       case HDD_SECURITY_GET_MASTERPASSWORD19_KEY:
          bCheckUser = FALSE;
          CurrentHardDiskNumber = 18;
          break;
       case HDD_SECURITY_GET_MASTERPASSWORD20_KEY:
           bCheckUser = FALSE;
           CurrentHardDiskNumber = 19;
           break;
        case HDD_SECURITY_GET_MASTERPASSWORD21_KEY:
           bCheckUser = FALSE;
           CurrentHardDiskNumber = 20;
           break;
        case HDD_SECURITY_GET_MASTERPASSWORD22_KEY:
           bCheckUser = FALSE;
           CurrentHardDiskNumber = 21;
           break;
        case HDD_SECURITY_GET_MASTERPASSWORD23_KEY:
           bCheckUser = FALSE;
           CurrentHardDiskNumber = 22;
           break;
        case HDD_SECURITY_GET_MASTERPASSWORD24_KEY:
           bCheckUser = FALSE;
           CurrentHardDiskNumber = 23;
           break;
       //<Malj2-20180529 Mantis:20093 HDD Security Support rose from 6 to 24 Hard Disk ->
...
//zanggy-20201217-Fix Hdd master password is clear when press ESC in "set password dialog"+>
    if(gHddSecEscNotifyEvent == NULL) {
        ...
        pBS->RegisterProtocolNotify( &gHddSecEscOnPwdPromptGuid,
                                     gHddSecEscNotifyEvent,
                                     &gHddSecEscNotifyRegistration );
    }
//zanggy-20201217-Fix Hdd master password is clear when press ESC in "set password dialog"->
