    ...
    IN OUT HW_VIDEO_DATA *HardwareVideoData )
{
    ...
    UINT8                              i = 0;//<Lvshh001-20181116 Add EDID DEBUG info>
    ...
    if(EdidDiscoveredProtocol->SizeOfEdid != 0 && EdidDiscoveredProtocol->Edid != NULL){
        if( EdidDiscoveredProtocol->SizeOfEdid == VESA_BIOS_EXTENSIONS_EDID_BLOCK_SIZE){
            ...
            Status = EFI_SUCCESS;
            //<Lvshh001-20181116 Add EDID DEBUG info +>
            HWSIG_TRACE((-1,"[OemDbg]Raw EDID:\n"));
            while( i < EdidDiscoveredProtocol->SizeOfEdid){
                   HWSIG_TRACE((-1,"%02x %02x %02x %02x %02x %02x %02x %02x",EdidDiscoveredProtocol->Edid[i],EdidDiscoveredProtocol->Edid[i+1],EdidDiscoveredProtocol->Edid[i+2],EdidDiscoveredProtocol->Edid[i+3],EdidDiscoveredProtocol->Edid[i+4],EdidDiscoveredProtocol->Edid[i+5],EdidDiscoveredProtocol->Edid[i+6],EdidDiscoveredProtocol->Edid[i+7]));
                   HWSIG_TRACE((-1,"  %02x %02x %02x %02x %02x %02x %02x %02x\n",EdidDiscoveredProtocol->Edid[i+8],EdidDiscoveredProtocol->Edid[i+9],EdidDiscoveredProtocol->Edid[i+10],EdidDiscoveredProtocol->Edid[i+11],EdidDiscoveredProtocol->Edid[i+12],EdidDiscoveredProtocol->Edid[i+13],EdidDiscoveredProtocol->Edid[i+14],EdidDiscoveredProtocol->Edid[i+15]));
                   i = i + 16;
            }
            //<Lvshh001-20181116 Add EDID DEBUG info ->
        }        
