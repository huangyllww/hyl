...
///Physical Layer 16.0 PCIe Ext Capability 
typedef struct _PCIE4_DATA {
    UINT16              PhyPcieCapOffs;
    UINT32              StatusReg; ///32 bit reg
    UINT32              LocaLDataParityStatus;
    UINT32              FirstReTimerDataParityStatus;
    UINT32              SecondReTimerDataParityStatus;
    UINT8               MaxLanesCount;    
} PCIE4_DATA;
...
///Embedded ROMs found in SDL Data..
    ...
    UINT8                   OemPolicy; //<lvych001-20161128 Sync with PCIe Dev List Module Config >
}PCI_DEV_INFO;
